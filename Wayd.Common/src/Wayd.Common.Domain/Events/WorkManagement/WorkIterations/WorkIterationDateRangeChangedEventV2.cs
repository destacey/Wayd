...
/// <summary>
/// The Work copy of an iteration's planned start or end moved, was set, or was cleared.
/// </summary>
/// <remarks>
...
public sealed record WorkIterationDateRangeChangedEventV2 : DomainEvent<WorkIterationDateRangeChangedEventV2>, IDomainEventDescriptor, IAggregateEvent
{
    ...
    public WorkIterationDateRangeChangedEventV2(Guid id, int key, IterationDateRange previousDateRange, IterationDateRange dateRange, EventActor actor, Instant timestamp)
        : base(actor, "2.0")
    {
        Id = id;
        Key = key;
