...
/// <summary>Row shape for the definition below: the group it belongs to, and whether the pass rejects it.</summary>
public sealed record TestGroupedImportRow(string Group, bool ShouldFail = false);
