...
namespace Wayd.Goals.Application.Tests.Infrastructure;
...
public class FakeGoalsDbContext : IGoalsDbContext, IDisposable
{
    ...
    public Task<int> SaveChangesAsync(CancellationToken cancellationToken = default)
    {
        ...
        var count = _objectives.Count + _employees.Count + _externalEmployeeBlacklistItems.Count + _externalIdentityMappings.Count + _personalAccessTokens.Count;
