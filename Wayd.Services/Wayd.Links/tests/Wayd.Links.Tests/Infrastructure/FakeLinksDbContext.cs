...
/// This eliminates the need for complex Moq setups in tests and is reusable across all Links domain tests.
/// </summary>
public class FakeLinksDbContext : ILinksDbContext, IDisposable
{
    ...
    public Task<int> SaveChangesAsync(CancellationToken cancellationToken = default)
    {
        ...
        var count = _links.Count + _employees.Count + _externalEmployeeBlacklistItems.Count + _externalIdentityMappings.Count + _personalAccessTokens.Count;
