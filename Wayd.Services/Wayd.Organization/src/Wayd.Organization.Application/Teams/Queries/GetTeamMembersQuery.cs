...
public sealed class GetTeamMembersQueryHandler(IOrganizationDbContext organizationDbContext) : IQueryHandler<GetTeamMembersQuery, IReadOnlyList<TeamMemberDto>>
{
