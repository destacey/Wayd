...
/// migrated schema — across every integration test class in this project. Each test resets the Planning data it
/// touches, so the classes are isolated without paying the per-class container start-up cost.
/// </summary>
