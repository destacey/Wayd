...
public enum StrategicInitiativeStatus
{
    ...
    [Display(Name = "Canceled", Description = "The strategic initiative was terminated before achieving its goals.", Order = 6, GroupName = nameof(LifecycleCategory.Canceled))]
    Canceled = 6
}
