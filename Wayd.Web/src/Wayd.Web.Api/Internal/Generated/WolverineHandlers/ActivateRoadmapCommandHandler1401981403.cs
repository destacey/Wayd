...
namespace Internal.Generated.WolverineHandlers
{
    ...
    public sealed class ActivateRoadmapCommandHandler1401981403 : Wolverine.Runtime.Handlers.MessageHandler
    {
        ...
        public ActivateRoadmapCommandHandler1401981403(Microsoft.AspNetCore.Http.IHttpContextAccessor __httpContextAccessor1, Microsoft.AspNetCore.Http.IHttpContextAccessor __httpContextAccessor2, Microsoft.EntityFrameworkCore.DbContextOptions dbContextOptions, Microsoft.Extensions.DependencyInjection.IServiceScopeFactory serviceScopeFactory, Microsoft.Extensions.Logging.ILogger<Wayd.Common.Application.Behaviors.PerformanceBehaviorLog> loggerOfPerformanceBehaviorLog, Microsoft.Extensions.Logging.ILogger<Wayd.Infrastructure.Common.Services.EventPublisher> loggerOfEventPublisher, Microsoft.Extensions.Logging.ILogger<Wayd.Planning.Application.Roadmaps.Commands.ActivateRoadmapCommandHandler> loggerOfActivateRoadmapCommandHandler, Microsoft.Extensions.Options.IOptions<Wayd.Infrastructure.Persistence.DatabaseSettings> optionsOfDatabaseSettings, System.Collections.Generic.IEnumerable<Wolverine.EntityFrameworkCore.IDomainEventScraper> domainEventScraperIEnumerable, System.TimeProvider timeProvider, Wolverine.FluentValidation.IFailureAction<Wayd.Planning.Application.Roadmaps.Commands.ActivateRoadmapCommand> failureActionOfActivateRoadmapCommand, Wolverine.Runtime.IWolverineRuntime wolverineRuntime)
        {
        ...
        {
            var activateRoadmapCommandValidator = new Wayd.Planning.Application.Roadmaps.Commands.ActivateRoadmapCommandValidator();
            ...
            try
            {
                ...
                await Wolverine.FluentValidation.Internals.FluentValidationExecutor.ExecuteOne<Wayd.Planning.Application.Roadmaps.Commands.ActivateRoadmapCommand>(activateRoadmapCommandValidator, _failureActionOfActivateRoadmapCommand, activateRoadmapCommand).ConfigureAwait(false);
                var activateRoadmapCommandHandler = new Wayd.Planning.Application.Roadmaps.Commands.ActivateRoadmapCommandHandler(waydDbContext, currentUser, _loggerOfActivateRoadmapCommandHandler);
