...
namespace Internal.Generated.WolverineHandlers
{
    ...
    public sealed class ActivateVisionCommandHandler1306964051 : Wolverine.Runtime.Handlers.MessageHandler
    {
        ...
        public ActivateVisionCommandHandler1306964051(Microsoft.AspNetCore.Http.IHttpContextAccessor __httpContextAccessor1, Microsoft.AspNetCore.Http.IHttpContextAccessor __httpContextAccessor2, Microsoft.EntityFrameworkCore.DbContextOptions dbContextOptions, Microsoft.Extensions.DependencyInjection.IServiceScopeFactory serviceScopeFactory, Microsoft.Extensions.Logging.ILogger<Wayd.Common.Application.Behaviors.PerformanceBehaviorLog> loggerOfPerformanceBehaviorLog, Microsoft.Extensions.Logging.ILogger<Wayd.Infrastructure.Common.Services.EventPublisher> loggerOfEventPublisher, Microsoft.Extensions.Logging.ILogger<Wayd.StrategicManagement.Application.Visions.Commands.ActivateVisionCommandHandler> loggerOfActivateVisionCommandHandler, Microsoft.Extensions.Options.IOptions<Wayd.Infrastructure.Persistence.DatabaseSettings> optionsOfDatabaseSettings, System.Collections.Generic.IEnumerable<Wolverine.EntityFrameworkCore.IDomainEventScraper> domainEventScraperIEnumerable, System.TimeProvider timeProvider, Wolverine.FluentValidation.IFailureAction<Wayd.StrategicManagement.Application.Visions.Commands.ActivateVisionCommand> failureActionOfActivateVisionCommand, Wolverine.Runtime.IWolverineRuntime wolverineRuntime)
        {
        ...
        {
            var activateVisionCommandValidator = new Wayd.StrategicManagement.Application.Visions.Commands.ActivateVisionCommandValidator();
            ...
            try
            {
                ...
                await Wolverine.FluentValidation.Internals.FluentValidationExecutor.ExecuteOne<Wayd.StrategicManagement.Application.Visions.Commands.ActivateVisionCommand>(activateVisionCommandValidator, _failureActionOfActivateVisionCommand, activateVisionCommand).ConfigureAwait(false);
                var activateVisionCommandHandler = new Wayd.StrategicManagement.Application.Visions.Commands.ActivateVisionCommandHandler(waydDbContext, _loggerOfActivateVisionCommandHandler, dateTimeProvider);
