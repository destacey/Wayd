...
{
    // START: AddChecklistItemCommandHandler1190313871
    [global::System.CodeDom.Compiler.GeneratedCode("JasperFx", "1.0.0")]
    public sealed class AddChecklistItemCommandHandler1190313871 : Wolverine.Runtime.Handlers.MessageHandler
    {
        ...
        private readonly Microsoft.Extensions.Logging.ILogger<Wayd.Planning.Application.StoryMaps.Commands.AddChecklistItemCommandHandler> _loggerOfAddChecklistItemCommandHandler;
        ...
        private readonly Wolverine.FluentValidation.IFailureAction<Wayd.Planning.Application.StoryMaps.Commands.AddChecklistItemCommand> _failureActionOfAddChecklistItemCommand;
        private readonly Wolverine.Runtime.IWolverineRuntime _wolverineRuntime;

        public AddChecklistItemCommandHandler1190313871(Microsoft.AspNetCore.Http.IHttpContextAccessor __httpContextAccessor1, Microsoft.AspNetCore.Http.IHttpContextAccessor __httpContextAccessor2, Microsoft.EntityFrameworkCore.DbContextOptions dbContextOptions, Microsoft.Extensions.DependencyInjection.IServiceScopeFactory serviceScopeFactory, Microsoft.Extensions.Logging.ILogger<Wayd.Common.Application.Behaviors.PerformanceBehaviorLog> loggerOfPerformanceBehaviorLog, Microsoft.Extensions.Logging.ILogger<Wayd.Infrastructure.Common.Services.EventPublisher> loggerOfEventPublisher, Microsoft.Extensions.Logging.ILogger<Wayd.Planning.Application.StoryMaps.Commands.AddChecklistItemCommandHandler> loggerOfAddChecklistItemCommandHandler, Microsoft.Extensions.Options.IOptions<Wayd.Infrastructure.Persistence.DatabaseSettings> optionsOfDatabaseSettings, System.Collections.Generic.IEnumerable<Wolverine.EntityFrameworkCore.IDomainEventScraper> domainEventScraperIEnumerable, System.TimeProvider timeProvider, Wolverine.FluentValidation.IFailureAction<Wayd.Planning.Application.StoryMaps.Commands.AddChecklistItemCommand> failureActionOfAddChecklistItemCommand, Wolverine.Runtime.IWolverineRuntime wolverineRuntime)
        {
            ...
            _loggerOfAddChecklistItemCommandHandler = loggerOfAddChecklistItemCommandHandler;
            _optionsOfDatabaseSettings = optionsOfDatabaseSettings;
            _domainEventScraperIEnumerable = domainEventScraperIEnumerable;
            _timeProvider = timeProvider;
            _failureActionOfAddChecklistItemCommand = failureActionOfAddChecklistItemCommand;
        ...
        public override async System.Threading.Tasks.Task HandleAsync(Wolverine.Runtime.MessageContext context, System.Threading.CancellationToken cancellation)
        {
            ...
            var addChecklistItemCommandValidator = new Wayd.Planning.Application.StoryMaps.Commands.AddChecklistItemCommandValidator();
            ...
            var addChecklistItemCommand = (Wayd.Planning.Application.StoryMaps.Commands.AddChecklistItemCommand)context.Envelope.Message;
            ...
            try
            {
                System.Diagnostics.Activity.Current?.SetTag("message.handler", "Wayd.Planning.Application.StoryMaps.Commands.AddChecklistItemCommandHandler");
                System.Diagnostics.Activity.Current?.SetTag("handler.type", "Wayd.Planning.Application.StoryMaps.Commands.AddChecklistItemCommandHandler");
                await Wolverine.FluentValidation.Internals.FluentValidationExecutor.ExecuteOne<Wayd.Planning.Application.StoryMaps.Commands.AddChecklistItemCommand>(addChecklistItemCommandValidator, _failureActionOfAddChecklistItemCommand, addChecklistItemCommand).ConfigureAwait(false);
                var addChecklistItemCommandHandler = new Wayd.Planning.Application.StoryMaps.Commands.AddChecklistItemCommandHandler(waydDbContext, storyMapNotifier, _loggerOfAddChecklistItemCommandHandler);
                
                // The actual message execution
                var outgoing1 = await addChecklistItemCommandHandler.Handle(addChecklistItemCommand, cancellation).ConfigureAwait(false);
    ...
    // END: AddChecklistItemCommandHandler1190313871
