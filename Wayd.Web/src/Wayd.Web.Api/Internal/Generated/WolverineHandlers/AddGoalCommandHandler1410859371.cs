...
{
    // START: AddGoalCommandHandler1410859371
    [global::System.CodeDom.Compiler.GeneratedCode("JasperFx", "1.0.0")]
    public sealed class AddGoalCommandHandler1410859371 : Wolverine.Runtime.Handlers.MessageHandler
    {
        ...
        private readonly Microsoft.Extensions.Logging.ILogger<Wayd.Planning.Application.StoryMaps.Commands.AddGoalCommandHandler> _loggerOfAddGoalCommandHandler;
        ...
        private readonly Wolverine.FluentValidation.IFailureAction<Wayd.Planning.Application.StoryMaps.Commands.AddGoalCommand> _failureActionOfAddGoalCommand;
        private readonly Wolverine.Runtime.IWolverineRuntime _wolverineRuntime;

        public AddGoalCommandHandler1410859371(Microsoft.AspNetCore.Http.IHttpContextAccessor __httpContextAccessor1, Microsoft.AspNetCore.Http.IHttpContextAccessor __httpContextAccessor2, Microsoft.EntityFrameworkCore.DbContextOptions dbContextOptions, Microsoft.Extensions.DependencyInjection.IServiceScopeFactory serviceScopeFactory, Microsoft.Extensions.Logging.ILogger<Wayd.Common.Application.Behaviors.PerformanceBehaviorLog> loggerOfPerformanceBehaviorLog, Microsoft.Extensions.Logging.ILogger<Wayd.Infrastructure.Common.Services.EventPublisher> loggerOfEventPublisher, Microsoft.Extensions.Logging.ILogger<Wayd.Planning.Application.StoryMaps.Commands.AddGoalCommandHandler> loggerOfAddGoalCommandHandler, Microsoft.Extensions.Options.IOptions<Wayd.Infrastructure.Persistence.DatabaseSettings> optionsOfDatabaseSettings, System.Collections.Generic.IEnumerable<Wolverine.EntityFrameworkCore.IDomainEventScraper> domainEventScraperIEnumerable, System.TimeProvider timeProvider, Wolverine.FluentValidation.IFailureAction<Wayd.Planning.Application.StoryMaps.Commands.AddGoalCommand> failureActionOfAddGoalCommand, Wolverine.Runtime.IWolverineRuntime wolverineRuntime)
        {
            ...
            _loggerOfAddGoalCommandHandler = loggerOfAddGoalCommandHandler;
            _optionsOfDatabaseSettings = optionsOfDatabaseSettings;
            _domainEventScraperIEnumerable = domainEventScraperIEnumerable;
            _timeProvider = timeProvider;
            _failureActionOfAddGoalCommand = failureActionOfAddGoalCommand;
        ...
        {
            var addGoalCommandValidator = new Wayd.Planning.Application.StoryMaps.Commands.AddGoalCommandValidator();
            ...
            var addGoalCommand = (Wayd.Planning.Application.StoryMaps.Commands.AddGoalCommand)context.Envelope.Message;
            ...
            try
            {
                System.Diagnostics.Activity.Current?.SetTag("message.handler", "Wayd.Planning.Application.StoryMaps.Commands.AddGoalCommandHandler");
                System.Diagnostics.Activity.Current?.SetTag("handler.type", "Wayd.Planning.Application.StoryMaps.Commands.AddGoalCommandHandler");
                await Wolverine.FluentValidation.Internals.FluentValidationExecutor.ExecuteOne<Wayd.Planning.Application.StoryMaps.Commands.AddGoalCommand>(addGoalCommandValidator, _failureActionOfAddGoalCommand, addGoalCommand).ConfigureAwait(false);
                var addGoalCommandHandler = new Wayd.Planning.Application.StoryMaps.Commands.AddGoalCommandHandler(waydDbContext, storyMapNotifier, _loggerOfAddGoalCommandHandler);
                
                // The actual message execution
                var outgoing1 = await addGoalCommandHandler.Handle(addGoalCommand, cancellation).ConfigureAwait(false);
    ...
    // END: AddGoalCommandHandler1410859371
