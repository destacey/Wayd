...
{
    // START: AddStepCommandHandler272640074
    [global::System.CodeDom.Compiler.GeneratedCode("JasperFx", "1.0.0")]
    public sealed class AddStepCommandHandler272640074 : Wolverine.Runtime.Handlers.MessageHandler
    {
        ...
        private readonly Microsoft.Extensions.Logging.ILogger<Wayd.Planning.Application.StoryMaps.Commands.AddStepCommandHandler> _loggerOfAddStepCommandHandler;
        ...
        private readonly Wolverine.FluentValidation.IFailureAction<Wayd.Planning.Application.StoryMaps.Commands.AddStepCommand> _failureActionOfAddStepCommand;
        private readonly Wolverine.Runtime.IWolverineRuntime _wolverineRuntime;

        public AddStepCommandHandler272640074(Microsoft.AspNetCore.Http.IHttpContextAccessor __httpContextAccessor1, Microsoft.AspNetCore.Http.IHttpContextAccessor __httpContextAccessor2, Microsoft.EntityFrameworkCore.DbContextOptions dbContextOptions, Microsoft.Extensions.DependencyInjection.IServiceScopeFactory serviceScopeFactory, Microsoft.Extensions.Logging.ILogger<Wayd.Common.Application.Behaviors.PerformanceBehaviorLog> loggerOfPerformanceBehaviorLog, Microsoft.Extensions.Logging.ILogger<Wayd.Infrastructure.Common.Services.EventPublisher> loggerOfEventPublisher, Microsoft.Extensions.Logging.ILogger<Wayd.Planning.Application.StoryMaps.Commands.AddStepCommandHandler> loggerOfAddStepCommandHandler, Microsoft.Extensions.Options.IOptions<Wayd.Infrastructure.Persistence.DatabaseSettings> optionsOfDatabaseSettings, System.Collections.Generic.IEnumerable<Wolverine.EntityFrameworkCore.IDomainEventScraper> domainEventScraperIEnumerable, System.TimeProvider timeProvider, Wolverine.FluentValidation.IFailureAction<Wayd.Planning.Application.StoryMaps.Commands.AddStepCommand> failureActionOfAddStepCommand, Wolverine.Runtime.IWolverineRuntime wolverineRuntime)
        {
            ...
            _loggerOfAddStepCommandHandler = loggerOfAddStepCommandHandler;
            _optionsOfDatabaseSettings = optionsOfDatabaseSettings;
            _domainEventScraperIEnumerable = domainEventScraperIEnumerable;
            _timeProvider = timeProvider;
            _failureActionOfAddStepCommand = failureActionOfAddStepCommand;
        ...
        {
            var addStepCommandValidator = new Wayd.Planning.Application.StoryMaps.Commands.AddStepCommandValidator();
            ...
            var addStepCommand = (Wayd.Planning.Application.StoryMaps.Commands.AddStepCommand)context.Envelope.Message;
            ...
            try
            {
                System.Diagnostics.Activity.Current?.SetTag("message.handler", "Wayd.Planning.Application.StoryMaps.Commands.AddStepCommandHandler");
                System.Diagnostics.Activity.Current?.SetTag("handler.type", "Wayd.Planning.Application.StoryMaps.Commands.AddStepCommandHandler");
                await Wolverine.FluentValidation.Internals.FluentValidationExecutor.ExecuteOne<Wayd.Planning.Application.StoryMaps.Commands.AddStepCommand>(addStepCommandValidator, _failureActionOfAddStepCommand, addStepCommand).ConfigureAwait(false);
                var addStepCommandHandler = new Wayd.Planning.Application.StoryMaps.Commands.AddStepCommandHandler(waydDbContext, storyMapNotifier, _loggerOfAddStepCommandHandler);
                
                // The actual message execution
                var outgoing1 = await addStepCommandHandler.Handle(addStepCommand, cancellation).ConfigureAwait(false);
    ...
    // END: AddStepCommandHandler272640074
