...
namespace Internal.Generated.WolverineHandlers
{
    ...
    public sealed class AddStrategicInitiativeKpiMeasurementCommandHandler1561301665 : Wolverine.Runtime.Handlers.MessageHandler
    {
        ...
        public AddStrategicInitiativeKpiMeasurementCommandHandler1561301665(Microsoft.AspNetCore.Http.IHttpContextAccessor __httpContextAccessor1, Microsoft.AspNetCore.Http.IHttpContextAccessor __httpContextAccessor2, Microsoft.EntityFrameworkCore.DbContextOptions dbContextOptions, Microsoft.Extensions.DependencyInjection.IServiceScopeFactory serviceScopeFactory, Microsoft.Extensions.Logging.ILogger<Wayd.Common.Application.Behaviors.PerformanceBehaviorLog> loggerOfPerformanceBehaviorLog, Microsoft.Extensions.Logging.ILogger<Wayd.Infrastructure.Common.Services.EventPublisher> loggerOfEventPublisher, Microsoft.Extensions.Logging.ILogger<Wayd.ProjectPortfolioManagement.Application.StrategicInitiatives.Commands.Kpis.AddStrategicInitiativeKpiMeasurementCommandHandler> loggerOfAddStrategicInitiativeKpiMeasurementCommandHandler, Microsoft.Extensions.Options.IOptions<Wayd.Infrastructure.Persistence.DatabaseSettings> optionsOfDatabaseSettings, System.Collections.Generic.IEnumerable<Wolverine.EntityFrameworkCore.IDomainEventScraper> domainEventScraperIEnumerable, System.TimeProvider timeProvider, Wolverine.FluentValidation.IFailureAction<Wayd.ProjectPortfolioManagement.Application.StrategicInitiatives.Commands.Kpis.AddStrategicInitiativeKpiMeasurementCommand> failureActionOfAddStrategicInitiativeKpiMeasurementCommand, Wolverine.Runtime.IWolverineRuntime wolverineRuntime)
        {
        ...
        public override async System.Threading.Tasks.Task HandleAsync(Wolverine.Runtime.MessageContext context, System.Threading.CancellationToken cancellation)
        {
            ...
            try
            {
                ...
                await Wolverine.FluentValidation.Internals.FluentValidationExecutor.ExecuteOne<Wayd.ProjectPortfolioManagement.Application.StrategicInitiatives.Commands.Kpis.AddStrategicInitiativeKpiMeasurementCommand>(addStrategicInitiativeKpiMeasurementCommandValidator, _failureActionOfAddStrategicInitiativeKpiMeasurementCommand, addStrategicInitiativeKpiMeasurementCommand).ConfigureAwait(false);
                var addStrategicInitiativeKpiMeasurementCommandHandler = new Wayd.ProjectPortfolioManagement.Application.StrategicInitiatives.Commands.Kpis.AddStrategicInitiativeKpiMeasurementCommandHandler(waydDbContext, _loggerOfAddStrategicInitiativeKpiMeasurementCommandHandler, dateTimeProvider, currentUser);
