...
{
    // START: AddSwimLaneCommandHandler1875748134
    [global::System.CodeDom.Compiler.GeneratedCode("JasperFx", "1.0.0")]
    public sealed class AddSwimLaneCommandHandler1875748134 : Wolverine.Runtime.Handlers.MessageHandler
    {
        ...
        private readonly Microsoft.Extensions.Logging.ILogger<Wayd.Planning.Application.StoryMaps.Commands.AddSwimLaneCommandHandler> _loggerOfAddSwimLaneCommandHandler;
        ...
        private readonly Wolverine.FluentValidation.IFailureAction<Wayd.Planning.Application.StoryMaps.Commands.AddSwimLaneCommand> _failureActionOfAddSwimLaneCommand;
        private readonly Wolverine.Runtime.IWolverineRuntime _wolverineRuntime;

        public AddSwimLaneCommandHandler1875748134(Microsoft.AspNetCore.Http.IHttpContextAccessor __httpContextAccessor1, Microsoft.AspNetCore.Http.IHttpContextAccessor __httpContextAccessor2, Microsoft.EntityFrameworkCore.DbContextOptions dbContextOptions, Microsoft.Extensions.DependencyInjection.IServiceScopeFactory serviceScopeFactory, Microsoft.Extensions.Logging.ILogger<Wayd.Common.Application.Behaviors.PerformanceBehaviorLog> loggerOfPerformanceBehaviorLog, Microsoft.Extensions.Logging.ILogger<Wayd.Infrastructure.Common.Services.EventPublisher> loggerOfEventPublisher, Microsoft.Extensions.Logging.ILogger<Wayd.Planning.Application.StoryMaps.Commands.AddSwimLaneCommandHandler> loggerOfAddSwimLaneCommandHandler, Microsoft.Extensions.Options.IOptions<Wayd.Infrastructure.Persistence.DatabaseSettings> optionsOfDatabaseSettings, System.Collections.Generic.IEnumerable<Wolverine.EntityFrameworkCore.IDomainEventScraper> domainEventScraperIEnumerable, System.TimeProvider timeProvider, Wolverine.FluentValidation.IFailureAction<Wayd.Planning.Application.StoryMaps.Commands.AddSwimLaneCommand> failureActionOfAddSwimLaneCommand, Wolverine.Runtime.IWolverineRuntime wolverineRuntime)
        {
            ...
            _loggerOfAddSwimLaneCommandHandler = loggerOfAddSwimLaneCommandHandler;
            _optionsOfDatabaseSettings = optionsOfDatabaseSettings;
            _domainEventScraperIEnumerable = domainEventScraperIEnumerable;
            _timeProvider = timeProvider;
            _failureActionOfAddSwimLaneCommand = failureActionOfAddSwimLaneCommand;
        ...
        public override async System.Threading.Tasks.Task HandleAsync(Wolverine.Runtime.MessageContext context, System.Threading.CancellationToken cancellation)
        {
            ...
            var addSwimLaneCommandValidator = new Wayd.Planning.Application.StoryMaps.Commands.AddSwimLaneCommandValidator();
            // The actual message body
            var addSwimLaneCommand = (Wayd.Planning.Application.StoryMaps.Commands.AddSwimLaneCommand)context.Envelope.Message;
            ...
            try
            {
                System.Diagnostics.Activity.Current?.SetTag("message.handler", "Wayd.Planning.Application.StoryMaps.Commands.AddSwimLaneCommandHandler");
                System.Diagnostics.Activity.Current?.SetTag("handler.type", "Wayd.Planning.Application.StoryMaps.Commands.AddSwimLaneCommandHandler");
                await Wolverine.FluentValidation.Internals.FluentValidationExecutor.ExecuteOne<Wayd.Planning.Application.StoryMaps.Commands.AddSwimLaneCommand>(addSwimLaneCommandValidator, _failureActionOfAddSwimLaneCommand, addSwimLaneCommand).ConfigureAwait(false);
                var addSwimLaneCommandHandler = new Wayd.Planning.Application.StoryMaps.Commands.AddSwimLaneCommandHandler(waydDbContext, storyMapNotifier, _loggerOfAddSwimLaneCommandHandler);
                
                // The actual message execution
                var outgoing1 = await addSwimLaneCommandHandler.Handle(addSwimLaneCommand, cancellation).ConfigureAwait(false);
    ...
    // END: AddSwimLaneCommandHandler1875748134
