...
{
    // START: AddTaskCommandHandler17281689
    [global::System.CodeDom.Compiler.GeneratedCode("JasperFx", "1.0.0")]
    public sealed class AddTaskCommandHandler17281689 : Wolverine.Runtime.Handlers.MessageHandler
    {
        ...
        private readonly Microsoft.Extensions.Logging.ILogger<Wayd.Planning.Application.StoryMaps.Commands.AddTaskCommandHandler> _loggerOfAddTaskCommandHandler;
        ...
        private readonly Wolverine.FluentValidation.IFailureAction<Wayd.Planning.Application.StoryMaps.Commands.AddTaskCommand> _failureActionOfAddTaskCommand;
        private readonly Wolverine.Runtime.IWolverineRuntime _wolverineRuntime;

        public AddTaskCommandHandler17281689(Microsoft.AspNetCore.Http.IHttpContextAccessor __httpContextAccessor1, Microsoft.AspNetCore.Http.IHttpContextAccessor __httpContextAccessor2, Microsoft.EntityFrameworkCore.DbContextOptions dbContextOptions, Microsoft.Extensions.DependencyInjection.IServiceScopeFactory serviceScopeFactory, Microsoft.Extensions.Logging.ILogger<Wayd.Common.Application.Behaviors.PerformanceBehaviorLog> loggerOfPerformanceBehaviorLog, Microsoft.Extensions.Logging.ILogger<Wayd.Infrastructure.Common.Services.EventPublisher> loggerOfEventPublisher, Microsoft.Extensions.Logging.ILogger<Wayd.Planning.Application.StoryMaps.Commands.AddTaskCommandHandler> loggerOfAddTaskCommandHandler, Microsoft.Extensions.Options.IOptions<Wayd.Infrastructure.Persistence.DatabaseSettings> optionsOfDatabaseSettings, System.Collections.Generic.IEnumerable<Wolverine.EntityFrameworkCore.IDomainEventScraper> domainEventScraperIEnumerable, System.TimeProvider timeProvider, Wolverine.FluentValidation.IFailureAction<Wayd.Planning.Application.StoryMaps.Commands.AddTaskCommand> failureActionOfAddTaskCommand, Wolverine.Runtime.IWolverineRuntime wolverineRuntime)
        {
            ...
            _loggerOfAddTaskCommandHandler = loggerOfAddTaskCommandHandler;
            _optionsOfDatabaseSettings = optionsOfDatabaseSettings;
            _domainEventScraperIEnumerable = domainEventScraperIEnumerable;
            _timeProvider = timeProvider;
            _failureActionOfAddTaskCommand = failureActionOfAddTaskCommand;
        ...
        public override async System.Threading.Tasks.Task HandleAsync(Wolverine.Runtime.MessageContext context, System.Threading.CancellationToken cancellation)
        {
            ...
            var addTaskCommandValidator = new Wayd.Planning.Application.StoryMaps.Commands.AddTaskCommandValidator();
            // The actual message body
            var addTaskCommand = (Wayd.Planning.Application.StoryMaps.Commands.AddTaskCommand)context.Envelope.Message;
            ...
            try
            {
                System.Diagnostics.Activity.Current?.SetTag("message.handler", "Wayd.Planning.Application.StoryMaps.Commands.AddTaskCommandHandler");
                System.Diagnostics.Activity.Current?.SetTag("handler.type", "Wayd.Planning.Application.StoryMaps.Commands.AddTaskCommandHandler");
                await Wolverine.FluentValidation.Internals.FluentValidationExecutor.ExecuteOne<Wayd.Planning.Application.StoryMaps.Commands.AddTaskCommand>(addTaskCommandValidator, _failureActionOfAddTaskCommand, addTaskCommand).ConfigureAwait(false);
                var addTaskCommandHandler = new Wayd.Planning.Application.StoryMaps.Commands.AddTaskCommandHandler(waydDbContext, storyMapNotifier, _loggerOfAddTaskCommandHandler);
                
                // The actual message execution
                var outgoing1 = await addTaskCommandHandler.Handle(addTaskCommand, cancellation).ConfigureAwait(false);
    ...
    // END: AddTaskCommandHandler17281689
