...
namespace Internal.Generated.WolverineHandlers
{
    ...
    public sealed class AddTeamMembershipCommandHandler504178351 : Wolverine.Runtime.Handlers.MessageHandler
    {
        ...
        public AddTeamMembershipCommandHandler504178351(Microsoft.AspNetCore.Http.IHttpContextAccessor __httpContextAccessor1, Microsoft.AspNetCore.Http.IHttpContextAccessor __httpContextAccessor2, Microsoft.EntityFrameworkCore.DbContextOptions dbContextOptions, Microsoft.Extensions.DependencyInjection.IServiceScopeFactory serviceScopeFactory, Microsoft.Extensions.Logging.ILogger<Wayd.Common.Application.Behaviors.PerformanceBehaviorLog> loggerOfPerformanceBehaviorLog, Microsoft.Extensions.Logging.ILogger<Wayd.Infrastructure.Common.Services.EventPublisher> loggerOfEventPublisher, Microsoft.Extensions.Logging.ILogger<Wayd.Organization.Application.Teams.Commands.AddTeamMembershipCommandHandler> loggerOfAddTeamMembershipCommandHandler, Microsoft.Extensions.Options.IOptions<Wayd.Infrastructure.Persistence.DatabaseSettings> optionsOfDatabaseSettings, System.Collections.Generic.IEnumerable<Wolverine.EntityFrameworkCore.IDomainEventScraper> domainEventScraperIEnumerable, System.TimeProvider timeProvider, Wolverine.FluentValidation.IFailureAction<Wayd.Organization.Application.Teams.Commands.AddTeamMembershipCommand> failureActionOfAddTeamMembershipCommand, Wolverine.Runtime.IWolverineRuntime wolverineRuntime)
        {
        ...
        public override async System.Threading.Tasks.Task HandleAsync(Wolverine.Runtime.MessageContext context, System.Threading.CancellationToken cancellation)
        {
            ...
            try
            {
                ...
                await Wolverine.FluentValidation.Internals.FluentValidationExecutor.ExecuteOne<Wayd.Organization.Application.Teams.Commands.AddTeamMembershipCommand>(addTeamMembershipCommandValidator, _failureActionOfAddTeamMembershipCommand, addTeamMembershipCommand).ConfigureAwait(false);
                var addTeamMembershipCommandHandler = new Wayd.Organization.Application.Teams.Commands.AddTeamMembershipCommandHandler(waydDbContext, dateTimeProvider, _loggerOfAddTeamMembershipCommandHandler);
