...
namespace Internal.Generated.WolverineHandlers
{
    ...
    public sealed class ArchiveFeatureFlagCommandHandler1167510142 : Wolverine.Runtime.Handlers.MessageHandler
    {
        ...
        public ArchiveFeatureFlagCommandHandler1167510142(Microsoft.AspNetCore.Http.IHttpContextAccessor __httpContextAccessor1, Microsoft.AspNetCore.Http.IHttpContextAccessor __httpContextAccessor2, Microsoft.EntityFrameworkCore.DbContextOptions dbContextOptions, Microsoft.Extensions.DependencyInjection.IServiceScopeFactory serviceScopeFactory, Microsoft.Extensions.Logging.ILogger<Wayd.Common.Application.Behaviors.PerformanceBehaviorLog> loggerOfPerformanceBehaviorLog, Microsoft.Extensions.Logging.ILogger<Wayd.Common.Application.FeatureManagement.Commands.ArchiveFeatureFlagCommandHandler> loggerOfArchiveFeatureFlagCommandHandler, Microsoft.Extensions.Logging.ILogger<Wayd.Infrastructure.Common.Services.EventPublisher> loggerOfEventPublisher, Microsoft.Extensions.Options.IOptions<Wayd.Infrastructure.Persistence.DatabaseSettings> optionsOfDatabaseSettings, System.Collections.Generic.IEnumerable<Wolverine.EntityFrameworkCore.IDomainEventScraper> domainEventScraperIEnumerable, System.TimeProvider timeProvider, Wayd.Common.Application.FeatureManagement.IFeatureFlagCacheInvalidator featureFlagCacheInvalidator, Wolverine.FluentValidation.IFailureAction<Wayd.Common.Application.FeatureManagement.Commands.ArchiveFeatureFlagCommand> failureActionOfArchiveFeatureFlagCommand, Wolverine.Runtime.IWolverineRuntime wolverineRuntime)
        {
        ...
        public override async System.Threading.Tasks.Task HandleAsync(Wolverine.Runtime.MessageContext context, System.Threading.CancellationToken cancellation)
        {
            ...
            try
            {
                ...
                await Wolverine.FluentValidation.Internals.FluentValidationExecutor.ExecuteOne<Wayd.Common.Application.FeatureManagement.Commands.ArchiveFeatureFlagCommand>(archiveFeatureFlagCommandValidator, _failureActionOfArchiveFeatureFlagCommand, archiveFeatureFlagCommand).ConfigureAwait(false);
                var archiveFeatureFlagCommandHandler = new Wayd.Common.Application.FeatureManagement.Commands.ArchiveFeatureFlagCommandHandler(waydDbContext, _featureFlagCacheInvalidator, _loggerOfArchiveFeatureFlagCommandHandler);
