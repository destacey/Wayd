...
{
    // START: ArchiveStoryMapCommandHandler666063460
    [global::System.CodeDom.Compiler.GeneratedCode("JasperFx", "1.0.0")]
    public sealed class ArchiveStoryMapCommandHandler666063460 : Wolverine.Runtime.Handlers.MessageHandler
    {
        ...
        private readonly Microsoft.Extensions.Logging.ILogger<Wayd.Planning.Application.StoryMaps.Commands.ArchiveStoryMapCommandHandler> _loggerOfArchiveStoryMapCommandHandler;
        ...
        private readonly Wolverine.FluentValidation.IFailureAction<Wayd.Planning.Application.StoryMaps.Commands.ArchiveStoryMapCommand> _failureActionOfArchiveStoryMapCommand;
        private readonly Wolverine.Runtime.IWolverineRuntime _wolverineRuntime;

        public ArchiveStoryMapCommandHandler666063460(Microsoft.AspNetCore.Http.IHttpContextAccessor __httpContextAccessor1, Microsoft.AspNetCore.Http.IHttpContextAccessor __httpContextAccessor2, Microsoft.EntityFrameworkCore.DbContextOptions dbContextOptions, Microsoft.Extensions.DependencyInjection.IServiceScopeFactory serviceScopeFactory, Microsoft.Extensions.Logging.ILogger<Wayd.Common.Application.Behaviors.PerformanceBehaviorLog> loggerOfPerformanceBehaviorLog, Microsoft.Extensions.Logging.ILogger<Wayd.Infrastructure.Common.Services.EventPublisher> loggerOfEventPublisher, Microsoft.Extensions.Logging.ILogger<Wayd.Planning.Application.StoryMaps.Commands.ArchiveStoryMapCommandHandler> loggerOfArchiveStoryMapCommandHandler, Microsoft.Extensions.Options.IOptions<Wayd.Infrastructure.Persistence.DatabaseSettings> optionsOfDatabaseSettings, System.Collections.Generic.IEnumerable<Wolverine.EntityFrameworkCore.IDomainEventScraper> domainEventScraperIEnumerable, System.TimeProvider timeProvider, Wolverine.FluentValidation.IFailureAction<Wayd.Planning.Application.StoryMaps.Commands.ArchiveStoryMapCommand> failureActionOfArchiveStoryMapCommand, Wolverine.Runtime.IWolverineRuntime wolverineRuntime)
        {
            ...
            _loggerOfArchiveStoryMapCommandHandler = loggerOfArchiveStoryMapCommandHandler;
            _optionsOfDatabaseSettings = optionsOfDatabaseSettings;
            _domainEventScraperIEnumerable = domainEventScraperIEnumerable;
            _timeProvider = timeProvider;
            _failureActionOfArchiveStoryMapCommand = failureActionOfArchiveStoryMapCommand;
        ...
        public override async System.Threading.Tasks.Task HandleAsync(Wolverine.Runtime.MessageContext context, System.Threading.CancellationToken cancellation)
        {
            ...
            var archiveStoryMapCommandValidator = new Wayd.Planning.Application.StoryMaps.Commands.ArchiveStoryMapCommandValidator();
            var systemTextJsonService = new Wayd.Infrastructure.Common.Services.SystemTextJsonService();
            // The actual message body
            var archiveStoryMapCommand = (Wayd.Planning.Application.StoryMaps.Commands.ArchiveStoryMapCommand)context.Envelope.Message;
            ...
            try
            {
                System.Diagnostics.Activity.Current?.SetTag("message.handler", "Wayd.Planning.Application.StoryMaps.Commands.ArchiveStoryMapCommandHandler");
                System.Diagnostics.Activity.Current?.SetTag("handler.type", "Wayd.Planning.Application.StoryMaps.Commands.ArchiveStoryMapCommandHandler");
                await Wolverine.FluentValidation.Internals.FluentValidationExecutor.ExecuteOne<Wayd.Planning.Application.StoryMaps.Commands.ArchiveStoryMapCommand>(archiveStoryMapCommandValidator, _failureActionOfArchiveStoryMapCommand, archiveStoryMapCommand).ConfigureAwait(false);
                var archiveStoryMapCommandHandler = new Wayd.Planning.Application.StoryMaps.Commands.ArchiveStoryMapCommandHandler(waydDbContext, storyMapNotifier, _loggerOfArchiveStoryMapCommandHandler);
                
                // The actual message execution
                var outgoing1 = await archiveStoryMapCommandHandler.Handle(archiveStoryMapCommand, cancellation).ConfigureAwait(false);
    ...
    // END: ArchiveStoryMapCommandHandler666063460
