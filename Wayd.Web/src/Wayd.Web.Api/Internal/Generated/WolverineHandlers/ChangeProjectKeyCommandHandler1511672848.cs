...
namespace Internal.Generated.WolverineHandlers
{
    ...
    public sealed class ChangeProjectKeyCommandHandler1511672848 : Wolverine.Runtime.Handlers.MessageHandler
    {
        ...
        public ChangeProjectKeyCommandHandler1511672848(Microsoft.AspNetCore.Http.IHttpContextAccessor __httpContextAccessor1, Microsoft.AspNetCore.Http.IHttpContextAccessor __httpContextAccessor2, Microsoft.EntityFrameworkCore.DbContextOptions dbContextOptions, Microsoft.Extensions.DependencyInjection.IServiceScopeFactory serviceScopeFactory, Microsoft.Extensions.Logging.ILogger<Wayd.Common.Application.Behaviors.PerformanceBehaviorLog> loggerOfPerformanceBehaviorLog, Microsoft.Extensions.Logging.ILogger<Wayd.Infrastructure.Common.Services.EventPublisher> loggerOfEventPublisher, Microsoft.Extensions.Logging.ILogger<Wayd.ProjectPortfolioManagement.Application.Projects.Commands.ChangeProjectKeyCommandHandler> loggerOfChangeProjectKeyCommandHandler, Microsoft.Extensions.Options.IOptions<Wayd.Infrastructure.Persistence.DatabaseSettings> optionsOfDatabaseSettings, System.Collections.Generic.IEnumerable<Wolverine.EntityFrameworkCore.IDomainEventScraper> domainEventScraperIEnumerable, System.TimeProvider timeProvider, Wolverine.FluentValidation.IFailureAction<Wayd.ProjectPortfolioManagement.Application.Projects.Commands.ChangeProjectKeyCommand> failureActionOfChangeProjectKeyCommand, Wolverine.Runtime.IWolverineRuntime wolverineRuntime)
        {
        ...
        public override async System.Threading.Tasks.Task HandleAsync(Wolverine.Runtime.MessageContext context, System.Threading.CancellationToken cancellation)
        {
            ...
            var changeProjectKeyCommandValidator = new Wayd.ProjectPortfolioManagement.Application.Projects.Commands.ChangeProjectKeyCommandValidator(waydDbContext);
            ...
            try
            {
                ...
                await Wolverine.FluentValidation.Internals.FluentValidationExecutor.ExecuteOne<Wayd.ProjectPortfolioManagement.Application.Projects.Commands.ChangeProjectKeyCommand>(changeProjectKeyCommandValidator, _failureActionOfChangeProjectKeyCommand, changeProjectKeyCommand).ConfigureAwait(false);
                var changeProjectKeyCommandHandler = new Wayd.ProjectPortfolioManagement.Application.Projects.Commands.ChangeProjectKeyCommandHandler(waydDbContext, _loggerOfChangeProjectKeyCommandHandler, dateTimeProvider);
