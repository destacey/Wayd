...
{
    // START: ChangeStoryMapOwnerCommandHandler810704137
    [global::System.CodeDom.Compiler.GeneratedCode("JasperFx", "1.0.0")]
    public sealed class ChangeStoryMapOwnerCommandHandler810704137 : Wolverine.Runtime.Handlers.MessageHandler
    {
        ...
        private readonly Microsoft.Extensions.Logging.ILogger<Wayd.Planning.Application.StoryMaps.Commands.ChangeStoryMapOwnerCommandHandler> _loggerOfChangeStoryMapOwnerCommandHandler;
        ...
        private readonly Wolverine.FluentValidation.IFailureAction<Wayd.Planning.Application.StoryMaps.Commands.ChangeStoryMapOwnerCommand> _failureActionOfChangeStoryMapOwnerCommand;
        private readonly Wolverine.Runtime.IWolverineRuntime _wolverineRuntime;

        public ChangeStoryMapOwnerCommandHandler810704137(Microsoft.AspNetCore.Http.IHttpContextAccessor __httpContextAccessor1, Microsoft.AspNetCore.Http.IHttpContextAccessor __httpContextAccessor2, Microsoft.EntityFrameworkCore.DbContextOptions dbContextOptions, Microsoft.Extensions.DependencyInjection.IServiceScopeFactory serviceScopeFactory, Microsoft.Extensions.Logging.ILogger<Wayd.Common.Application.Behaviors.PerformanceBehaviorLog> loggerOfPerformanceBehaviorLog, Microsoft.Extensions.Logging.ILogger<Wayd.Infrastructure.Common.Services.EventPublisher> loggerOfEventPublisher, Microsoft.Extensions.Logging.ILogger<Wayd.Planning.Application.StoryMaps.Commands.ChangeStoryMapOwnerCommandHandler> loggerOfChangeStoryMapOwnerCommandHandler, Microsoft.Extensions.Options.IOptions<Wayd.Infrastructure.Persistence.DatabaseSettings> optionsOfDatabaseSettings, System.Collections.Generic.IEnumerable<Wolverine.EntityFrameworkCore.IDomainEventScraper> domainEventScraperIEnumerable, System.TimeProvider timeProvider, Wolverine.FluentValidation.IFailureAction<Wayd.Planning.Application.StoryMaps.Commands.ChangeStoryMapOwnerCommand> failureActionOfChangeStoryMapOwnerCommand, Wolverine.Runtime.IWolverineRuntime wolverineRuntime)
        {
            ...
            _loggerOfChangeStoryMapOwnerCommandHandler = loggerOfChangeStoryMapOwnerCommandHandler;
            _optionsOfDatabaseSettings = optionsOfDatabaseSettings;
            _domainEventScraperIEnumerable = domainEventScraperIEnumerable;
            _timeProvider = timeProvider;
            _failureActionOfChangeStoryMapOwnerCommand = failureActionOfChangeStoryMapOwnerCommand;
        ...
        public override async System.Threading.Tasks.Task HandleAsync(Wolverine.Runtime.MessageContext context, System.Threading.CancellationToken cancellation)
        {
            ...
            var changeStoryMapOwnerCommandValidator = new Wayd.Planning.Application.StoryMaps.Commands.ChangeStoryMapOwnerCommandValidator();
            // The actual message body
            var changeStoryMapOwnerCommand = (Wayd.Planning.Application.StoryMaps.Commands.ChangeStoryMapOwnerCommand)context.Envelope.Message;
            ...
            try
            {
                System.Diagnostics.Activity.Current?.SetTag("message.handler", "Wayd.Planning.Application.StoryMaps.Commands.ChangeStoryMapOwnerCommandHandler");
                System.Diagnostics.Activity.Current?.SetTag("handler.type", "Wayd.Planning.Application.StoryMaps.Commands.ChangeStoryMapOwnerCommandHandler");
                await Wolverine.FluentValidation.Internals.FluentValidationExecutor.ExecuteOne<Wayd.Planning.Application.StoryMaps.Commands.ChangeStoryMapOwnerCommand>(changeStoryMapOwnerCommandValidator, _failureActionOfChangeStoryMapOwnerCommand, changeStoryMapOwnerCommand).ConfigureAwait(false);
                var changeStoryMapOwnerCommandHandler = new Wayd.Planning.Application.StoryMaps.Commands.ChangeStoryMapOwnerCommandHandler(waydDbContext, storyMapNotifier, _loggerOfChangeStoryMapOwnerCommandHandler);
                
                // The actual message execution
                var outgoing1 = await changeStoryMapOwnerCommandHandler.Handle(changeStoryMapOwnerCommand, cancellation).ConfigureAwait(false);
    ...
    // END: ChangeStoryMapOwnerCommandHandler810704137
