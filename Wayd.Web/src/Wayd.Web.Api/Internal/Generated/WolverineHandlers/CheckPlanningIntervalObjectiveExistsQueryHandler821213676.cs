...
{
    // START: CheckPlanningIntervalObjectiveExistsQueryHandler821213676
    [global::System.CodeDom.Compiler.GeneratedCode("JasperFx", "1.0.0")]
    public sealed class CheckPlanningIntervalObjectiveExistsQueryHandler821213676 : Wolverine.Runtime.Handlers.MessageHandler
    {
        ...
        public override async System.Threading.Tasks.Task HandleAsync(Wolverine.Runtime.MessageContext context, System.Threading.CancellationToken cancellation)
        {
            ...
            var checkPlanningIntervalObjectiveExistsQuery = (Wayd.Planning.Application.PlanningIntervals.Queries.CheckPlanningIntervalObjectiveExistsQuery)context.Envelope.Message;
            ...
            try
            {
                System.Diagnostics.Activity.Current?.SetTag("message.handler", "Wayd.Planning.Application.PlanningIntervals.Queries.CheckPlanningIntervalObjectiveExistsQueryHandler");
                System.Diagnostics.Activity.Current?.SetTag("handler.type", "Wayd.Planning.Application.PlanningIntervals.Queries.CheckPlanningIntervalObjectiveExistsQueryHandler");
                var checkPlanningIntervalObjectiveExistsQueryHandler = new Wayd.Planning.Application.PlanningIntervals.Queries.CheckPlanningIntervalObjectiveExistsQueryHandler(waydDbContext);
                
                // The actual message execution
                var outgoing1 = await checkPlanningIntervalObjectiveExistsQueryHandler.Handle(checkPlanningIntervalObjectiveExistsQuery, cancellation).ConfigureAwait(false);
    ...
    // END: CheckPlanningIntervalObjectiveExistsQueryHandler821213676
