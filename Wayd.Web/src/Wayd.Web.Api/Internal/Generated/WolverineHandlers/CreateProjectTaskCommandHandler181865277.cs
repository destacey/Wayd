...
namespace Internal.Generated.WolverineHandlers
{
    ...
    public sealed class CreateProjectTaskCommandHandler181865277 : Wolverine.Runtime.Handlers.MessageHandler
    {
        ...
        public CreateProjectTaskCommandHandler181865277(Microsoft.AspNetCore.Http.IHttpContextAccessor __httpContextAccessor1, Microsoft.AspNetCore.Http.IHttpContextAccessor __httpContextAccessor2, Microsoft.EntityFrameworkCore.DbContextOptions dbContextOptions, Microsoft.Extensions.DependencyInjection.IServiceScopeFactory serviceScopeFactory, Microsoft.Extensions.Logging.ILogger<Wayd.Common.Application.Behaviors.PerformanceBehaviorLog> loggerOfPerformanceBehaviorLog, Microsoft.Extensions.Logging.ILogger<Wayd.Infrastructure.Common.Services.EventPublisher> loggerOfEventPublisher, Microsoft.Extensions.Logging.ILogger<Wayd.ProjectPortfolioManagement.Application.ProjectTasks.Commands.CreateProjectTaskCommandHandler> loggerOfCreateProjectTaskCommandHandler, Microsoft.Extensions.Options.IOptions<Wayd.Infrastructure.Persistence.DatabaseSettings> optionsOfDatabaseSettings, System.Collections.Generic.IEnumerable<Wolverine.EntityFrameworkCore.IDomainEventScraper> domainEventScraperIEnumerable, System.TimeProvider timeProvider, Wolverine.FluentValidation.IFailureAction<Wayd.ProjectPortfolioManagement.Application.ProjectTasks.Commands.CreateProjectTaskCommand> failureActionOfCreateProjectTaskCommand, Wolverine.Runtime.IWolverineRuntime wolverineRuntime)
        {
        ...
        public override async System.Threading.Tasks.Task HandleAsync(Wolverine.Runtime.MessageContext context, System.Threading.CancellationToken cancellation)
        {
            ...
            try
            {
                ...
                await Wolverine.FluentValidation.Internals.FluentValidationExecutor.ExecuteOne<Wayd.ProjectPortfolioManagement.Application.ProjectTasks.Commands.CreateProjectTaskCommand>(createProjectTaskCommandValidator, _failureActionOfCreateProjectTaskCommand, createProjectTaskCommand).ConfigureAwait(false);
                var createProjectTaskCommandHandler = new Wayd.ProjectPortfolioManagement.Application.ProjectTasks.Commands.CreateProjectTaskCommandHandler(waydDbContext, _loggerOfCreateProjectTaskCommandHandler);
