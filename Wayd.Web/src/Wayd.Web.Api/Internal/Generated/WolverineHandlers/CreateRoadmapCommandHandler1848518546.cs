...
namespace Internal.Generated.WolverineHandlers
{
    ...
    public sealed class CreateRoadmapCommandHandler1848518546 : Wolverine.Runtime.Handlers.MessageHandler
    {
        ...
        public CreateRoadmapCommandHandler1848518546(Microsoft.AspNetCore.Http.IHttpContextAccessor __httpContextAccessor1, Microsoft.AspNetCore.Http.IHttpContextAccessor __httpContextAccessor2, Microsoft.EntityFrameworkCore.DbContextOptions dbContextOptions, Microsoft.Extensions.DependencyInjection.IServiceScopeFactory serviceScopeFactory, Microsoft.Extensions.Logging.ILogger<Wayd.Common.Application.Behaviors.PerformanceBehaviorLog> loggerOfPerformanceBehaviorLog, Microsoft.Extensions.Logging.ILogger<Wayd.Infrastructure.Common.Services.EventPublisher> loggerOfEventPublisher, Microsoft.Extensions.Logging.ILogger<Wayd.Planning.Application.Roadmaps.Commands.CreateRoadmapCommandHandler> loggerOfCreateRoadmapCommandHandler, Microsoft.Extensions.Options.IOptions<Wayd.Infrastructure.Persistence.DatabaseSettings> optionsOfDatabaseSettings, System.Collections.Generic.IEnumerable<Wolverine.EntityFrameworkCore.IDomainEventScraper> domainEventScraperIEnumerable, System.TimeProvider timeProvider, Wolverine.FluentValidation.IFailureAction<Wayd.Planning.Application.Roadmaps.Commands.CreateRoadmapCommand> failureActionOfCreateRoadmapCommand, Wolverine.Runtime.IWolverineRuntime wolverineRuntime)
        {
        ...
        public override async System.Threading.Tasks.Task HandleAsync(Wolverine.Runtime.MessageContext context, System.Threading.CancellationToken cancellation)
        {
            ...
            try
            {
                ...
                await Wolverine.FluentValidation.Internals.FluentValidationExecutor.ExecuteOne<Wayd.Planning.Application.Roadmaps.Commands.CreateRoadmapCommand>(createRoadmapCommandValidator, _failureActionOfCreateRoadmapCommand, createRoadmapCommand).ConfigureAwait(false);
                var createRoadmapCommandHandler = new Wayd.Planning.Application.Roadmaps.Commands.CreateRoadmapCommandHandler(waydDbContext, _loggerOfCreateRoadmapCommandHandler);
