...
{
    // START: CreateStoryMapCommandHandler1927348466
    [global::System.CodeDom.Compiler.GeneratedCode("JasperFx", "1.0.0")]
    public sealed class CreateStoryMapCommandHandler1927348466 : Wolverine.Runtime.Handlers.MessageHandler
    {
        ...
        private readonly Microsoft.Extensions.Logging.ILogger<Wayd.Planning.Application.StoryMaps.Commands.CreateStoryMapCommandHandler> _loggerOfCreateStoryMapCommandHandler;
        ...
        private readonly Wolverine.FluentValidation.IFailureAction<Wayd.Planning.Application.StoryMaps.Commands.CreateStoryMapCommand> _failureActionOfCreateStoryMapCommand;
        private readonly Wolverine.Runtime.IWolverineRuntime _wolverineRuntime;

        public CreateStoryMapCommandHandler1927348466(Microsoft.AspNetCore.Http.IHttpContextAccessor __httpContextAccessor1, Microsoft.AspNetCore.Http.IHttpContextAccessor __httpContextAccessor2, Microsoft.EntityFrameworkCore.DbContextOptions dbContextOptions, Microsoft.Extensions.DependencyInjection.IServiceScopeFactory serviceScopeFactory, Microsoft.Extensions.Logging.ILogger<Wayd.Common.Application.Behaviors.PerformanceBehaviorLog> loggerOfPerformanceBehaviorLog, Microsoft.Extensions.Logging.ILogger<Wayd.Infrastructure.Common.Services.EventPublisher> loggerOfEventPublisher, Microsoft.Extensions.Logging.ILogger<Wayd.Planning.Application.StoryMaps.Commands.CreateStoryMapCommandHandler> loggerOfCreateStoryMapCommandHandler, Microsoft.Extensions.Options.IOptions<Wayd.Infrastructure.Persistence.DatabaseSettings> optionsOfDatabaseSettings, System.Collections.Generic.IEnumerable<Wolverine.EntityFrameworkCore.IDomainEventScraper> domainEventScraperIEnumerable, System.TimeProvider timeProvider, Wolverine.FluentValidation.IFailureAction<Wayd.Planning.Application.StoryMaps.Commands.CreateStoryMapCommand> failureActionOfCreateStoryMapCommand, Wolverine.Runtime.IWolverineRuntime wolverineRuntime)
        {
            ...
            _loggerOfCreateStoryMapCommandHandler = loggerOfCreateStoryMapCommandHandler;
            _optionsOfDatabaseSettings = optionsOfDatabaseSettings;
            _domainEventScraperIEnumerable = domainEventScraperIEnumerable;
            _timeProvider = timeProvider;
            _failureActionOfCreateStoryMapCommand = failureActionOfCreateStoryMapCommand;
        ...
        public override async System.Threading.Tasks.Task HandleAsync(Wolverine.Runtime.MessageContext context, System.Threading.CancellationToken cancellation)
        {
            ...
            var createStoryMapCommandValidator = new Wayd.Planning.Application.StoryMaps.Commands.CreateStoryMapCommandValidator();
            ...
            var createStoryMapCommand = (Wayd.Planning.Application.StoryMaps.Commands.CreateStoryMapCommand)context.Envelope.Message;
            ...
            try
            {
                System.Diagnostics.Activity.Current?.SetTag("message.handler", "Wayd.Planning.Application.StoryMaps.Commands.CreateStoryMapCommandHandler");
                System.Diagnostics.Activity.Current?.SetTag("handler.type", "Wayd.Planning.Application.StoryMaps.Commands.CreateStoryMapCommandHandler");
                await Wolverine.FluentValidation.Internals.FluentValidationExecutor.ExecuteOne<Wayd.Planning.Application.StoryMaps.Commands.CreateStoryMapCommand>(createStoryMapCommandValidator, _failureActionOfCreateStoryMapCommand, createStoryMapCommand).ConfigureAwait(false);
                var createStoryMapCommandHandler = new Wayd.Planning.Application.StoryMaps.Commands.CreateStoryMapCommandHandler(waydDbContext, currentUser, _loggerOfCreateStoryMapCommandHandler);
                
                // The actual message execution
                var outgoing1 = await createStoryMapCommandHandler.Handle(createStoryMapCommand, cancellation).ConfigureAwait(false);
    ...
    // END: CreateStoryMapCommandHandler1927348466
