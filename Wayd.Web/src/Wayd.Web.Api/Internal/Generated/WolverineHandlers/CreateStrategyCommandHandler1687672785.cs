...
namespace Internal.Generated.WolverineHandlers
{
    ...
    public sealed class CreateStrategyCommandHandler1687672785 : Wolverine.Runtime.Handlers.MessageHandler
    {
        ...
        public CreateStrategyCommandHandler1687672785(Microsoft.AspNetCore.Http.IHttpContextAccessor __httpContextAccessor1, Microsoft.AspNetCore.Http.IHttpContextAccessor __httpContextAccessor2, Microsoft.EntityFrameworkCore.DbContextOptions dbContextOptions, Microsoft.Extensions.DependencyInjection.IServiceScopeFactory serviceScopeFactory, Microsoft.Extensions.Logging.ILogger<Wayd.Common.Application.Behaviors.PerformanceBehaviorLog> loggerOfPerformanceBehaviorLog, Microsoft.Extensions.Logging.ILogger<Wayd.Infrastructure.Common.Services.EventPublisher> loggerOfEventPublisher, Microsoft.Extensions.Logging.ILogger<Wayd.StrategicManagement.Application.Strategies.Commands.CreateStrategyCommandHandler> loggerOfCreateStrategyCommandHandler, Microsoft.Extensions.Options.IOptions<Wayd.Infrastructure.Persistence.DatabaseSettings> optionsOfDatabaseSettings, System.Collections.Generic.IEnumerable<Wolverine.EntityFrameworkCore.IDomainEventScraper> domainEventScraperIEnumerable, System.TimeProvider timeProvider, Wolverine.FluentValidation.IFailureAction<Wayd.StrategicManagement.Application.Strategies.Commands.CreateStrategyCommand> failureActionOfCreateStrategyCommand, Wolverine.Runtime.IWolverineRuntime wolverineRuntime)
        {
        ...
        public override async System.Threading.Tasks.Task HandleAsync(Wolverine.Runtime.MessageContext context, System.Threading.CancellationToken cancellation)
        {
            ...
            try
            {
                ...
                await Wolverine.FluentValidation.Internals.FluentValidationExecutor.ExecuteOne<Wayd.StrategicManagement.Application.Strategies.Commands.CreateStrategyCommand>(createStrategyCommandValidator, _failureActionOfCreateStrategyCommand, createStrategyCommand).ConfigureAwait(false);
                var createStrategyCommandHandler = new Wayd.StrategicManagement.Application.Strategies.Commands.CreateStrategyCommandHandler(waydDbContext, _loggerOfCreateStrategyCommandHandler);
