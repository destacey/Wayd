...
namespace Internal.Generated.WolverineHandlers
{
    ...
    public sealed class CreateTeamCommandHandler249812508 : Wolverine.Runtime.Handlers.MessageHandler
    {
        ...
        public CreateTeamCommandHandler249812508(Microsoft.AspNetCore.Http.IHttpContextAccessor __httpContextAccessor1, Microsoft.AspNetCore.Http.IHttpContextAccessor __httpContextAccessor2, Microsoft.EntityFrameworkCore.DbContextOptions dbContextOptions, Microsoft.Extensions.DependencyInjection.IServiceScopeFactory serviceScopeFactory, Microsoft.Extensions.Logging.ILogger<Wayd.Common.Application.Behaviors.PerformanceBehaviorLog> loggerOfPerformanceBehaviorLog, Microsoft.Extensions.Logging.ILogger<Wayd.Infrastructure.Common.Services.EventPublisher> loggerOfEventPublisher, Microsoft.Extensions.Logging.ILogger<Wayd.Organization.Application.Teams.Commands.CreateTeamCommandHandler> loggerOfCreateTeamCommandHandler, Microsoft.Extensions.Options.IOptions<Wayd.Infrastructure.Persistence.DatabaseSettings> optionsOfDatabaseSettings, System.Collections.Generic.IEnumerable<Wolverine.EntityFrameworkCore.IDomainEventScraper> domainEventScraperIEnumerable, System.TimeProvider timeProvider, Wolverine.FluentValidation.IFailureAction<Wayd.Organization.Application.Teams.Commands.CreateTeamCommand> failureActionOfCreateTeamCommand, Wolverine.Runtime.IWolverineRuntime wolverineRuntime)
        {
        ...
        public override async System.Threading.Tasks.Task HandleAsync(Wolverine.Runtime.MessageContext context, System.Threading.CancellationToken cancellation)
        {
            ...
            try
            {
                ...
                await Wolverine.FluentValidation.Internals.FluentValidationExecutor.ExecuteOne<Wayd.Organization.Application.Teams.Commands.CreateTeamCommand>(createTeamCommandValidator, _failureActionOfCreateTeamCommand, createTeamCommand).ConfigureAwait(false);
                var createTeamCommandHandler = new Wayd.Organization.Application.Teams.Commands.CreateTeamCommandHandler(waydDbContext, dateTimeProvider, _loggerOfCreateTeamCommandHandler);
