...
namespace Internal.Generated.WolverineHandlers
{
    ...
    public sealed class CreateWorkTypeLevelCommandHandler1259366366 : Wolverine.Runtime.Handlers.MessageHandler
    {
        ...
        public CreateWorkTypeLevelCommandHandler1259366366(Microsoft.AspNetCore.Http.IHttpContextAccessor __httpContextAccessor1, Microsoft.AspNetCore.Http.IHttpContextAccessor __httpContextAccessor2, Microsoft.EntityFrameworkCore.DbContextOptions dbContextOptions, Microsoft.Extensions.DependencyInjection.IServiceScopeFactory serviceScopeFactory, Microsoft.Extensions.Logging.ILogger<Wayd.Common.Application.Behaviors.PerformanceBehaviorLog> loggerOfPerformanceBehaviorLog, Microsoft.Extensions.Logging.ILogger<Wayd.Infrastructure.Common.Services.EventPublisher> loggerOfEventPublisher, Microsoft.Extensions.Logging.ILogger<Wayd.Work.Application.WorkTypeLevels.Commands.CreateWorkTypeLevelCommandHandler> loggerOfCreateWorkTypeLevelCommandHandler, Microsoft.Extensions.Options.IOptions<Wayd.Infrastructure.Persistence.DatabaseSettings> optionsOfDatabaseSettings, System.Collections.Generic.IEnumerable<Wolverine.EntityFrameworkCore.IDomainEventScraper> domainEventScraperIEnumerable, System.TimeProvider timeProvider, Wolverine.FluentValidation.IFailureAction<Wayd.Work.Application.WorkTypeLevels.Commands.CreateWorkTypeLevelCommand> failureActionOfCreateWorkTypeLevelCommand, Wolverine.Runtime.IWolverineRuntime wolverineRuntime)
        {
        ...
        public override async System.Threading.Tasks.Task HandleAsync(Wolverine.Runtime.MessageContext context, System.Threading.CancellationToken cancellation)
        {
            ...
            try
            {
                ...
                await Wolverine.FluentValidation.Internals.FluentValidationExecutor.ExecuteOne<Wayd.Work.Application.WorkTypeLevels.Commands.CreateWorkTypeLevelCommand>(createWorkTypeLevelCommandValidator, _failureActionOfCreateWorkTypeLevelCommand, createWorkTypeLevelCommand).ConfigureAwait(false);
                var createWorkTypeLevelCommandHandler = new Wayd.Work.Application.WorkTypeLevels.Commands.CreateWorkTypeLevelCommandHandler(waydDbContext, dateTimeProvider, _loggerOfCreateWorkTypeLevelCommandHandler);
