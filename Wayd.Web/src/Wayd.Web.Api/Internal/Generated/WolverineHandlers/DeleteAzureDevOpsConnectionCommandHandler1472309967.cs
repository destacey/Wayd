...
{
    // START: DeleteAzureDevOpsConnectionCommandHandler1472309967
    [global::System.CodeDom.Compiler.GeneratedCode("JasperFx", "1.0.0")]
    public sealed class DeleteAzureDevOpsConnectionCommandHandler1472309967 : Wolverine.Runtime.Handlers.MessageHandler
    {
        ...
        private readonly Microsoft.Extensions.Logging.ILogger<Wayd.AppIntegration.Application.Connections.Commands.AzureDevOps.DeleteAzureDevOpsConnectionCommandHandler> _loggerOfDeleteAzureDevOpsConnectionCommandHandler;
        ...
        public DeleteAzureDevOpsConnectionCommandHandler1472309967(Microsoft.AspNetCore.Http.IHttpContextAccessor __httpContextAccessor1, Microsoft.AspNetCore.Http.IHttpContextAccessor __httpContextAccessor2, Microsoft.EntityFrameworkCore.DbContextOptions dbContextOptions, Microsoft.Extensions.DependencyInjection.IServiceScopeFactory serviceScopeFactory, Microsoft.Extensions.Logging.ILogger<Wayd.AppIntegration.Application.Connections.Commands.AzureDevOps.DeleteAzureDevOpsConnectionCommandHandler> loggerOfDeleteAzureDevOpsConnectionCommandHandler, Microsoft.Extensions.Logging.ILogger<Wayd.Common.Application.Behaviors.PerformanceBehaviorLog> loggerOfPerformanceBehaviorLog, Microsoft.Extensions.Logging.ILogger<Wayd.Infrastructure.Common.Services.EventPublisher> loggerOfEventPublisher, Microsoft.Extensions.Options.IOptions<Wayd.Infrastructure.Persistence.DatabaseSettings> optionsOfDatabaseSettings, System.Collections.Generic.IEnumerable<Wolverine.EntityFrameworkCore.IDomainEventScraper> domainEventScraperIEnumerable, System.TimeProvider timeProvider, Wolverine.Runtime.IWolverineRuntime wolverineRuntime)
        {
            _httpContextAccessor1 = __httpContextAccessor1;
            _httpContextAccessor2 = __httpContextAccessor2;
            _dbContextOptions = dbContextOptions;
            _serviceScopeFactory = serviceScopeFactory;
            _loggerOfDeleteAzureDevOpsConnectionCommandHandler = loggerOfDeleteAzureDevOpsConnectionCommandHandler;
        ...
        public override async System.Threading.Tasks.Task HandleAsync(Wolverine.Runtime.MessageContext context, System.Threading.CancellationToken cancellation)
        {
            ...
            var deleteAzureDevOpsConnectionCommand = (Wayd.AppIntegration.Application.Connections.Commands.AzureDevOps.DeleteAzureDevOpsConnectionCommand)context.Envelope.Message;
            ...
            try
            {
                System.Diagnostics.Activity.Current?.SetTag("message.handler", "Wayd.AppIntegration.Application.Connections.Commands.AzureDevOps.DeleteAzureDevOpsConnectionCommandHandler");
                System.Diagnostics.Activity.Current?.SetTag("handler.type", "Wayd.AppIntegration.Application.Connections.Commands.AzureDevOps.DeleteAzureDevOpsConnectionCommandHandler");
                var deleteAzureDevOpsConnectionCommandHandler = new Wayd.AppIntegration.Application.Connections.Commands.AzureDevOps.DeleteAzureDevOpsConnectionCommandHandler(waydDbContext, _loggerOfDeleteAzureDevOpsConnectionCommandHandler);
                
                // The actual message execution
                var outgoing1 = await deleteAzureDevOpsConnectionCommandHandler.Handle(deleteAzureDevOpsConnectionCommand, cancellation).ConfigureAwait(false);
    ...
    // END: DeleteAzureDevOpsConnectionCommandHandler1472309967
