...
{
    // START: DeleteEntraConnectionCommandHandler1396856303
    [global::System.CodeDom.Compiler.GeneratedCode("JasperFx", "1.0.0")]
    public sealed class DeleteEntraConnectionCommandHandler1396856303 : Wolverine.Runtime.Handlers.MessageHandler
    {
        ...
        private readonly Microsoft.Extensions.Logging.ILogger<Wayd.AppIntegration.Application.Connections.Commands.Entra.DeleteEntraConnectionCommandHandler> _loggerOfDeleteEntraConnectionCommandHandler;
        ...
        public DeleteEntraConnectionCommandHandler1396856303(Microsoft.AspNetCore.Http.IHttpContextAccessor __httpContextAccessor1, Microsoft.AspNetCore.Http.IHttpContextAccessor __httpContextAccessor2, Microsoft.EntityFrameworkCore.DbContextOptions dbContextOptions, Microsoft.Extensions.DependencyInjection.IServiceScopeFactory serviceScopeFactory, Microsoft.Extensions.Logging.ILogger<Wayd.AppIntegration.Application.Connections.Commands.Entra.DeleteEntraConnectionCommandHandler> loggerOfDeleteEntraConnectionCommandHandler, Microsoft.Extensions.Logging.ILogger<Wayd.Common.Application.Behaviors.PerformanceBehaviorLog> loggerOfPerformanceBehaviorLog, Microsoft.Extensions.Logging.ILogger<Wayd.Infrastructure.Common.Services.EventPublisher> loggerOfEventPublisher, Microsoft.Extensions.Options.IOptions<Wayd.Infrastructure.Persistence.DatabaseSettings> optionsOfDatabaseSettings, System.Collections.Generic.IEnumerable<Wolverine.EntityFrameworkCore.IDomainEventScraper> domainEventScraperIEnumerable, System.TimeProvider timeProvider, Wolverine.Runtime.IWolverineRuntime wolverineRuntime)
        {
            _httpContextAccessor1 = __httpContextAccessor1;
            _httpContextAccessor2 = __httpContextAccessor2;
            _dbContextOptions = dbContextOptions;
            _serviceScopeFactory = serviceScopeFactory;
            _loggerOfDeleteEntraConnectionCommandHandler = loggerOfDeleteEntraConnectionCommandHandler;
        ...
        public override async System.Threading.Tasks.Task HandleAsync(Wolverine.Runtime.MessageContext context, System.Threading.CancellationToken cancellation)
        {
            ...
            try
            {
                System.Diagnostics.Activity.Current?.SetTag("message.handler", "Wayd.AppIntegration.Application.Connections.Commands.Entra.DeleteEntraConnectionCommandHandler");
                System.Diagnostics.Activity.Current?.SetTag("handler.type", "Wayd.AppIntegration.Application.Connections.Commands.Entra.DeleteEntraConnectionCommandHandler");
                var deleteEntraConnectionCommandHandler = new Wayd.AppIntegration.Application.Connections.Commands.Entra.DeleteEntraConnectionCommandHandler(waydDbContext, _loggerOfDeleteEntraConnectionCommandHandler);
                
                // The actual message execution
                var outgoing1 = await deleteEntraConnectionCommandHandler.Handle(deleteEntraConnectionCommand, cancellation).ConfigureAwait(false);
    ...
    // END: DeleteEntraConnectionCommandHandler1396856303
