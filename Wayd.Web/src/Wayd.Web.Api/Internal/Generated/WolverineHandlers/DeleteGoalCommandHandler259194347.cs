...
{
    // START: DeleteGoalCommandHandler259194347
    [global::System.CodeDom.Compiler.GeneratedCode("JasperFx", "1.0.0")]
    public sealed class DeleteGoalCommandHandler259194347 : Wolverine.Runtime.Handlers.MessageHandler
    {
        ...
        private readonly Microsoft.Extensions.Logging.ILogger<Wayd.Planning.Application.StoryMaps.Commands.DeleteGoalCommandHandler> _loggerOfDeleteGoalCommandHandler;
        ...
        private readonly Wolverine.FluentValidation.IFailureAction<Wayd.Planning.Application.StoryMaps.Commands.DeleteGoalCommand> _failureActionOfDeleteGoalCommand;
        private readonly Wolverine.Runtime.IWolverineRuntime _wolverineRuntime;

        public DeleteGoalCommandHandler259194347(Microsoft.AspNetCore.Http.IHttpContextAccessor __httpContextAccessor1, Microsoft.AspNetCore.Http.IHttpContextAccessor __httpContextAccessor2, Microsoft.EntityFrameworkCore.DbContextOptions dbContextOptions, Microsoft.Extensions.DependencyInjection.IServiceScopeFactory serviceScopeFactory, Microsoft.Extensions.Logging.ILogger<Wayd.Common.Application.Behaviors.PerformanceBehaviorLog> loggerOfPerformanceBehaviorLog, Microsoft.Extensions.Logging.ILogger<Wayd.Infrastructure.Common.Services.EventPublisher> loggerOfEventPublisher, Microsoft.Extensions.Logging.ILogger<Wayd.Planning.Application.StoryMaps.Commands.DeleteGoalCommandHandler> loggerOfDeleteGoalCommandHandler, Microsoft.Extensions.Options.IOptions<Wayd.Infrastructure.Persistence.DatabaseSettings> optionsOfDatabaseSettings, System.Collections.Generic.IEnumerable<Wolverine.EntityFrameworkCore.IDomainEventScraper> domainEventScraperIEnumerable, System.TimeProvider timeProvider, Wolverine.FluentValidation.IFailureAction<Wayd.Planning.Application.StoryMaps.Commands.DeleteGoalCommand> failureActionOfDeleteGoalCommand, Wolverine.Runtime.IWolverineRuntime wolverineRuntime)
        {
            ...
            _loggerOfDeleteGoalCommandHandler = loggerOfDeleteGoalCommandHandler;
            _optionsOfDatabaseSettings = optionsOfDatabaseSettings;
            _domainEventScraperIEnumerable = domainEventScraperIEnumerable;
            _timeProvider = timeProvider;
            _failureActionOfDeleteGoalCommand = failureActionOfDeleteGoalCommand;
        ...
        public override async System.Threading.Tasks.Task HandleAsync(Wolverine.Runtime.MessageContext context, System.Threading.CancellationToken cancellation)
        {
            ...
            var deleteGoalCommandValidator = new Wayd.Planning.Application.StoryMaps.Commands.DeleteGoalCommandValidator();
            // The actual message body
            var deleteGoalCommand = (Wayd.Planning.Application.StoryMaps.Commands.DeleteGoalCommand)context.Envelope.Message;
            ...
            try
            {
                System.Diagnostics.Activity.Current?.SetTag("message.handler", "Wayd.Planning.Application.StoryMaps.Commands.DeleteGoalCommandHandler");
                System.Diagnostics.Activity.Current?.SetTag("handler.type", "Wayd.Planning.Application.StoryMaps.Commands.DeleteGoalCommandHandler");
                await Wolverine.FluentValidation.Internals.FluentValidationExecutor.ExecuteOne<Wayd.Planning.Application.StoryMaps.Commands.DeleteGoalCommand>(deleteGoalCommandValidator, _failureActionOfDeleteGoalCommand, deleteGoalCommand).ConfigureAwait(false);
                var deleteGoalCommandHandler = new Wayd.Planning.Application.StoryMaps.Commands.DeleteGoalCommandHandler(waydDbContext, storyMapNotifier, _loggerOfDeleteGoalCommandHandler);
                
                // The actual message execution
                var outgoing1 = await deleteGoalCommandHandler.Handle(deleteGoalCommand, cancellation).ConfigureAwait(false);
    ...
    // END: DeleteGoalCommandHandler259194347
