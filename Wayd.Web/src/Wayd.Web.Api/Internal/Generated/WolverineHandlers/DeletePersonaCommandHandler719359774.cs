...
{
    // START: DeletePersonaCommandHandler719359774
    [global::System.CodeDom.Compiler.GeneratedCode("JasperFx", "1.0.0")]
    public sealed class DeletePersonaCommandHandler719359774 : Wolverine.Runtime.Handlers.MessageHandler
    {
        ...
        private readonly Microsoft.Extensions.Logging.ILogger<Wayd.Planning.Application.StoryMaps.Commands.DeletePersonaCommandHandler> _loggerOfDeletePersonaCommandHandler;
        ...
        private readonly Wolverine.FluentValidation.IFailureAction<Wayd.Planning.Application.StoryMaps.Commands.DeletePersonaCommand> _failureActionOfDeletePersonaCommand;
        private readonly Wolverine.Runtime.IWolverineRuntime _wolverineRuntime;

        public DeletePersonaCommandHandler719359774(Microsoft.AspNetCore.Http.IHttpContextAccessor __httpContextAccessor1, Microsoft.AspNetCore.Http.IHttpContextAccessor __httpContextAccessor2, Microsoft.EntityFrameworkCore.DbContextOptions dbContextOptions, Microsoft.Extensions.DependencyInjection.IServiceScopeFactory serviceScopeFactory, Microsoft.Extensions.Logging.ILogger<Wayd.Common.Application.Behaviors.PerformanceBehaviorLog> loggerOfPerformanceBehaviorLog, Microsoft.Extensions.Logging.ILogger<Wayd.Infrastructure.Common.Services.EventPublisher> loggerOfEventPublisher, Microsoft.Extensions.Logging.ILogger<Wayd.Planning.Application.StoryMaps.Commands.DeletePersonaCommandHandler> loggerOfDeletePersonaCommandHandler, Microsoft.Extensions.Options.IOptions<Wayd.Infrastructure.Persistence.DatabaseSettings> optionsOfDatabaseSettings, System.Collections.Generic.IEnumerable<Wolverine.EntityFrameworkCore.IDomainEventScraper> domainEventScraperIEnumerable, System.TimeProvider timeProvider, Wolverine.FluentValidation.IFailureAction<Wayd.Planning.Application.StoryMaps.Commands.DeletePersonaCommand> failureActionOfDeletePersonaCommand, Wolverine.Runtime.IWolverineRuntime wolverineRuntime)
        {
            ...
            _loggerOfDeletePersonaCommandHandler = loggerOfDeletePersonaCommandHandler;
            _optionsOfDatabaseSettings = optionsOfDatabaseSettings;
            _domainEventScraperIEnumerable = domainEventScraperIEnumerable;
            _timeProvider = timeProvider;
            _failureActionOfDeletePersonaCommand = failureActionOfDeletePersonaCommand;
        ...
        public override async System.Threading.Tasks.Task HandleAsync(Wolverine.Runtime.MessageContext context, System.Threading.CancellationToken cancellation)
        {
            ...
            var deletePersonaCommandValidator = new Wayd.Planning.Application.StoryMaps.Commands.DeletePersonaCommandValidator();
            ...
            var deletePersonaCommand = (Wayd.Planning.Application.StoryMaps.Commands.DeletePersonaCommand)context.Envelope.Message;
            ...
            try
            {
                System.Diagnostics.Activity.Current?.SetTag("message.handler", "Wayd.Planning.Application.StoryMaps.Commands.DeletePersonaCommandHandler");
                System.Diagnostics.Activity.Current?.SetTag("handler.type", "Wayd.Planning.Application.StoryMaps.Commands.DeletePersonaCommandHandler");
                await Wolverine.FluentValidation.Internals.FluentValidationExecutor.ExecuteOne<Wayd.Planning.Application.StoryMaps.Commands.DeletePersonaCommand>(deletePersonaCommandValidator, _failureActionOfDeletePersonaCommand, deletePersonaCommand).ConfigureAwait(false);
                var deletePersonaCommandHandler = new Wayd.Planning.Application.StoryMaps.Commands.DeletePersonaCommandHandler(waydDbContext, storyMapNotifier, _loggerOfDeletePersonaCommandHandler);
                
                // The actual message execution
                var outgoing1 = await deletePersonaCommandHandler.Handle(deletePersonaCommand, cancellation).ConfigureAwait(false);
    ...
    // END: DeletePersonaCommandHandler719359774
