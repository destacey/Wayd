...
namespace Internal.Generated.WolverineHandlers
{
    ...
    public sealed class DeleteRoadmapCommandHandler1004895241 : Wolverine.Runtime.Handlers.MessageHandler
    {
        ...
        public DeleteRoadmapCommandHandler1004895241(Microsoft.AspNetCore.Http.IHttpContextAccessor __httpContextAccessor1, Microsoft.AspNetCore.Http.IHttpContextAccessor __httpContextAccessor2, Microsoft.EntityFrameworkCore.DbContextOptions dbContextOptions, Microsoft.Extensions.DependencyInjection.IServiceScopeFactory serviceScopeFactory, Microsoft.Extensions.Logging.ILogger<Wayd.Common.Application.Behaviors.PerformanceBehaviorLog> loggerOfPerformanceBehaviorLog, Microsoft.Extensions.Logging.ILogger<Wayd.Infrastructure.Common.Services.EventPublisher> loggerOfEventPublisher, Microsoft.Extensions.Logging.ILogger<Wayd.Planning.Application.Roadmaps.Commands.DeleteRoadmapCommandHandler> loggerOfDeleteRoadmapCommandHandler, Microsoft.Extensions.Options.IOptions<Wayd.Infrastructure.Persistence.DatabaseSettings> optionsOfDatabaseSettings, System.Collections.Generic.IEnumerable<Wolverine.EntityFrameworkCore.IDomainEventScraper> domainEventScraperIEnumerable, System.TimeProvider timeProvider, Wolverine.FluentValidation.IFailureAction<Wayd.Planning.Application.Roadmaps.Commands.DeleteRoadmapCommand> failureActionOfDeleteRoadmapCommand, Wolverine.Runtime.IWolverineRuntime wolverineRuntime)
        {
        ...
        public override async System.Threading.Tasks.Task HandleAsync(Wolverine.Runtime.MessageContext context, System.Threading.CancellationToken cancellation)
        {
            ...
            var deleteRoadmapCommandValidator = new Wayd.Planning.Application.Roadmaps.Commands.DeleteRoadmapCommandValidator();
            ...
            try
            {
                ...
                await Wolverine.FluentValidation.Internals.FluentValidationExecutor.ExecuteOne<Wayd.Planning.Application.Roadmaps.Commands.DeleteRoadmapCommand>(deleteRoadmapCommandValidator, _failureActionOfDeleteRoadmapCommand, deleteRoadmapCommand).ConfigureAwait(false);
                var deleteRoadmapCommandHandler = new Wayd.Planning.Application.Roadmaps.Commands.DeleteRoadmapCommandHandler(waydDbContext, currentUser, _loggerOfDeleteRoadmapCommandHandler);
