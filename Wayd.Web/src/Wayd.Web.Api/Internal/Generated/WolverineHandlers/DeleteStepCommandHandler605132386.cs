...
{
    // START: DeleteStepCommandHandler605132386
    [global::System.CodeDom.Compiler.GeneratedCode("JasperFx", "1.0.0")]
    public sealed class DeleteStepCommandHandler605132386 : Wolverine.Runtime.Handlers.MessageHandler
    {
        ...
        private readonly Microsoft.Extensions.Logging.ILogger<Wayd.Planning.Application.StoryMaps.Commands.DeleteStepCommandHandler> _loggerOfDeleteStepCommandHandler;
        ...
        private readonly Wolverine.FluentValidation.IFailureAction<Wayd.Planning.Application.StoryMaps.Commands.DeleteStepCommand> _failureActionOfDeleteStepCommand;
        private readonly Wolverine.Runtime.IWolverineRuntime _wolverineRuntime;

        public DeleteStepCommandHandler605132386(Microsoft.AspNetCore.Http.IHttpContextAccessor __httpContextAccessor1, Microsoft.AspNetCore.Http.IHttpContextAccessor __httpContextAccessor2, Microsoft.EntityFrameworkCore.DbContextOptions dbContextOptions, Microsoft.Extensions.DependencyInjection.IServiceScopeFactory serviceScopeFactory, Microsoft.Extensions.Logging.ILogger<Wayd.Common.Application.Behaviors.PerformanceBehaviorLog> loggerOfPerformanceBehaviorLog, Microsoft.Extensions.Logging.ILogger<Wayd.Infrastructure.Common.Services.EventPublisher> loggerOfEventPublisher, Microsoft.Extensions.Logging.ILogger<Wayd.Planning.Application.StoryMaps.Commands.DeleteStepCommandHandler> loggerOfDeleteStepCommandHandler, Microsoft.Extensions.Options.IOptions<Wayd.Infrastructure.Persistence.DatabaseSettings> optionsOfDatabaseSettings, System.Collections.Generic.IEnumerable<Wolverine.EntityFrameworkCore.IDomainEventScraper> domainEventScraperIEnumerable, System.TimeProvider timeProvider, Wolverine.FluentValidation.IFailureAction<Wayd.Planning.Application.StoryMaps.Commands.DeleteStepCommand> failureActionOfDeleteStepCommand, Wolverine.Runtime.IWolverineRuntime wolverineRuntime)
        {
            ...
            _loggerOfDeleteStepCommandHandler = loggerOfDeleteStepCommandHandler;
            _optionsOfDatabaseSettings = optionsOfDatabaseSettings;
            _domainEventScraperIEnumerable = domainEventScraperIEnumerable;
            _timeProvider = timeProvider;
            _failureActionOfDeleteStepCommand = failureActionOfDeleteStepCommand;
        ...
        {
            var deleteStepCommandValidator = new Wayd.Planning.Application.StoryMaps.Commands.DeleteStepCommandValidator();
            ...
            var deleteStepCommand = (Wayd.Planning.Application.StoryMaps.Commands.DeleteStepCommand)context.Envelope.Message;
            ...
            try
            {
                System.Diagnostics.Activity.Current?.SetTag("message.handler", "Wayd.Planning.Application.StoryMaps.Commands.DeleteStepCommandHandler");
                System.Diagnostics.Activity.Current?.SetTag("handler.type", "Wayd.Planning.Application.StoryMaps.Commands.DeleteStepCommandHandler");
                await Wolverine.FluentValidation.Internals.FluentValidationExecutor.ExecuteOne<Wayd.Planning.Application.StoryMaps.Commands.DeleteStepCommand>(deleteStepCommandValidator, _failureActionOfDeleteStepCommand, deleteStepCommand).ConfigureAwait(false);
                var deleteStepCommandHandler = new Wayd.Planning.Application.StoryMaps.Commands.DeleteStepCommandHandler(waydDbContext, storyMapNotifier, _loggerOfDeleteStepCommandHandler);
                
                // The actual message execution
                var outgoing1 = await deleteStepCommandHandler.Handle(deleteStepCommand, cancellation).ConfigureAwait(false);
    ...
    // END: DeleteStepCommandHandler605132386
