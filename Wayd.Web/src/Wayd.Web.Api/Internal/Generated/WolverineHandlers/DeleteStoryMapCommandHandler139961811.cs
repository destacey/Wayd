...
{
    // START: DeleteStoryMapCommandHandler139961811
    [global::System.CodeDom.Compiler.GeneratedCode("JasperFx", "1.0.0")]
    public sealed class DeleteStoryMapCommandHandler139961811 : Wolverine.Runtime.Handlers.MessageHandler
    {
        ...
        private readonly Microsoft.Extensions.Logging.ILogger<Wayd.Planning.Application.StoryMaps.Commands.DeleteStoryMapCommandHandler> _loggerOfDeleteStoryMapCommandHandler;
        ...
        private readonly Wolverine.FluentValidation.IFailureAction<Wayd.Planning.Application.StoryMaps.Commands.DeleteStoryMapCommand> _failureActionOfDeleteStoryMapCommand;
        private readonly Wolverine.Runtime.IWolverineRuntime _wolverineRuntime;

        public DeleteStoryMapCommandHandler139961811(Microsoft.AspNetCore.Http.IHttpContextAccessor __httpContextAccessor1, Microsoft.AspNetCore.Http.IHttpContextAccessor __httpContextAccessor2, Microsoft.EntityFrameworkCore.DbContextOptions dbContextOptions, Microsoft.Extensions.DependencyInjection.IServiceScopeFactory serviceScopeFactory, Microsoft.Extensions.Logging.ILogger<Wayd.Common.Application.Behaviors.PerformanceBehaviorLog> loggerOfPerformanceBehaviorLog, Microsoft.Extensions.Logging.ILogger<Wayd.Infrastructure.Common.Services.EventPublisher> loggerOfEventPublisher, Microsoft.Extensions.Logging.ILogger<Wayd.Planning.Application.StoryMaps.Commands.DeleteStoryMapCommandHandler> loggerOfDeleteStoryMapCommandHandler, Microsoft.Extensions.Options.IOptions<Wayd.Infrastructure.Persistence.DatabaseSettings> optionsOfDatabaseSettings, System.Collections.Generic.IEnumerable<Wolverine.EntityFrameworkCore.IDomainEventScraper> domainEventScraperIEnumerable, System.TimeProvider timeProvider, Wolverine.FluentValidation.IFailureAction<Wayd.Planning.Application.StoryMaps.Commands.DeleteStoryMapCommand> failureActionOfDeleteStoryMapCommand, Wolverine.Runtime.IWolverineRuntime wolverineRuntime)
        {
            ...
            _loggerOfDeleteStoryMapCommandHandler = loggerOfDeleteStoryMapCommandHandler;
            _optionsOfDatabaseSettings = optionsOfDatabaseSettings;
            _domainEventScraperIEnumerable = domainEventScraperIEnumerable;
            _timeProvider = timeProvider;
            _failureActionOfDeleteStoryMapCommand = failureActionOfDeleteStoryMapCommand;
        ...
        public override async System.Threading.Tasks.Task HandleAsync(Wolverine.Runtime.MessageContext context, System.Threading.CancellationToken cancellation)
        {
            ...
            var deleteStoryMapCommandValidator = new Wayd.Planning.Application.StoryMaps.Commands.DeleteStoryMapCommandValidator();
            // The actual message body
            var deleteStoryMapCommand = (Wayd.Planning.Application.StoryMaps.Commands.DeleteStoryMapCommand)context.Envelope.Message;
            ...
            try
            {
                System.Diagnostics.Activity.Current?.SetTag("message.handler", "Wayd.Planning.Application.StoryMaps.Commands.DeleteStoryMapCommandHandler");
                System.Diagnostics.Activity.Current?.SetTag("handler.type", "Wayd.Planning.Application.StoryMaps.Commands.DeleteStoryMapCommandHandler");
                await Wolverine.FluentValidation.Internals.FluentValidationExecutor.ExecuteOne<Wayd.Planning.Application.StoryMaps.Commands.DeleteStoryMapCommand>(deleteStoryMapCommandValidator, _failureActionOfDeleteStoryMapCommand, deleteStoryMapCommand).ConfigureAwait(false);
                var deleteStoryMapCommandHandler = new Wayd.Planning.Application.StoryMaps.Commands.DeleteStoryMapCommandHandler(waydDbContext, storyMapNotifier, _loggerOfDeleteStoryMapCommandHandler);
                
                // The actual message execution
                var outgoing1 = await deleteStoryMapCommandHandler.Handle(deleteStoryMapCommand, cancellation).ConfigureAwait(false);
    ...
    // END: DeleteStoryMapCommandHandler139961811
