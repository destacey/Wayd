...
{
    // START: DeleteTaskCommandHandler1891344719
    [global::System.CodeDom.Compiler.GeneratedCode("JasperFx", "1.0.0")]
    public sealed class DeleteTaskCommandHandler1891344719 : Wolverine.Runtime.Handlers.MessageHandler
    {
        ...
        private readonly Microsoft.Extensions.Logging.ILogger<Wayd.Planning.Application.StoryMaps.Commands.DeleteTaskCommandHandler> _loggerOfDeleteTaskCommandHandler;
        ...
        private readonly Wolverine.FluentValidation.IFailureAction<Wayd.Planning.Application.StoryMaps.Commands.DeleteTaskCommand> _failureActionOfDeleteTaskCommand;
        private readonly Wolverine.Runtime.IWolverineRuntime _wolverineRuntime;

        public DeleteTaskCommandHandler1891344719(Microsoft.AspNetCore.Http.IHttpContextAccessor __httpContextAccessor1, Microsoft.AspNetCore.Http.IHttpContextAccessor __httpContextAccessor2, Microsoft.EntityFrameworkCore.DbContextOptions dbContextOptions, Microsoft.Extensions.DependencyInjection.IServiceScopeFactory serviceScopeFactory, Microsoft.Extensions.Logging.ILogger<Wayd.Common.Application.Behaviors.PerformanceBehaviorLog> loggerOfPerformanceBehaviorLog, Microsoft.Extensions.Logging.ILogger<Wayd.Infrastructure.Common.Services.EventPublisher> loggerOfEventPublisher, Microsoft.Extensions.Logging.ILogger<Wayd.Planning.Application.StoryMaps.Commands.DeleteTaskCommandHandler> loggerOfDeleteTaskCommandHandler, Microsoft.Extensions.Options.IOptions<Wayd.Infrastructure.Persistence.DatabaseSettings> optionsOfDatabaseSettings, System.Collections.Generic.IEnumerable<Wolverine.EntityFrameworkCore.IDomainEventScraper> domainEventScraperIEnumerable, System.TimeProvider timeProvider, Wolverine.FluentValidation.IFailureAction<Wayd.Planning.Application.StoryMaps.Commands.DeleteTaskCommand> failureActionOfDeleteTaskCommand, Wolverine.Runtime.IWolverineRuntime wolverineRuntime)
        {
            ...
            _loggerOfDeleteTaskCommandHandler = loggerOfDeleteTaskCommandHandler;
            _optionsOfDatabaseSettings = optionsOfDatabaseSettings;
            _domainEventScraperIEnumerable = domainEventScraperIEnumerable;
            _timeProvider = timeProvider;
            _failureActionOfDeleteTaskCommand = failureActionOfDeleteTaskCommand;
        ...
        public override async System.Threading.Tasks.Task HandleAsync(Wolverine.Runtime.MessageContext context, System.Threading.CancellationToken cancellation)
        {
            ...
            var deleteTaskCommandValidator = new Wayd.Planning.Application.StoryMaps.Commands.DeleteTaskCommandValidator();
            ...
            var deleteTaskCommand = (Wayd.Planning.Application.StoryMaps.Commands.DeleteTaskCommand)context.Envelope.Message;
            ...
            try
            {
                System.Diagnostics.Activity.Current?.SetTag("message.handler", "Wayd.Planning.Application.StoryMaps.Commands.DeleteTaskCommandHandler");
                System.Diagnostics.Activity.Current?.SetTag("handler.type", "Wayd.Planning.Application.StoryMaps.Commands.DeleteTaskCommandHandler");
                await Wolverine.FluentValidation.Internals.FluentValidationExecutor.ExecuteOne<Wayd.Planning.Application.StoryMaps.Commands.DeleteTaskCommand>(deleteTaskCommandValidator, _failureActionOfDeleteTaskCommand, deleteTaskCommand).ConfigureAwait(false);
                var deleteTaskCommandHandler = new Wayd.Planning.Application.StoryMaps.Commands.DeleteTaskCommandHandler(waydDbContext, storyMapNotifier, _loggerOfDeleteTaskCommandHandler);
                
                // The actual message execution
                var outgoing1 = await deleteTaskCommandHandler.Handle(deleteTaskCommand, cancellation).ConfigureAwait(false);
    ...
    // END: DeleteTaskCommandHandler1891344719
