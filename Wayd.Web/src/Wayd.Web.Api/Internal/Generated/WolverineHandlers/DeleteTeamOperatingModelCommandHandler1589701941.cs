...
namespace Internal.Generated.WolverineHandlers
{
    ...
    public sealed class DeleteTeamOperatingModelCommandHandler1589701941 : Wolverine.Runtime.Handlers.MessageHandler
    {
        ...
        public DeleteTeamOperatingModelCommandHandler1589701941(Microsoft.AspNetCore.Http.IHttpContextAccessor __httpContextAccessor1, Microsoft.AspNetCore.Http.IHttpContextAccessor __httpContextAccessor2, Microsoft.EntityFrameworkCore.DbContextOptions dbContextOptions, Microsoft.Extensions.DependencyInjection.IServiceScopeFactory serviceScopeFactory, Microsoft.Extensions.Logging.ILogger<Wayd.Common.Application.Behaviors.PerformanceBehaviorLog> loggerOfPerformanceBehaviorLog, Microsoft.Extensions.Logging.ILogger<Wayd.Infrastructure.Common.Services.EventPublisher> loggerOfEventPublisher, Microsoft.Extensions.Logging.ILogger<Wayd.Organization.Application.Teams.Commands.DeleteTeamOperatingModelCommandHandler> loggerOfDeleteTeamOperatingModelCommandHandler, Microsoft.Extensions.Options.IOptions<Wayd.Infrastructure.Persistence.DatabaseSettings> optionsOfDatabaseSettings, System.Collections.Generic.IEnumerable<Wolverine.EntityFrameworkCore.IDomainEventScraper> domainEventScraperIEnumerable, System.TimeProvider timeProvider, Wolverine.FluentValidation.IFailureAction<Wayd.Organization.Application.Teams.Commands.DeleteTeamOperatingModelCommand> failureActionOfDeleteTeamOperatingModelCommand, Wolverine.Runtime.IWolverineRuntime wolverineRuntime)
        {
        ...
        public override async System.Threading.Tasks.Task HandleAsync(Wolverine.Runtime.MessageContext context, System.Threading.CancellationToken cancellation)
        {
            ...
            try
            {
                ...
                await Wolverine.FluentValidation.Internals.FluentValidationExecutor.ExecuteOne<Wayd.Organization.Application.Teams.Commands.DeleteTeamOperatingModelCommand>(deleteTeamOperatingModelCommandValidator, _failureActionOfDeleteTeamOperatingModelCommand, deleteTeamOperatingModelCommand).ConfigureAwait(false);
                var deleteTeamOperatingModelCommandHandler = new Wayd.Organization.Application.Teams.Commands.DeleteTeamOperatingModelCommandHandler(waydDbContext, _loggerOfDeleteTeamOperatingModelCommandHandler);
