...
{
    // START: DeleteWorkdayConnectionCommandHandler949878703
    [global::System.CodeDom.Compiler.GeneratedCode("JasperFx", "1.0.0")]
    public sealed class DeleteWorkdayConnectionCommandHandler949878703 : Wolverine.Runtime.Handlers.MessageHandler
    {
        ...
        private readonly Microsoft.Extensions.Logging.ILogger<Wayd.AppIntegration.Application.Connections.Commands.Workday.DeleteWorkdayConnectionCommandHandler> _loggerOfDeleteWorkdayConnectionCommandHandler;
        ...
        public DeleteWorkdayConnectionCommandHandler949878703(Microsoft.AspNetCore.Http.IHttpContextAccessor __httpContextAccessor1, Microsoft.AspNetCore.Http.IHttpContextAccessor __httpContextAccessor2, Microsoft.EntityFrameworkCore.DbContextOptions dbContextOptions, Microsoft.Extensions.DependencyInjection.IServiceScopeFactory serviceScopeFactory, Microsoft.Extensions.Logging.ILogger<Wayd.AppIntegration.Application.Connections.Commands.Workday.DeleteWorkdayConnectionCommandHandler> loggerOfDeleteWorkdayConnectionCommandHandler, Microsoft.Extensions.Logging.ILogger<Wayd.Common.Application.Behaviors.PerformanceBehaviorLog> loggerOfPerformanceBehaviorLog, Microsoft.Extensions.Logging.ILogger<Wayd.Infrastructure.Common.Services.EventPublisher> loggerOfEventPublisher, Microsoft.Extensions.Options.IOptions<Wayd.Infrastructure.Persistence.DatabaseSettings> optionsOfDatabaseSettings, System.Collections.Generic.IEnumerable<Wolverine.EntityFrameworkCore.IDomainEventScraper> domainEventScraperIEnumerable, System.TimeProvider timeProvider, Wolverine.Runtime.IWolverineRuntime wolverineRuntime)
        {
            _httpContextAccessor1 = __httpContextAccessor1;
            _httpContextAccessor2 = __httpContextAccessor2;
            _dbContextOptions = dbContextOptions;
            _serviceScopeFactory = serviceScopeFactory;
            _loggerOfDeleteWorkdayConnectionCommandHandler = loggerOfDeleteWorkdayConnectionCommandHandler;
        ...
        public override async System.Threading.Tasks.Task HandleAsync(Wolverine.Runtime.MessageContext context, System.Threading.CancellationToken cancellation)
        {
            ...
            var deleteWorkdayConnectionCommand = (Wayd.AppIntegration.Application.Connections.Commands.Workday.DeleteWorkdayConnectionCommand)context.Envelope.Message;
            ...
            try
            {
                System.Diagnostics.Activity.Current?.SetTag("message.handler", "Wayd.AppIntegration.Application.Connections.Commands.Workday.DeleteWorkdayConnectionCommandHandler");
                System.Diagnostics.Activity.Current?.SetTag("handler.type", "Wayd.AppIntegration.Application.Connections.Commands.Workday.DeleteWorkdayConnectionCommandHandler");
                var deleteWorkdayConnectionCommandHandler = new Wayd.AppIntegration.Application.Connections.Commands.Workday.DeleteWorkdayConnectionCommandHandler(waydDbContext, _loggerOfDeleteWorkdayConnectionCommandHandler);
                
                // The actual message execution
                var outgoing1 = await deleteWorkdayConnectionCommandHandler.Handle(deleteWorkdayConnectionCommand, cancellation).ConfigureAwait(false);
    ...
    // END: DeleteWorkdayConnectionCommandHandler949878703
