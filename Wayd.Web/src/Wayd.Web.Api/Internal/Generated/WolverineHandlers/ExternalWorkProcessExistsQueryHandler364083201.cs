...
{
    // START: ExternalWorkProcessExistsQueryHandler364083201
    [global::System.CodeDom.Compiler.GeneratedCode("JasperFx", "1.0.0")]
    public sealed class ExternalWorkProcessExistsQueryHandler364083201 : Wolverine.Runtime.Handlers.MessageHandler
    {
        ...
        public override async System.Threading.Tasks.Task HandleAsync(Wolverine.Runtime.MessageContext context, System.Threading.CancellationToken cancellation)
        {
            ...
            var externalWorkProcessExistsQuery = (Wayd.Common.Application.Requests.WorkManagement.Queries.ExternalWorkProcessExistsQuery)context.Envelope.Message;
            ...
            try
            {
                System.Diagnostics.Activity.Current?.SetTag("message.handler", "Wayd.Work.Application.WorkProcesses.Queries.ExternalWorkProcessExistsQueryHandler");
                System.Diagnostics.Activity.Current?.SetTag("handler.type", "Wayd.Work.Application.WorkProcesses.Queries.ExternalWorkProcessExistsQueryHandler");
                var externalWorkProcessExistsQueryHandler = new Wayd.Work.Application.WorkProcesses.Queries.ExternalWorkProcessExistsQueryHandler(waydDbContext);
                
                // The actual message execution
                var outgoing1 = await externalWorkProcessExistsQueryHandler.Handle(externalWorkProcessExistsQuery, cancellation).ConfigureAwait(false);
    ...
    // END: ExternalWorkProcessExistsQueryHandler364083201
