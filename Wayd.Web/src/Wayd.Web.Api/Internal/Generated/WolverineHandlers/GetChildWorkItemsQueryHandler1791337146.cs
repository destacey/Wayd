...
{
    // START: GetChildWorkItemsQueryHandler1791337146
    [global::System.CodeDom.Compiler.GeneratedCode("JasperFx", "1.0.0")]
    public sealed class GetChildWorkItemsQueryHandler1791337146 : Wolverine.Runtime.Handlers.MessageHandler
    {
        ...
        private readonly Microsoft.Extensions.Logging.ILogger<Wayd.Work.Application.WorkItems.Queries.GetChildWorkItemsQueryHandler> _loggerOfGetChildWorkItemsQueryHandler;
        ...
        public GetChildWorkItemsQueryHandler1791337146(Microsoft.AspNetCore.Http.IHttpContextAccessor __httpContextAccessor1, Microsoft.AspNetCore.Http.IHttpContextAccessor __httpContextAccessor2, Microsoft.EntityFrameworkCore.DbContextOptions dbContextOptions, Microsoft.Extensions.DependencyInjection.IServiceScopeFactory serviceScopeFactory, Microsoft.Extensions.Logging.ILogger<Wayd.Common.Application.Behaviors.PerformanceBehaviorLog> loggerOfPerformanceBehaviorLog, Microsoft.Extensions.Logging.ILogger<Wayd.Infrastructure.Common.Services.EventPublisher> loggerOfEventPublisher, Microsoft.Extensions.Logging.ILogger<Wayd.Work.Application.WorkItems.Queries.GetChildWorkItemsQueryHandler> loggerOfGetChildWorkItemsQueryHandler, Microsoft.Extensions.Options.IOptions<Wayd.Infrastructure.Persistence.DatabaseSettings> optionsOfDatabaseSettings, System.Collections.Generic.IEnumerable<Wolverine.EntityFrameworkCore.IDomainEventScraper> domainEventScraperIEnumerable, System.TimeProvider timeProvider, Wolverine.Runtime.IWolverineRuntime wolverineRuntime)
        {
            ...
            _loggerOfGetChildWorkItemsQueryHandler = loggerOfGetChildWorkItemsQueryHandler;
        ...
        public override async System.Threading.Tasks.Task HandleAsync(Wolverine.Runtime.MessageContext context, System.Threading.CancellationToken cancellation)
        {
            ...
            var getChildWorkItemsQuery = (Wayd.Work.Application.WorkItems.Queries.GetChildWorkItemsQuery)context.Envelope.Message;
            ...
            try
            {
                System.Diagnostics.Activity.Current?.SetTag("message.handler", "Wayd.Work.Application.WorkItems.Queries.GetChildWorkItemsQueryHandler");
                System.Diagnostics.Activity.Current?.SetTag("handler.type", "Wayd.Work.Application.WorkItems.Queries.GetChildWorkItemsQueryHandler");
                var getChildWorkItemsQueryHandler = new Wayd.Work.Application.WorkItems.Queries.GetChildWorkItemsQueryHandler(waydDbContext, _loggerOfGetChildWorkItemsQueryHandler);
                
                // The actual message execution
                var outgoing1 = await getChildWorkItemsQueryHandler.Handle(getChildWorkItemsQuery, cancellation).ConfigureAwait(false);
    ...
    // END: GetChildWorkItemsQueryHandler1791337146
