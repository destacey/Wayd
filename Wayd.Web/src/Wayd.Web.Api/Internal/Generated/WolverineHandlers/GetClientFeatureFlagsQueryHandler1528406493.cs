...
{
    // START: GetClientFeatureFlagsQueryHandler1528406493
    [global::System.CodeDom.Compiler.GeneratedCode("JasperFx", "1.0.0")]
    public sealed class GetClientFeatureFlagsQueryHandler1528406493 : Wolverine.Runtime.Handlers.MessageHandler
    {
        ...
        public override async System.Threading.Tasks.Task HandleAsync(Wolverine.Runtime.MessageContext context, System.Threading.CancellationToken cancellation)
        {
            ...
            try
            {
                System.Diagnostics.Activity.Current?.SetTag("message.handler", "Wayd.Common.Application.FeatureManagement.Queries.GetClientFeatureFlagsQueryHandler");
                System.Diagnostics.Activity.Current?.SetTag("handler.type", "Wayd.Common.Application.FeatureManagement.Queries.GetClientFeatureFlagsQueryHandler");
                var getClientFeatureFlagsQueryHandler = new Wayd.Common.Application.FeatureManagement.Queries.GetClientFeatureFlagsQueryHandler(waydDbContext);
                
                // The actual message execution
                var outgoing1 = await getClientFeatureFlagsQueryHandler.Handle(getClientFeatureFlagsQuery, cancellation).ConfigureAwait(false);
    ...
    // END: GetClientFeatureFlagsQueryHandler1528406493
