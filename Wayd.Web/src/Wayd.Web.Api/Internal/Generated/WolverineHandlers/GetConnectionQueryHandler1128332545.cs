...
{
    // START: GetConnectionQueryHandler1128332545
    [global::System.CodeDom.Compiler.GeneratedCode("JasperFx", "1.0.0")]
    public sealed class GetConnectionQueryHandler1128332545 : Wolverine.Runtime.Handlers.MessageHandler
    {
        ...
        public override async System.Threading.Tasks.Task HandleAsync(Wolverine.Runtime.MessageContext context, System.Threading.CancellationToken cancellation)
        {
            ...
            try
            {
                System.Diagnostics.Activity.Current?.SetTag("message.handler", "Wayd.AppIntegration.Application.Connections.Queries.GetConnectionQueryHandler");
                System.Diagnostics.Activity.Current?.SetTag("handler.type", "Wayd.AppIntegration.Application.Connections.Queries.GetConnectionQueryHandler");
                var getConnectionQueryHandler = new Wayd.AppIntegration.Application.Connections.Queries.GetConnectionQueryHandler(waydDbContext);
                
                // The actual message execution
                var outgoing1 = await getConnectionQueryHandler.Handle(getConnectionQuery, cancellation).ConfigureAwait(false);
    ...
    // END: GetConnectionQueryHandler1128332545
