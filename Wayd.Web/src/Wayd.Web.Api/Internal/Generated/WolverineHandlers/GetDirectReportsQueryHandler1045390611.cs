...
{
    // START: GetDirectReportsQueryHandler1045390611
    [global::System.CodeDom.Compiler.GeneratedCode("JasperFx", "1.0.0")]
    public sealed class GetDirectReportsQueryHandler1045390611 : Wolverine.Runtime.Handlers.MessageHandler
    {
        ...
        private readonly Microsoft.Extensions.Logging.ILogger<Wayd.Common.Application.Employees.Queries.GetDirectReportsQueryHandler> _loggerOfGetDirectReportsQueryHandler;
        ...
        public GetDirectReportsQueryHandler1045390611(Microsoft.AspNetCore.Http.IHttpContextAccessor __httpContextAccessor1, Microsoft.AspNetCore.Http.IHttpContextAccessor __httpContextAccessor2, Microsoft.EntityFrameworkCore.DbContextOptions dbContextOptions, Microsoft.Extensions.DependencyInjection.IServiceScopeFactory serviceScopeFactory, Microsoft.Extensions.Logging.ILogger<Wayd.Common.Application.Behaviors.PerformanceBehaviorLog> loggerOfPerformanceBehaviorLog, Microsoft.Extensions.Logging.ILogger<Wayd.Common.Application.Employees.Queries.GetDirectReportsQueryHandler> loggerOfGetDirectReportsQueryHandler, Microsoft.Extensions.Logging.ILogger<Wayd.Infrastructure.Common.Services.EventPublisher> loggerOfEventPublisher, Microsoft.Extensions.Options.IOptions<Wayd.Infrastructure.Persistence.DatabaseSettings> optionsOfDatabaseSettings, System.Collections.Generic.IEnumerable<Wolverine.EntityFrameworkCore.IDomainEventScraper> domainEventScraperIEnumerable, System.TimeProvider timeProvider, Wolverine.Runtime.IWolverineRuntime wolverineRuntime)
        {
            ...
            _loggerOfGetDirectReportsQueryHandler = loggerOfGetDirectReportsQueryHandler;
        ...
        public override async System.Threading.Tasks.Task HandleAsync(Wolverine.Runtime.MessageContext context, System.Threading.CancellationToken cancellation)
        {
            ...
            var getDirectReportsQuery = (Wayd.Common.Application.Employees.Queries.GetDirectReportsQuery)context.Envelope.Message;
            ...
            try
            {
                System.Diagnostics.Activity.Current?.SetTag("message.handler", "Wayd.Common.Application.Employees.Queries.GetDirectReportsQueryHandler");
                System.Diagnostics.Activity.Current?.SetTag("handler.type", "Wayd.Common.Application.Employees.Queries.GetDirectReportsQueryHandler");
                var getDirectReportsQueryHandler = new Wayd.Common.Application.Employees.Queries.GetDirectReportsQueryHandler(waydDbContext, _loggerOfGetDirectReportsQueryHandler);
                
                // The actual message execution
                var outgoing1 = await getDirectReportsQueryHandler.Handle(getDirectReportsQuery, cancellation).ConfigureAwait(false);
    ...
    // END: GetDirectReportsQueryHandler1045390611
