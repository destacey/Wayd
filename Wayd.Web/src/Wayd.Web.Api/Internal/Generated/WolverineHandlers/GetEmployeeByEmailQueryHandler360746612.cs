...
{
    // START: GetEmployeeByEmailQueryHandler360746612
    [global::System.CodeDom.Compiler.GeneratedCode("JasperFx", "1.0.0")]
    public sealed class GetEmployeeByEmailQueryHandler360746612 : Wolverine.Runtime.Handlers.MessageHandler
    {
        ...
        public override async System.Threading.Tasks.Task HandleAsync(Wolverine.Runtime.MessageContext context, System.Threading.CancellationToken cancellation)
        {
            ...
            var getEmployeeByEmailQuery = (Wayd.Common.Application.Employees.Queries.GetEmployeeByEmailQuery)context.Envelope.Message;
            ...
            try
            {
                System.Diagnostics.Activity.Current?.SetTag("message.handler", "Wayd.Common.Application.Employees.Queries.GetEmployeeByEmailQueryHandler");
                System.Diagnostics.Activity.Current?.SetTag("handler.type", "Wayd.Common.Application.Employees.Queries.GetEmployeeByEmailQueryHandler");
                var getEmployeeByEmailQueryHandler = new Wayd.Common.Application.Employees.Queries.GetEmployeeByEmailQueryHandler(waydDbContext);
                
                // The actual message execution
                var outgoing1 = await getEmployeeByEmailQueryHandler.Handle(getEmployeeByEmailQuery, cancellation).ConfigureAwait(false);
    ...
    // END: GetEmployeeByEmailQueryHandler360746612
