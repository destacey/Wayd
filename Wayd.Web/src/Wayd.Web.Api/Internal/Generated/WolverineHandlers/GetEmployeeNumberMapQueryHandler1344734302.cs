...
{
    // START: GetEmployeeNumberMapQueryHandler1344734302
    [global::System.CodeDom.Compiler.GeneratedCode("JasperFx", "1.0.0")]
    public sealed class GetEmployeeNumberMapQueryHandler1344734302 : Wolverine.Runtime.Handlers.MessageHandler
    {
        ...
        public override async System.Threading.Tasks.Task HandleAsync(Wolverine.Runtime.MessageContext context, System.Threading.CancellationToken cancellation)
        {
            ...
            var getEmployeeNumberMapQuery = (Wayd.Common.Application.Employees.Queries.GetEmployeeNumberMapQuery)context.Envelope.Message;
            ...
            try
            {
                System.Diagnostics.Activity.Current?.SetTag("message.handler", "Wayd.Common.Application.Employees.Queries.GetEmployeeNumberMapQueryHandler");
                System.Diagnostics.Activity.Current?.SetTag("handler.type", "Wayd.Common.Application.Employees.Queries.GetEmployeeNumberMapQueryHandler");
                var getEmployeeNumberMapQueryHandler = new Wayd.Common.Application.Employees.Queries.GetEmployeeNumberMapQueryHandler(waydDbContext);
                
                // The actual message execution
                var outgoing1 = await getEmployeeNumberMapQueryHandler.Handle(getEmployeeNumberMapQuery, cancellation).ConfigureAwait(false);
    ...
    // END: GetEmployeeNumberMapQueryHandler1344734302
