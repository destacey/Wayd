...
{
    // START: GetEmployeeTeamMembershipsQueryHandler1722059798
    [global::System.CodeDom.Compiler.GeneratedCode("JasperFx", "1.0.0")]
    public sealed class GetEmployeeTeamMembershipsQueryHandler1722059798 : Wolverine.Runtime.Handlers.MessageHandler
    {
        ...
        public override async System.Threading.Tasks.Task HandleAsync(Wolverine.Runtime.MessageContext context, System.Threading.CancellationToken cancellation)
        {
            ...
            var getEmployeeTeamMembershipsQuery = (Wayd.Organization.Application.Teams.Queries.GetEmployeeTeamMembershipsQuery)context.Envelope.Message;
            ...
            try
            {
                System.Diagnostics.Activity.Current?.SetTag("message.handler", "Wayd.Organization.Application.Teams.Queries.GetEmployeeTeamMembershipsQueryHandler");
                System.Diagnostics.Activity.Current?.SetTag("handler.type", "Wayd.Organization.Application.Teams.Queries.GetEmployeeTeamMembershipsQueryHandler");
                var getEmployeeTeamMembershipsQueryHandler = new Wayd.Organization.Application.Teams.Queries.GetEmployeeTeamMembershipsQueryHandler(waydDbContext);
                
                // The actual message execution
                var outgoing1 = await getEmployeeTeamMembershipsQueryHandler.Handle(getEmployeeTeamMembershipsQuery, cancellation).ConfigureAwait(false);
    ...
    // END: GetEmployeeTeamMembershipsQueryHandler1722059798
