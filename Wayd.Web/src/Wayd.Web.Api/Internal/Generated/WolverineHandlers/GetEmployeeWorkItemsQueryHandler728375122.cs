...
{
    // START: GetEmployeeWorkItemsQueryHandler728375122
    [global::System.CodeDom.Compiler.GeneratedCode("JasperFx", "1.0.0")]
    public sealed class GetEmployeeWorkItemsQueryHandler728375122 : Wolverine.Runtime.Handlers.MessageHandler
    {
        ...
        public override async System.Threading.Tasks.Task HandleAsync(Wolverine.Runtime.MessageContext context, System.Threading.CancellationToken cancellation)
        {
            ...
            var getEmployeeWorkItemsQuery = (Wayd.Work.Application.WorkItems.Queries.GetEmployeeWorkItemsQuery)context.Envelope.Message;
            ...
            try
            {
                System.Diagnostics.Activity.Current?.SetTag("message.handler", "Wayd.Work.Application.WorkItems.Queries.GetEmployeeWorkItemsQueryHandler");
                System.Diagnostics.Activity.Current?.SetTag("handler.type", "Wayd.Work.Application.WorkItems.Queries.GetEmployeeWorkItemsQueryHandler");
                var getEmployeeWorkItemsQueryHandler = new Wayd.Work.Application.WorkItems.Queries.GetEmployeeWorkItemsQueryHandler(waydDbContext);
                
                // The actual message execution
                var outgoing1 = await getEmployeeWorkItemsQueryHandler.Handle(getEmployeeWorkItemsQuery, cancellation).ConfigureAwait(false);
    ...
    // END: GetEmployeeWorkItemsQueryHandler728375122
