...
{
    // START: GetExternalObjectWorkItemsQueryHandler705656014
    [global::System.CodeDom.Compiler.GeneratedCode("JasperFx", "1.0.0")]
    public sealed class GetExternalObjectWorkItemsQueryHandler705656014 : Wolverine.Runtime.Handlers.MessageHandler
    {
        ...
        public override async System.Threading.Tasks.Task HandleAsync(Wolverine.Runtime.MessageContext context, System.Threading.CancellationToken cancellation)
        {
            ...
            var getExternalObjectWorkItemsQuery = (Wayd.Work.Application.WorkItems.Queries.GetExternalObjectWorkItemsQuery)context.Envelope.Message;
            ...
            try
            {
                System.Diagnostics.Activity.Current?.SetTag("message.handler", "Wayd.Work.Application.WorkItems.Queries.GetExternalObjectWorkItemsQueryHandler");
                System.Diagnostics.Activity.Current?.SetTag("handler.type", "Wayd.Work.Application.WorkItems.Queries.GetExternalObjectWorkItemsQueryHandler");
                var getExternalObjectWorkItemsQueryHandler = new Wayd.Work.Application.WorkItems.Queries.GetExternalObjectWorkItemsQueryHandler(waydDbContext);
                
                // The actual message execution
                var outgoing1 = await getExternalObjectWorkItemsQueryHandler.Handle(getExternalObjectWorkItemsQuery, cancellation).ConfigureAwait(false);
    ...
    // END: GetExternalObjectWorkItemsQueryHandler705656014
