...
{
    // START: GetFeatureFlagsQueryHandler156349492
    [global::System.CodeDom.Compiler.GeneratedCode("JasperFx", "1.0.0")]
    public sealed class GetFeatureFlagsQueryHandler156349492 : Wolverine.Runtime.Handlers.MessageHandler
    {
        ...
        public override async System.Threading.Tasks.Task HandleAsync(Wolverine.Runtime.MessageContext context, System.Threading.CancellationToken cancellation)
        {
            ...
            var getFeatureFlagsQuery = (Wayd.Common.Application.FeatureManagement.Queries.GetFeatureFlagsQuery)context.Envelope.Message;
            ...
            try
            {
                System.Diagnostics.Activity.Current?.SetTag("message.handler", "Wayd.Common.Application.FeatureManagement.Queries.GetFeatureFlagsQueryHandler");
                System.Diagnostics.Activity.Current?.SetTag("handler.type", "Wayd.Common.Application.FeatureManagement.Queries.GetFeatureFlagsQueryHandler");
                var getFeatureFlagsQueryHandler = new Wayd.Common.Application.FeatureManagement.Queries.GetFeatureFlagsQueryHandler(waydDbContext);
                
                // The actual message execution
                var outgoing1 = await getFeatureFlagsQueryHandler.Handle(getFeatureFlagsQuery, cancellation).ConfigureAwait(false);
    ...
    // END: GetFeatureFlagsQueryHandler156349492
