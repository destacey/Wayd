...
namespace Internal.Generated.WolverineHandlers
{
    ...
    public sealed class GetIterationMappingsQueryHandler1907064875 : Wolverine.Runtime.Handlers.MessageHandler
    {
        ...
        public GetIterationMappingsQueryHandler1907064875(Microsoft.AspNetCore.Http.IHttpContextAccessor __httpContextAccessor1, Microsoft.AspNetCore.Http.IHttpContextAccessor __httpContextAccessor2, Microsoft.EntityFrameworkCore.DbContextOptions dbContextOptions, Microsoft.Extensions.DependencyInjection.IServiceScopeFactory serviceScopeFactory, Microsoft.Extensions.Logging.ILogger<Wayd.Common.Application.Behaviors.PerformanceBehaviorLog> loggerOfPerformanceBehaviorLog, Microsoft.Extensions.Logging.ILogger<Wayd.Infrastructure.Common.Services.EventPublisher> loggerOfEventPublisher, Microsoft.Extensions.Logging.ILogger<Wayd.Planning.Application.Iterations.Queries.GetIterationMappingsQueryHandler> loggerOfGetIterationMappingsQueryHandler, Microsoft.Extensions.Options.IOptions<Wayd.Infrastructure.Persistence.DatabaseSettings> optionsOfDatabaseSettings, System.Collections.Generic.IEnumerable<Wolverine.EntityFrameworkCore.IDomainEventScraper> domainEventScraperIEnumerable, System.TimeProvider timeProvider, Wolverine.FluentValidation.IFailureAction<Wayd.Common.Application.Requests.Planning.Iterations.GetIterationMappingsQuery> failureActionOfGetIterationMappingsQuery, Wolverine.Runtime.IWolverineRuntime wolverineRuntime)
        {
        ...
        public override async System.Threading.Tasks.Task HandleAsync(Wolverine.Runtime.MessageContext context, System.Threading.CancellationToken cancellation)
        {
            ...
            try
            {
                ...
                await Wolverine.FluentValidation.Internals.FluentValidationExecutor.ExecuteOne<Wayd.Common.Application.Requests.Planning.Iterations.GetIterationMappingsQuery>(getIterationMappingsQueryValidator, _failureActionOfGetIterationMappingsQuery, getIterationMappingsQuery).ConfigureAwait(false);
                var getIterationMappingsQueryHandler = new Wayd.Planning.Application.Iterations.Queries.GetIterationMappingsQueryHandler(waydDbContext, _loggerOfGetIterationMappingsQueryHandler);
