...
{
    // START: GetMyRisksQueryHandler1251392374
    [global::System.CodeDom.Compiler.GeneratedCode("JasperFx", "1.0.0")]
    public sealed class GetMyRisksQueryHandler1251392374 : Wolverine.Runtime.Handlers.MessageHandler
    {
        ...
        public GetMyRisksQueryHandler1251392374(Microsoft.Extensions.DependencyInjection.IServiceScopeFactory serviceScopeFactory, Microsoft.Extensions.Logging.ILogger<Wayd.Common.Application.Behaviors.PerformanceBehaviorLog> loggerOfPerformanceBehaviorLog)
        {
        ...
        public override async System.Threading.Tasks.Task HandleAsync(Wolverine.Runtime.MessageContext context, System.Threading.CancellationToken cancellation)
        {
            ...
            */
            ...
            try
            {
                System.Diagnostics.Activity.Current?.SetTag("message.handler", "Wayd.Planning.Application.Risks.Queries.GetMyRisksQueryHandler");
                System.Diagnostics.Activity.Current?.SetTag("handler.type", "Wayd.Planning.Application.Risks.Queries.GetMyRisksQueryHandler");
                var getMyRisksQueryHandler = new Wayd.Planning.Application.Risks.Queries.GetMyRisksQueryHandler(planningDbContext, currentUser);
                
                // The actual message execution
                var outgoing1 = await getMyRisksQueryHandler.Handle(getMyRisksQuery, cancellation).ConfigureAwait(false);
    ...
    // END: GetMyRisksQueryHandler1251392374
