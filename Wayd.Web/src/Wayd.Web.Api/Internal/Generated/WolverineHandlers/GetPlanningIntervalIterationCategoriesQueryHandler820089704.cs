...
{
    // START: GetPlanningIntervalIterationCategoriesQueryHandler820089704
    [global::System.CodeDom.Compiler.GeneratedCode("JasperFx", "1.0.0")]
    public sealed class GetPlanningIntervalIterationCategoriesQueryHandler820089704 : Wolverine.Runtime.Handlers.MessageHandler
    {
        ...
        public GetPlanningIntervalIterationCategoriesQueryHandler820089704(Microsoft.Extensions.DependencyInjection.IServiceScopeFactory serviceScopeFactory, Microsoft.Extensions.Logging.ILogger<Wayd.Common.Application.Behaviors.PerformanceBehaviorLog> loggerOfPerformanceBehaviorLog)
        {
        ...
        public override async System.Threading.Tasks.Task HandleAsync(Wolverine.Runtime.MessageContext context, System.Threading.CancellationToken cancellation)
        {
            ...
            try
            {
                System.Diagnostics.Activity.Current?.SetTag("message.handler", "Wayd.Planning.Application.PlanningIntervals.Queries.GetPlanningIntervalIterationCategoriesQueryHandler");
                System.Diagnostics.Activity.Current?.SetTag("handler.type", "Wayd.Planning.Application.PlanningIntervals.Queries.GetPlanningIntervalIterationCategoriesQueryHandler");
                var getPlanningIntervalIterationCategoriesQueryHandler = new Wayd.Planning.Application.PlanningIntervals.Queries.GetPlanningIntervalIterationCategoriesQueryHandler();
                
                // The actual message execution
                var outgoing1 = await getPlanningIntervalIterationCategoriesQueryHandler.Handle(getPlanningIntervalIterationCategoriesQuery, cancellation).ConfigureAwait(false);
    ...
    // END: GetPlanningIntervalIterationCategoriesQueryHandler820089704
