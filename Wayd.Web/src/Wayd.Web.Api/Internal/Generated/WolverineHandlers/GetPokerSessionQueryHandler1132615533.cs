...
{
    // START: GetPokerSessionQueryHandler1132615533
    [global::System.CodeDom.Compiler.GeneratedCode("JasperFx", "1.0.0")]
    public sealed class GetPokerSessionQueryHandler1132615533 : Wolverine.Runtime.Handlers.MessageHandler
    {
        ...
        public override async System.Threading.Tasks.Task HandleAsync(Wolverine.Runtime.MessageContext context, System.Threading.CancellationToken cancellation)
        {
            ...
            try
            {
                System.Diagnostics.Activity.Current?.SetTag("message.handler", "Wayd.Planning.Application.PokerSessions.Queries.GetPokerSessionQueryHandler");
                System.Diagnostics.Activity.Current?.SetTag("handler.type", "Wayd.Planning.Application.PokerSessions.Queries.GetPokerSessionQueryHandler");
                var getPokerSessionQueryHandler = new Wayd.Planning.Application.PokerSessions.Queries.GetPokerSessionQueryHandler(waydDbContext);
                
                // The actual message execution
                var outgoing1 = await getPokerSessionQueryHandler.Handle(getPokerSessionQuery, cancellation).ConfigureAwait(false);
    ...
    // END: GetPokerSessionQueryHandler1132615533
