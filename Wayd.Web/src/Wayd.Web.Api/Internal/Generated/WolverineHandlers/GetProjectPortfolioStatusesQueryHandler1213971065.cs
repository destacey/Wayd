...
{
    // START: GetProjectPortfolioStatusesQueryHandler1213971065
    [global::System.CodeDom.Compiler.GeneratedCode("JasperFx", "1.0.0")]
    public sealed class GetProjectPortfolioStatusesQueryHandler1213971065 : Wolverine.Runtime.Handlers.MessageHandler
    {
        ...
        public GetProjectPortfolioStatusesQueryHandler1213971065(Microsoft.Extensions.DependencyInjection.IServiceScopeFactory serviceScopeFactory, Microsoft.Extensions.Logging.ILogger<Wayd.Common.Application.Behaviors.PerformanceBehaviorLog> loggerOfPerformanceBehaviorLog)
        {
        ...
        public override async System.Threading.Tasks.Task HandleAsync(Wolverine.Runtime.MessageContext context, System.Threading.CancellationToken cancellation)
        {
            ...
            try
            {
                System.Diagnostics.Activity.Current?.SetTag("message.handler", "Wayd.ProjectPortfolioManagement.Application.Portfolios.Queries.GetProjectPortfolioStatusesQueryHandler");
                System.Diagnostics.Activity.Current?.SetTag("handler.type", "Wayd.ProjectPortfolioManagement.Application.Portfolios.Queries.GetProjectPortfolioStatusesQueryHandler");
                var getProjectPortfolioStatusesQueryHandler = new Wayd.ProjectPortfolioManagement.Application.Portfolios.Queries.GetProjectPortfolioStatusesQueryHandler();
                
                // The actual message execution
                var outgoing1 = await getProjectPortfolioStatusesQueryHandler.Handle(getProjectPortfolioStatusesQuery, cancellation).ConfigureAwait(false);
    ...
    // END: GetProjectPortfolioStatusesQueryHandler1213971065
