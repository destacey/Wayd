...
{
    // START: GetProjectWorkItemsQueryHandler1726927657
    [global::System.CodeDom.Compiler.GeneratedCode("JasperFx", "1.0.0")]
    public sealed class GetProjectWorkItemsQueryHandler1726927657 : Wolverine.Runtime.Handlers.MessageHandler
    {
        ...
        public override async System.Threading.Tasks.Task HandleAsync(Wolverine.Runtime.MessageContext context, System.Threading.CancellationToken cancellation)
        {
            ...
            var getProjectWorkItemsQuery = (Wayd.Work.Application.WorkItems.Queries.GetProjectWorkItemsQuery)context.Envelope.Message;
            ...
            try
            {
                System.Diagnostics.Activity.Current?.SetTag("message.handler", "Wayd.Work.Application.WorkItems.Queries.GetProjectWorkItemsQueryHandler");
                System.Diagnostics.Activity.Current?.SetTag("handler.type", "Wayd.Work.Application.WorkItems.Queries.GetProjectWorkItemsQueryHandler");
                var getProjectWorkItemsQueryHandler = new Wayd.Work.Application.WorkItems.Queries.GetProjectWorkItemsQueryHandler(waydDbContext);
                
                // The actual message execution
                var outgoing1 = await getProjectWorkItemsQueryHandler.Handle(getProjectWorkItemsQuery, cancellation).ConfigureAwait(false);
    ...
    // END: GetProjectWorkItemsQueryHandler1726927657
