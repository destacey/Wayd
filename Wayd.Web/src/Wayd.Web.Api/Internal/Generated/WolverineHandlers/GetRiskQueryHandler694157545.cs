...
{
    // START: GetRiskQueryHandler694157545
    [global::System.CodeDom.Compiler.GeneratedCode("JasperFx", "1.0.0")]
    public sealed class GetRiskQueryHandler694157545 : Wolverine.Runtime.Handlers.MessageHandler
    {
        ...
        private readonly Microsoft.Extensions.Logging.ILogger<Wayd.Planning.Application.Risks.Queries.GetRiskQueryHandler> _loggerOfGetRiskQueryHandler;
        ...
        public GetRiskQueryHandler694157545(Microsoft.AspNetCore.Http.IHttpContextAccessor __httpContextAccessor1, Microsoft.AspNetCore.Http.IHttpContextAccessor __httpContextAccessor2, Microsoft.EntityFrameworkCore.DbContextOptions dbContextOptions, Microsoft.Extensions.DependencyInjection.IServiceScopeFactory serviceScopeFactory, Microsoft.Extensions.Logging.ILogger<Wayd.Common.Application.Behaviors.PerformanceBehaviorLog> loggerOfPerformanceBehaviorLog, Microsoft.Extensions.Logging.ILogger<Wayd.Infrastructure.Common.Services.EventPublisher> loggerOfEventPublisher, Microsoft.Extensions.Logging.ILogger<Wayd.Planning.Application.Risks.Queries.GetRiskQueryHandler> loggerOfGetRiskQueryHandler, Microsoft.Extensions.Options.IOptions<Wayd.Infrastructure.Persistence.DatabaseSettings> optionsOfDatabaseSettings, System.Collections.Generic.IEnumerable<Wolverine.EntityFrameworkCore.IDomainEventScraper> domainEventScraperIEnumerable, System.TimeProvider timeProvider, Wolverine.Runtime.IWolverineRuntime wolverineRuntime)
        {
            ...
            _loggerOfGetRiskQueryHandler = loggerOfGetRiskQueryHandler;
        ...
        public override async System.Threading.Tasks.Task HandleAsync(Wolverine.Runtime.MessageContext context, System.Threading.CancellationToken cancellation)
        {
            ...
            try
            {
                System.Diagnostics.Activity.Current?.SetTag("message.handler", "Wayd.Planning.Application.Risks.Queries.GetRiskQueryHandler");
                System.Diagnostics.Activity.Current?.SetTag("handler.type", "Wayd.Planning.Application.Risks.Queries.GetRiskQueryHandler");
                var getRiskQueryHandler = new Wayd.Planning.Application.Risks.Queries.GetRiskQueryHandler(waydDbContext, _loggerOfGetRiskQueryHandler);
                
                // The actual message execution
                var outgoing1 = await getRiskQueryHandler.Handle(getRiskQuery, cancellation).ConfigureAwait(false);
    ...
    // END: GetRiskQueryHandler694157545
