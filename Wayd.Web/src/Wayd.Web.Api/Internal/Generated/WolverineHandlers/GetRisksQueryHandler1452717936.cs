...
{
    // START: GetRisksQueryHandler1452717936
    [global::System.CodeDom.Compiler.GeneratedCode("JasperFx", "1.0.0")]
    public sealed class GetRisksQueryHandler1452717936 : Wolverine.Runtime.Handlers.MessageHandler
    {
        ...
        public override async System.Threading.Tasks.Task HandleAsync(Wolverine.Runtime.MessageContext context, System.Threading.CancellationToken cancellation)
        {
            ...
            var getRisksQuery = (Wayd.Planning.Application.Risks.Queries.GetRisksQuery)context.Envelope.Message;
            ...
            try
            {
                System.Diagnostics.Activity.Current?.SetTag("message.handler", "Wayd.Planning.Application.Risks.Queries.GetRisksQueryHandler");
                System.Diagnostics.Activity.Current?.SetTag("handler.type", "Wayd.Planning.Application.Risks.Queries.GetRisksQueryHandler");
                var getRisksQueryHandler = new Wayd.Planning.Application.Risks.Queries.GetRisksQueryHandler(waydDbContext);
                
                // The actual message execution
                var outgoing1 = await getRisksQueryHandler.Handle(getRisksQuery, cancellation).ConfigureAwait(false);
    ...
    // END: GetRisksQueryHandler1452717936
