...
{
    // START: GetRoadmapActivitiesQueryHandler1649316866
    [global::System.CodeDom.Compiler.GeneratedCode("JasperFx", "1.0.0")]
    public sealed class GetRoadmapActivitiesQueryHandler1649316866 : Wolverine.Runtime.Handlers.MessageHandler
    {
        ...
        public override async System.Threading.Tasks.Task HandleAsync(Wolverine.Runtime.MessageContext context, System.Threading.CancellationToken cancellation)
        {
            ...
            var getRoadmapActivitiesQuery = (Wayd.Planning.Application.Roadmaps.Queries.GetRoadmapActivitiesQuery)context.Envelope.Message;
            ...
            try
            {
                System.Diagnostics.Activity.Current?.SetTag("message.handler", "Wayd.Planning.Application.Roadmaps.Queries.GetRoadmapActivitiesQueryHandler");
                System.Diagnostics.Activity.Current?.SetTag("handler.type", "Wayd.Planning.Application.Roadmaps.Queries.GetRoadmapActivitiesQueryHandler");
                var getRoadmapActivitiesQueryHandler = new Wayd.Planning.Application.Roadmaps.Queries.GetRoadmapActivitiesQueryHandler(waydDbContext, currentUser);
                
                // The actual message execution
                var outgoing1 = await getRoadmapActivitiesQueryHandler.Handle(getRoadmapActivitiesQuery, cancellation).ConfigureAwait(false);
    ...
    // END: GetRoadmapActivitiesQueryHandler1649316866
