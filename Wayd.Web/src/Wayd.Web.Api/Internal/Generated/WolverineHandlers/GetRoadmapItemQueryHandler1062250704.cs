...
{
    // START: GetRoadmapItemQueryHandler1062250704
    [global::System.CodeDom.Compiler.GeneratedCode("JasperFx", "1.0.0")]
    public sealed class GetRoadmapItemQueryHandler1062250704 : Wolverine.Runtime.Handlers.MessageHandler
    {
        ...
        public override async System.Threading.Tasks.Task HandleAsync(Wolverine.Runtime.MessageContext context, System.Threading.CancellationToken cancellation)
        {
            ...
            try
            {
                System.Diagnostics.Activity.Current?.SetTag("message.handler", "Wayd.Planning.Application.Roadmaps.Queries.GetRoadmapItemQueryHandler");
                System.Diagnostics.Activity.Current?.SetTag("handler.type", "Wayd.Planning.Application.Roadmaps.Queries.GetRoadmapItemQueryHandler");
                var getRoadmapItemQueryHandler = new Wayd.Planning.Application.Roadmaps.Queries.GetRoadmapItemQueryHandler(waydDbContext, currentUser);
                
                // The actual message execution
                var outgoing1 = await getRoadmapItemQueryHandler.Handle(getRoadmapItemQuery, cancellation).ConfigureAwait(false);
    ...
    // END: GetRoadmapItemQueryHandler1062250704
