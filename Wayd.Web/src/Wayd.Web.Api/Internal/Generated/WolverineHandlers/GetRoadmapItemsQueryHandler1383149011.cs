...
{
    // START: GetRoadmapItemsQueryHandler1383149011
    [global::System.CodeDom.Compiler.GeneratedCode("JasperFx", "1.0.0")]
    public sealed class GetRoadmapItemsQueryHandler1383149011 : Wolverine.Runtime.Handlers.MessageHandler
    {
        ...
        public override async System.Threading.Tasks.Task HandleAsync(Wolverine.Runtime.MessageContext context, System.Threading.CancellationToken cancellation)
        {
            ...
            var getRoadmapItemsQuery = (Wayd.Planning.Application.Roadmaps.Queries.GetRoadmapItemsQuery)context.Envelope.Message;
            ...
            try
            {
                System.Diagnostics.Activity.Current?.SetTag("message.handler", "Wayd.Planning.Application.Roadmaps.Queries.GetRoadmapItemsQueryHandler");
                System.Diagnostics.Activity.Current?.SetTag("handler.type", "Wayd.Planning.Application.Roadmaps.Queries.GetRoadmapItemsQueryHandler");
                var getRoadmapItemsQueryHandler = new Wayd.Planning.Application.Roadmaps.Queries.GetRoadmapItemsQueryHandler(waydDbContext, currentUser);
                
                // The actual message execution
                var outgoing1 = await getRoadmapItemsQueryHandler.Handle(getRoadmapItemsQuery, cancellation).ConfigureAwait(false);
    ...
    // END: GetRoadmapItemsQueryHandler1383149011
