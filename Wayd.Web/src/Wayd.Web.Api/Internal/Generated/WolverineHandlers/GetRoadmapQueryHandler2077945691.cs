...
{
    // START: GetRoadmapQueryHandler2077945691
    [global::System.CodeDom.Compiler.GeneratedCode("JasperFx", "1.0.0")]
    public sealed class GetRoadmapQueryHandler2077945691 : Wolverine.Runtime.Handlers.MessageHandler
    {
        ...
        public override async System.Threading.Tasks.Task HandleAsync(Wolverine.Runtime.MessageContext context, System.Threading.CancellationToken cancellation)
        {
            ...
            var getRoadmapQuery = (Wayd.Planning.Application.Roadmaps.Queries.GetRoadmapQuery)context.Envelope.Message;
            ...
            try
            {
                System.Diagnostics.Activity.Current?.SetTag("message.handler", "Wayd.Planning.Application.Roadmaps.Queries.GetRoadmapQueryHandler");
                System.Diagnostics.Activity.Current?.SetTag("handler.type", "Wayd.Planning.Application.Roadmaps.Queries.GetRoadmapQueryHandler");
                var getRoadmapQueryHandler = new Wayd.Planning.Application.Roadmaps.Queries.GetRoadmapQueryHandler(waydDbContext, currentUser);
                
                // The actual message execution
                var outgoing1 = await getRoadmapQueryHandler.Handle(getRoadmapQuery, cancellation).ConfigureAwait(false);
    ...
    // END: GetRoadmapQueryHandler2077945691
