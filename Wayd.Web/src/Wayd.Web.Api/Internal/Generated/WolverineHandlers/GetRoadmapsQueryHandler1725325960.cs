...
{
    // START: GetRoadmapsQueryHandler1725325960
    [global::System.CodeDom.Compiler.GeneratedCode("JasperFx", "1.0.0")]
    public sealed class GetRoadmapsQueryHandler1725325960 : Wolverine.Runtime.Handlers.MessageHandler
    {
        ...
        public override async System.Threading.Tasks.Task HandleAsync(Wolverine.Runtime.MessageContext context, System.Threading.CancellationToken cancellation)
        {
            ...
            try
            {
                System.Diagnostics.Activity.Current?.SetTag("message.handler", "Wayd.Planning.Application.Roadmaps.Queries.GetRoadmapsQueryHandler");
                System.Diagnostics.Activity.Current?.SetTag("handler.type", "Wayd.Planning.Application.Roadmaps.Queries.GetRoadmapsQueryHandler");
                var getRoadmapsQueryHandler = new Wayd.Planning.Application.Roadmaps.Queries.GetRoadmapsQueryHandler(waydDbContext, currentUser);
                
                // The actual message execution
                var outgoing1 = await getRoadmapsQueryHandler.Handle(getRoadmapsQuery, cancellation).ConfigureAwait(false);
    ...
    // END: GetRoadmapsQueryHandler1725325960
