...
{
    // START: GetScoringModelsQueryHandler1346065757
    [global::System.CodeDom.Compiler.GeneratedCode("JasperFx", "1.0.0")]
    public sealed class GetScoringModelsQueryHandler1346065757 : Wolverine.Runtime.Handlers.MessageHandler
    {
        ...
        public override async System.Threading.Tasks.Task HandleAsync(Wolverine.Runtime.MessageContext context, System.Threading.CancellationToken cancellation)
        {
            ...
            var getScoringModelsQuery = (Wayd.Common.Application.Scoring.ScoringModels.Queries.GetScoringModelsQuery)context.Envelope.Message;
            ...
            try
            {
                System.Diagnostics.Activity.Current?.SetTag("message.handler", "Wayd.Common.Application.Scoring.ScoringModels.Queries.GetScoringModelsQueryHandler");
                System.Diagnostics.Activity.Current?.SetTag("handler.type", "Wayd.Common.Application.Scoring.ScoringModels.Queries.GetScoringModelsQueryHandler");
                var getScoringModelsQueryHandler = new Wayd.Common.Application.Scoring.ScoringModels.Queries.GetScoringModelsQueryHandler(waydDbContext);
                
                // The actual message execution
                var outgoing1 = await getScoringModelsQueryHandler.Handle(getScoringModelsQuery, cancellation).ConfigureAwait(false);
    ...
    // END: GetScoringModelsQueryHandler1346065757
