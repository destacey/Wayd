...
{
    // START: GetSimpleIterationsQueryHandler632905138
    [global::System.CodeDom.Compiler.GeneratedCode("JasperFx", "1.0.0")]
    public sealed class GetSimpleIterationsQueryHandler632905138 : Wolverine.Runtime.Handlers.MessageHandler
    {
        ...
        public override async System.Threading.Tasks.Task HandleAsync(Wolverine.Runtime.MessageContext context, System.Threading.CancellationToken cancellation)
        {
            ...
            var getSimpleIterationsQuery = (Wayd.Planning.Application.Iterations.Queries.GetSimpleIterationsQuery)context.Envelope.Message;
            ...
            try
            {
                System.Diagnostics.Activity.Current?.SetTag("message.handler", "Wayd.Planning.Application.Iterations.Queries.GetSimpleIterationsQueryHandler");
                System.Diagnostics.Activity.Current?.SetTag("handler.type", "Wayd.Planning.Application.Iterations.Queries.GetSimpleIterationsQueryHandler");
                var getSimpleIterationsQueryHandler = new Wayd.Planning.Application.Iterations.Queries.GetSimpleIterationsQueryHandler(waydDbContext);
                
                // The actual message execution
                var outgoing1 = await getSimpleIterationsQueryHandler.Handle(getSimpleIterationsQuery, cancellation).ConfigureAwait(false);
    ...
    // END: GetSimpleIterationsQueryHandler632905138
