...
{
    // START: GetSimpleTeamsQueryHandler2112319136
    [global::System.CodeDom.Compiler.GeneratedCode("JasperFx", "1.0.0")]
    public sealed class GetSimpleTeamsQueryHandler2112319136 : Wolverine.Runtime.Handlers.MessageHandler
    {
        ...
        public override async System.Threading.Tasks.Task HandleAsync(Wolverine.Runtime.MessageContext context, System.Threading.CancellationToken cancellation)
        {
            ...
            var getSimpleTeamsQuery = (Wayd.Organization.Application.Teams.Queries.GetSimpleTeamsQuery)context.Envelope.Message;
            ...
            try
            {
                System.Diagnostics.Activity.Current?.SetTag("message.handler", "Wayd.Organization.Application.Teams.Queries.GetSimpleTeamsQueryHandler");
                System.Diagnostics.Activity.Current?.SetTag("handler.type", "Wayd.Organization.Application.Teams.Queries.GetSimpleTeamsQueryHandler");
                var getSimpleTeamsQueryHandler = new Wayd.Organization.Application.Teams.Queries.GetSimpleTeamsQueryHandler(waydDbContext);
                
                // The actual message execution
                var outgoing1 = await getSimpleTeamsQueryHandler.Handle(getSimpleTeamsQuery, cancellation).ConfigureAwait(false);
    ...
    // END: GetSimpleTeamsQueryHandler2112319136
