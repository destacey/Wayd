...
{
    // START: GetSprintWorkItemMetricsQueryHandler1224825778
    [global::System.CodeDom.Compiler.GeneratedCode("JasperFx", "1.0.0")]
    public sealed class GetSprintWorkItemMetricsQueryHandler1224825778 : Wolverine.Runtime.Handlers.MessageHandler
    {
        ...
        private readonly Microsoft.Extensions.Logging.ILogger<Wayd.Work.Application.WorkItems.Queries.GetSprintWorkItemMetricsQueryHandler> _loggerOfGetSprintWorkItemMetricsQueryHandler;
        ...
        public GetSprintWorkItemMetricsQueryHandler1224825778(Microsoft.AspNetCore.Http.IHttpContextAccessor __httpContextAccessor1, Microsoft.AspNetCore.Http.IHttpContextAccessor __httpContextAccessor2, Microsoft.EntityFrameworkCore.DbContextOptions dbContextOptions, Microsoft.Extensions.DependencyInjection.IServiceScopeFactory serviceScopeFactory, Microsoft.Extensions.Logging.ILogger<Wayd.Common.Application.Behaviors.PerformanceBehaviorLog> loggerOfPerformanceBehaviorLog, Microsoft.Extensions.Logging.ILogger<Wayd.Infrastructure.Common.Services.EventPublisher> loggerOfEventPublisher, Microsoft.Extensions.Logging.ILogger<Wayd.Work.Application.WorkItems.Queries.GetSprintWorkItemMetricsQueryHandler> loggerOfGetSprintWorkItemMetricsQueryHandler, Microsoft.Extensions.Options.IOptions<Wayd.Infrastructure.Persistence.DatabaseSettings> optionsOfDatabaseSettings, System.Collections.Generic.IEnumerable<Wolverine.EntityFrameworkCore.IDomainEventScraper> domainEventScraperIEnumerable, System.TimeProvider timeProvider, Wolverine.Runtime.IWolverineRuntime wolverineRuntime)
        {
            ...
            _loggerOfGetSprintWorkItemMetricsQueryHandler = loggerOfGetSprintWorkItemMetricsQueryHandler;
        ...
        public override async System.Threading.Tasks.Task HandleAsync(Wolverine.Runtime.MessageContext context, System.Threading.CancellationToken cancellation)
        {
            ...
            var getSprintWorkItemMetricsQuery = (Wayd.Work.Application.WorkItems.Queries.GetSprintWorkItemMetricsQuery)context.Envelope.Message;
            ...
            try
            {
                System.Diagnostics.Activity.Current?.SetTag("message.handler", "Wayd.Work.Application.WorkItems.Queries.GetSprintWorkItemMetricsQueryHandler");
                System.Diagnostics.Activity.Current?.SetTag("handler.type", "Wayd.Work.Application.WorkItems.Queries.GetSprintWorkItemMetricsQueryHandler");
                var getSprintWorkItemMetricsQueryHandler = new Wayd.Work.Application.WorkItems.Queries.GetSprintWorkItemMetricsQueryHandler(waydDbContext, _loggerOfGetSprintWorkItemMetricsQueryHandler);
                
                // The actual message execution
                var outgoing1 = await getSprintWorkItemMetricsQueryHandler.Handle(getSprintWorkItemMetricsQuery, cancellation).ConfigureAwait(false);
    ...
    // END: GetSprintWorkItemMetricsQueryHandler1224825778
