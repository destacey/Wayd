...
{
    // START: GetSprintsBacklogQueryHandler1981851357
    [global::System.CodeDom.Compiler.GeneratedCode("JasperFx", "1.0.0")]
    public sealed class GetSprintsBacklogQueryHandler1981851357 : Wolverine.Runtime.Handlers.MessageHandler
    {
        ...
        private readonly Microsoft.Extensions.Logging.ILogger<Wayd.Work.Application.WorkItems.Queries.GetSprintsBacklogQueryHandler> _loggerOfGetSprintsBacklogQueryHandler;
        ...
        public GetSprintsBacklogQueryHandler1981851357(Microsoft.AspNetCore.Http.IHttpContextAccessor __httpContextAccessor1, Microsoft.AspNetCore.Http.IHttpContextAccessor __httpContextAccessor2, Microsoft.EntityFrameworkCore.DbContextOptions dbContextOptions, Microsoft.Extensions.DependencyInjection.IServiceScopeFactory serviceScopeFactory, Microsoft.Extensions.Logging.ILogger<Wayd.Common.Application.Behaviors.PerformanceBehaviorLog> loggerOfPerformanceBehaviorLog, Microsoft.Extensions.Logging.ILogger<Wayd.Infrastructure.Common.Services.EventPublisher> loggerOfEventPublisher, Microsoft.Extensions.Logging.ILogger<Wayd.Work.Application.WorkItems.Queries.GetSprintsBacklogQueryHandler> loggerOfGetSprintsBacklogQueryHandler, Microsoft.Extensions.Options.IOptions<Wayd.Infrastructure.Persistence.DatabaseSettings> optionsOfDatabaseSettings, System.Collections.Generic.IEnumerable<Wolverine.EntityFrameworkCore.IDomainEventScraper> domainEventScraperIEnumerable, System.TimeProvider timeProvider, Wolverine.Runtime.IWolverineRuntime wolverineRuntime)
        {
            ...
            _loggerOfGetSprintsBacklogQueryHandler = loggerOfGetSprintsBacklogQueryHandler;
        ...
        public override async System.Threading.Tasks.Task HandleAsync(Wolverine.Runtime.MessageContext context, System.Threading.CancellationToken cancellation)
        {
            ...
            var getSprintsBacklogQuery = (Wayd.Work.Application.WorkItems.Queries.GetSprintsBacklogQuery)context.Envelope.Message;
            ...
            try
            {
                System.Diagnostics.Activity.Current?.SetTag("message.handler", "Wayd.Work.Application.WorkItems.Queries.GetSprintsBacklogQueryHandler");
                System.Diagnostics.Activity.Current?.SetTag("handler.type", "Wayd.Work.Application.WorkItems.Queries.GetSprintsBacklogQueryHandler");
                var getSprintsBacklogQueryHandler = new Wayd.Work.Application.WorkItems.Queries.GetSprintsBacklogQueryHandler(waydDbContext, _loggerOfGetSprintsBacklogQueryHandler);
                
                // The actual message execution
                var outgoing1 = await getSprintsBacklogQueryHandler.Handle(getSprintsBacklogQuery, cancellation).ConfigureAwait(false);
    ...
    // END: GetSprintsBacklogQueryHandler1981851357
