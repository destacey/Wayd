...
{
    // START: GetSprintsQueryHandler120463231
    [global::System.CodeDom.Compiler.GeneratedCode("JasperFx", "1.0.0")]
    public sealed class GetSprintsQueryHandler120463231 : Wolverine.Runtime.Handlers.MessageHandler
    {
        ...
        public override async System.Threading.Tasks.Task HandleAsync(Wolverine.Runtime.MessageContext context, System.Threading.CancellationToken cancellation)
        {
            ...
            var getSprintsQuery = (Wayd.Planning.Application.Iterations.Queries.GetSprintsQuery)context.Envelope.Message;
            ...
            try
            {
                System.Diagnostics.Activity.Current?.SetTag("message.handler", "Wayd.Planning.Application.Iterations.Queries.GetSprintsQueryHandler");
                System.Diagnostics.Activity.Current?.SetTag("handler.type", "Wayd.Planning.Application.Iterations.Queries.GetSprintsQueryHandler");
                var getSprintsQueryHandler = new Wayd.Planning.Application.Iterations.Queries.GetSprintsQueryHandler(waydDbContext);
                
                // The actual message execution
                var outgoing1 = await getSprintsQueryHandler.Handle(getSprintsQuery, cancellation).ConfigureAwait(false);
    ...
    // END: GetSprintsQueryHandler120463231
