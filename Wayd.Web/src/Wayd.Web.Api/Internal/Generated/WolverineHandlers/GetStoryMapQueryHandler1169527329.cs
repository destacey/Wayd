...
{
    // START: GetStoryMapQueryHandler1169527329
    [global::System.CodeDom.Compiler.GeneratedCode("JasperFx", "1.0.0")]
    public sealed class GetStoryMapQueryHandler1169527329 : Wolverine.Runtime.Handlers.MessageHandler
    {
        ...
        public override async System.Threading.Tasks.Task HandleAsync(Wolverine.Runtime.MessageContext context, System.Threading.CancellationToken cancellation)
        {
            ...
            var getStoryMapQuery = (Wayd.Planning.Application.StoryMaps.Queries.GetStoryMapQuery)context.Envelope.Message;
            ...
            try
            {
                System.Diagnostics.Activity.Current?.SetTag("message.handler", "Wayd.Planning.Application.StoryMaps.Queries.GetStoryMapQueryHandler");
                System.Diagnostics.Activity.Current?.SetTag("handler.type", "Wayd.Planning.Application.StoryMaps.Queries.GetStoryMapQueryHandler");
                var getStoryMapQueryHandler = new Wayd.Planning.Application.StoryMaps.Queries.GetStoryMapQueryHandler(waydDbContext);
                
                // The actual message execution
                var outgoing1 = await getStoryMapQueryHandler.Handle(getStoryMapQuery, cancellation).ConfigureAwait(false);
    ...
    // END: GetStoryMapQueryHandler1169527329
