...
{
    // START: GetStoryMapsQueryHandler768483608
    [global::System.CodeDom.Compiler.GeneratedCode("JasperFx", "1.0.0")]
    public sealed class GetStoryMapsQueryHandler768483608 : Wolverine.Runtime.Handlers.MessageHandler
    {
        ...
        public override async System.Threading.Tasks.Task HandleAsync(Wolverine.Runtime.MessageContext context, System.Threading.CancellationToken cancellation)
        {
            ...
            var getStoryMapsQuery = (Wayd.Planning.Application.StoryMaps.Queries.GetStoryMapsQuery)context.Envelope.Message;
            ...
            try
            {
                System.Diagnostics.Activity.Current?.SetTag("message.handler", "Wayd.Planning.Application.StoryMaps.Queries.GetStoryMapsQueryHandler");
                System.Diagnostics.Activity.Current?.SetTag("handler.type", "Wayd.Planning.Application.StoryMaps.Queries.GetStoryMapsQueryHandler");
                var getStoryMapsQueryHandler = new Wayd.Planning.Application.StoryMaps.Queries.GetStoryMapsQueryHandler(waydDbContext);
                
                // The actual message execution
                var outgoing1 = await getStoryMapsQueryHandler.Handle(getStoryMapsQuery, cancellation).ConfigureAwait(false);
    ...
    // END: GetStoryMapsQueryHandler768483608
