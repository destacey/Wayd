...
{
    // START: GetStrategicThemeOptionsQueryHandler523023119
    [global::System.CodeDom.Compiler.GeneratedCode("JasperFx", "1.0.0")]
    public sealed class GetStrategicThemeOptionsQueryHandler523023119 : Wolverine.Runtime.Handlers.MessageHandler
    {
        ...
        public override async System.Threading.Tasks.Task HandleAsync(Wolverine.Runtime.MessageContext context, System.Threading.CancellationToken cancellation)
        {
            ...
            var getStrategicThemeOptionsQuery = (Wayd.StrategicManagement.Application.StrategicThemes.Queries.GetStrategicThemeOptionsQuery)context.Envelope.Message;
            ...
            try
            {
                System.Diagnostics.Activity.Current?.SetTag("message.handler", "Wayd.StrategicManagement.Application.StrategicThemes.Queries.GetStrategicThemeOptionsQueryHandler");
                System.Diagnostics.Activity.Current?.SetTag("handler.type", "Wayd.StrategicManagement.Application.StrategicThemes.Queries.GetStrategicThemeOptionsQueryHandler");
                var getStrategicThemeOptionsQueryHandler = new Wayd.StrategicManagement.Application.StrategicThemes.Queries.GetStrategicThemeOptionsQueryHandler(waydDbContext);
                
                // The actual message execution
                var outgoing1 = await getStrategicThemeOptionsQueryHandler.Handle(getStrategicThemeOptionsQuery, cancellation).ConfigureAwait(false);
    ...
    // END: GetStrategicThemeOptionsQueryHandler523023119
