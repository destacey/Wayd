...
{
    // START: GetStrategiesQueryHandler1208645126
    [global::System.CodeDom.Compiler.GeneratedCode("JasperFx", "1.0.0")]
    public sealed class GetStrategiesQueryHandler1208645126 : Wolverine.Runtime.Handlers.MessageHandler
    {
        ...
        public override async System.Threading.Tasks.Task HandleAsync(Wolverine.Runtime.MessageContext context, System.Threading.CancellationToken cancellation)
        {
            ...
            var getStrategiesQuery = (Wayd.StrategicManagement.Application.Strategies.Queries.GetStrategiesQuery)context.Envelope.Message;
            ...
            try
            {
                System.Diagnostics.Activity.Current?.SetTag("message.handler", "Wayd.StrategicManagement.Application.Strategies.Queries.GetStrategysQueryHandler");
                System.Diagnostics.Activity.Current?.SetTag("handler.type", "Wayd.StrategicManagement.Application.Strategies.Queries.GetStrategysQueryHandler");
                var getStrategysQueryHandler = new Wayd.StrategicManagement.Application.Strategies.Queries.GetStrategysQueryHandler(waydDbContext);
                
                // The actual message execution
                var outgoing1 = await getStrategysQueryHandler.Handle(getStrategiesQuery, cancellation).ConfigureAwait(false);
    ...
    // END: GetStrategiesQueryHandler1208645126
