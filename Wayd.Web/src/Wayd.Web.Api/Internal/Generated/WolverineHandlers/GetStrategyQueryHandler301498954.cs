...
{
    // START: GetStrategyQueryHandler301498954
    [global::System.CodeDom.Compiler.GeneratedCode("JasperFx", "1.0.0")]
    public sealed class GetStrategyQueryHandler301498954 : Wolverine.Runtime.Handlers.MessageHandler
    {
        ...
        public override async System.Threading.Tasks.Task HandleAsync(Wolverine.Runtime.MessageContext context, System.Threading.CancellationToken cancellation)
        {
            ...
            var getStrategyQuery = (Wayd.StrategicManagement.Application.Strategies.Queries.GetStrategyQuery)context.Envelope.Message;
            ...
            try
            {
                System.Diagnostics.Activity.Current?.SetTag("message.handler", "Wayd.StrategicManagement.Application.Strategies.Queries.GetStrategyQueryHandler");
                System.Diagnostics.Activity.Current?.SetTag("handler.type", "Wayd.StrategicManagement.Application.Strategies.Queries.GetStrategyQueryHandler");
                var getStrategyQueryHandler = new Wayd.StrategicManagement.Application.Strategies.Queries.GetStrategyQueryHandler(waydDbContext);
                
                // The actual message execution
                var outgoing1 = await getStrategyQueryHandler.Handle(getStrategyQuery, cancellation).ConfigureAwait(false);
    ...
    // END: GetStrategyQueryHandler301498954
