...
{
    // START: GetTeamMembersQueryHandler1209725364
    [global::System.CodeDom.Compiler.GeneratedCode("JasperFx", "1.0.0")]
    public sealed class GetTeamMembersQueryHandler1209725364 : Wolverine.Runtime.Handlers.MessageHandler
    {
        ...
        public override async System.Threading.Tasks.Task HandleAsync(Wolverine.Runtime.MessageContext context, System.Threading.CancellationToken cancellation)
        {
            ...
            var getTeamMembersQuery = (Wayd.Organization.Application.Teams.Queries.GetTeamMembersQuery)context.Envelope.Message;
            ...
            try
            {
                System.Diagnostics.Activity.Current?.SetTag("message.handler", "Wayd.Organization.Application.Teams.Queries.GetTeamMembersQueryHandler");
                System.Diagnostics.Activity.Current?.SetTag("handler.type", "Wayd.Organization.Application.Teams.Queries.GetTeamMembersQueryHandler");
                var getTeamMembersQueryHandler = new Wayd.Organization.Application.Teams.Queries.GetTeamMembersQueryHandler(waydDbContext);
                
                // The actual message execution
                var outgoing1 = await getTeamMembersQueryHandler.Handle(getTeamMembersQuery, cancellation).ConfigureAwait(false);
    ...
    // END: GetTeamMembersQueryHandler1209725364
