...
{
    // START: GetWorkProcessQueryHandler358365084
    [global::System.CodeDom.Compiler.GeneratedCode("JasperFx", "1.0.0")]
    public sealed class GetWorkProcessQueryHandler358365084 : Wolverine.Runtime.Handlers.MessageHandler
    {
        ...
        private readonly Microsoft.Extensions.Logging.ILogger<Wayd.Work.Application.WorkProcesses.Queries.GetWorkProcessQueryHandler> _loggerOfGetWorkProcessQueryHandler;
        ...
        public GetWorkProcessQueryHandler358365084(Microsoft.AspNetCore.Http.IHttpContextAccessor __httpContextAccessor1, Microsoft.AspNetCore.Http.IHttpContextAccessor __httpContextAccessor2, Microsoft.EntityFrameworkCore.DbContextOptions dbContextOptions, Microsoft.Extensions.DependencyInjection.IServiceScopeFactory serviceScopeFactory, Microsoft.Extensions.Logging.ILogger<Wayd.Common.Application.Behaviors.PerformanceBehaviorLog> loggerOfPerformanceBehaviorLog, Microsoft.Extensions.Logging.ILogger<Wayd.Infrastructure.Common.Services.EventPublisher> loggerOfEventPublisher, Microsoft.Extensions.Logging.ILogger<Wayd.Work.Application.WorkProcesses.Queries.GetWorkProcessQueryHandler> loggerOfGetWorkProcessQueryHandler, Microsoft.Extensions.Options.IOptions<Wayd.Infrastructure.Persistence.DatabaseSettings> optionsOfDatabaseSettings, System.Collections.Generic.IEnumerable<Wolverine.EntityFrameworkCore.IDomainEventScraper> domainEventScraperIEnumerable, System.TimeProvider timeProvider, Wolverine.Runtime.IWolverineRuntime wolverineRuntime)
        {
            ...
            _loggerOfGetWorkProcessQueryHandler = loggerOfGetWorkProcessQueryHandler;
        ...
        public override async System.Threading.Tasks.Task HandleAsync(Wolverine.Runtime.MessageContext context, System.Threading.CancellationToken cancellation)
        {
            ...
            var getWorkProcessQuery = (Wayd.Work.Application.WorkProcesses.Queries.GetWorkProcessQuery)context.Envelope.Message;
            ...
            try
            {
                System.Diagnostics.Activity.Current?.SetTag("message.handler", "Wayd.Work.Application.WorkProcesses.Queries.GetWorkProcessQueryHandler");
                System.Diagnostics.Activity.Current?.SetTag("handler.type", "Wayd.Work.Application.WorkProcesses.Queries.GetWorkProcessQueryHandler");
                var getWorkProcessQueryHandler = new Wayd.Work.Application.WorkProcesses.Queries.GetWorkProcessQueryHandler(waydDbContext, _loggerOfGetWorkProcessQueryHandler);
                
                // The actual message execution
                var outgoing1 = await getWorkProcessQueryHandler.Handle(getWorkProcessQuery, cancellation).ConfigureAwait(false);
    ...
    // END: GetWorkProcessQueryHandler358365084
