...
namespace Internal.Generated.WolverineHandlers
{
    ...
    public sealed class GetWorkProcessSchemesQueryHandler394688068 : Wolverine.Runtime.Handlers.MessageHandler
    {
        ...
        public GetWorkProcessSchemesQueryHandler394688068(Microsoft.AspNetCore.Http.IHttpContextAccessor __httpContextAccessor1, Microsoft.AspNetCore.Http.IHttpContextAccessor __httpContextAccessor2, Microsoft.EntityFrameworkCore.DbContextOptions dbContextOptions, Microsoft.Extensions.DependencyInjection.IServiceScopeFactory serviceScopeFactory, Microsoft.Extensions.Logging.ILogger<Wayd.Common.Application.Behaviors.PerformanceBehaviorLog> loggerOfPerformanceBehaviorLog, Microsoft.Extensions.Logging.ILogger<Wayd.Infrastructure.Common.Services.EventPublisher> loggerOfEventPublisher, Microsoft.Extensions.Logging.ILogger<Wayd.Work.Application.WorkProcesses.Queries.GetWorkProcessSchemesQueryHandler> loggerOfGetWorkProcessSchemesQueryHandler, Microsoft.Extensions.Options.IOptions<Wayd.Infrastructure.Persistence.DatabaseSettings> optionsOfDatabaseSettings, System.Collections.Generic.IEnumerable<Wolverine.EntityFrameworkCore.IDomainEventScraper> domainEventScraperIEnumerable, System.TimeProvider timeProvider, Wolverine.FluentValidation.IFailureAction<Wayd.Common.Application.Requests.WorkManagement.Queries.GetWorkProcessSchemesQuery> failureActionOfGetWorkProcessSchemesQuery, Wolverine.Runtime.IWolverineRuntime wolverineRuntime)
        {
        ...
        public override async System.Threading.Tasks.Task HandleAsync(Wolverine.Runtime.MessageContext context, System.Threading.CancellationToken cancellation)
        {
            ...
            try
            {
                ...
                await Wolverine.FluentValidation.Internals.FluentValidationExecutor.ExecuteOne<Wayd.Common.Application.Requests.WorkManagement.Queries.GetWorkProcessSchemesQuery>(getWorkProcessSchemesQueryValidator, _failureActionOfGetWorkProcessSchemesQuery, getWorkProcessSchemesQuery).ConfigureAwait(false);
                var getWorkProcessSchemesQueryHandler = new Wayd.Work.Application.WorkProcesses.Queries.GetWorkProcessSchemesQueryHandler(waydDbContext, _loggerOfGetWorkProcessSchemesQueryHandler);
