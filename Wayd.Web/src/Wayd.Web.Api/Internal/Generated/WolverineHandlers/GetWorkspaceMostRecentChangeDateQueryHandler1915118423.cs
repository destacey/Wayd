...
{
    // START: GetWorkspaceMostRecentChangeDateQueryHandler1915118423
    [global::System.CodeDom.Compiler.GeneratedCode("JasperFx", "1.0.0")]
    public sealed class GetWorkspaceMostRecentChangeDateQueryHandler1915118423 : Wolverine.Runtime.Handlers.MessageHandler
    {
        ...
        private readonly Microsoft.Extensions.Logging.ILogger<Wayd.Work.Application.Workspaces.Queries.GetWorkspaceMostRecentChangeDateQueryHandler> _loggerOfGetWorkspaceMostRecentChangeDateQueryHandler;
        ...
        public GetWorkspaceMostRecentChangeDateQueryHandler1915118423(Microsoft.AspNetCore.Http.IHttpContextAccessor __httpContextAccessor1, Microsoft.AspNetCore.Http.IHttpContextAccessor __httpContextAccessor2, Microsoft.EntityFrameworkCore.DbContextOptions dbContextOptions, Microsoft.Extensions.DependencyInjection.IServiceScopeFactory serviceScopeFactory, Microsoft.Extensions.Logging.ILogger<Wayd.Common.Application.Behaviors.PerformanceBehaviorLog> loggerOfPerformanceBehaviorLog, Microsoft.Extensions.Logging.ILogger<Wayd.Infrastructure.Common.Services.EventPublisher> loggerOfEventPublisher, Microsoft.Extensions.Logging.ILogger<Wayd.Work.Application.Workspaces.Queries.GetWorkspaceMostRecentChangeDateQueryHandler> loggerOfGetWorkspaceMostRecentChangeDateQueryHandler, Microsoft.Extensions.Options.IOptions<Wayd.Infrastructure.Persistence.DatabaseSettings> optionsOfDatabaseSettings, System.Collections.Generic.IEnumerable<Wolverine.EntityFrameworkCore.IDomainEventScraper> domainEventScraperIEnumerable, System.TimeProvider timeProvider, Wolverine.Runtime.IWolverineRuntime wolverineRuntime)
        {
            ...
            _loggerOfGetWorkspaceMostRecentChangeDateQueryHandler = loggerOfGetWorkspaceMostRecentChangeDateQueryHandler;
        ...
        public override async System.Threading.Tasks.Task HandleAsync(Wolverine.Runtime.MessageContext context, System.Threading.CancellationToken cancellation)
        {
            ...
            var getWorkspaceMostRecentChangeDateQuery = (Wayd.Common.Application.Requests.WorkManagement.Queries.GetWorkspaceMostRecentChangeDateQuery)context.Envelope.Message;
            ...
            try
            {
                System.Diagnostics.Activity.Current?.SetTag("message.handler", "Wayd.Work.Application.Workspaces.Queries.GetWorkspaceMostRecentChangeDateQueryHandler");
                System.Diagnostics.Activity.Current?.SetTag("handler.type", "Wayd.Work.Application.Workspaces.Queries.GetWorkspaceMostRecentChangeDateQueryHandler");
                var getWorkspaceMostRecentChangeDateQueryHandler = new Wayd.Work.Application.Workspaces.Queries.GetWorkspaceMostRecentChangeDateQueryHandler(waydDbContext, _loggerOfGetWorkspaceMostRecentChangeDateQueryHandler);
                
                // The actual message execution
                var outgoing1 = await getWorkspaceMostRecentChangeDateQueryHandler.Handle(getWorkspaceMostRecentChangeDateQuery, cancellation).ConfigureAwait(false);
    ...
    // END: GetWorkspaceMostRecentChangeDateQueryHandler1915118423
