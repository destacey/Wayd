...
{
    // START: ImportPpmFinalizationsCommandHandler671000093
    [global::System.CodeDom.Compiler.GeneratedCode("JasperFx", "1.0.0")]
    public sealed class ImportPpmFinalizationsCommandHandler671000093 : Wolverine.Runtime.Handlers.MessageHandler
    {
        ...
        private readonly Microsoft.Extensions.Logging.ILogger<Wayd.ProjectPortfolioManagement.Application.Finalization.Commands.ImportPpmFinalizationsCommandHandler> _loggerOfImportPpmFinalizationsCommandHandler;
        ...
        private readonly Wolverine.FluentValidation.IFailureAction<Wayd.ProjectPortfolioManagement.Application.Finalization.Commands.ImportPpmFinalizationsCommand> _failureActionOfImportPpmFinalizationsCommand;
        private readonly Wolverine.Runtime.IWolverineRuntime _wolverineRuntime;

        public ImportPpmFinalizationsCommandHandler671000093(Microsoft.AspNetCore.Http.IHttpContextAccessor __httpContextAccessor1, Microsoft.AspNetCore.Http.IHttpContextAccessor __httpContextAccessor2, Microsoft.EntityFrameworkCore.DbContextOptions dbContextOptions, Microsoft.Extensions.DependencyInjection.IServiceScopeFactory serviceScopeFactory, Microsoft.Extensions.Logging.ILogger<Wayd.Common.Application.Behaviors.PerformanceBehaviorLog> loggerOfPerformanceBehaviorLog, Microsoft.Extensions.Logging.ILogger<Wayd.Infrastructure.Common.Services.EventPublisher> loggerOfEventPublisher, Microsoft.Extensions.Logging.ILogger<Wayd.ProjectPortfolioManagement.Application.Finalization.Commands.ImportPpmFinalizationsCommandHandler> loggerOfImportPpmFinalizationsCommandHandler, Microsoft.Extensions.Options.IOptions<Wayd.Infrastructure.Persistence.DatabaseSettings> optionsOfDatabaseSettings, System.Collections.Generic.IEnumerable<Wolverine.EntityFrameworkCore.IDomainEventScraper> domainEventScraperIEnumerable, System.TimeProvider timeProvider, Wolverine.FluentValidation.IFailureAction<Wayd.ProjectPortfolioManagement.Application.Finalization.Commands.ImportPpmFinalizationsCommand> failureActionOfImportPpmFinalizationsCommand, Wolverine.Runtime.IWolverineRuntime wolverineRuntime)
        {
            ...
            _loggerOfImportPpmFinalizationsCommandHandler = loggerOfImportPpmFinalizationsCommandHandler;
            _optionsOfDatabaseSettings = optionsOfDatabaseSettings;
            _domainEventScraperIEnumerable = domainEventScraperIEnumerable;
            _timeProvider = timeProvider;
            _failureActionOfImportPpmFinalizationsCommand = failureActionOfImportPpmFinalizationsCommand;
        ...
        {
            var importPpmFinalizationsCommandValidator = new Wayd.ProjectPortfolioManagement.Application.Finalization.Commands.ImportPpmFinalizationsCommandValidator();
            ...
            var importPpmFinalizationsCommand = (Wayd.ProjectPortfolioManagement.Application.Finalization.Commands.ImportPpmFinalizationsCommand)context.Envelope.Message;
            ...
            try
            {
                System.Diagnostics.Activity.Current?.SetTag("message.handler", "Wayd.ProjectPortfolioManagement.Application.Finalization.Commands.ImportPpmFinalizationsCommandHandler");
                System.Diagnostics.Activity.Current?.SetTag("handler.type", "Wayd.ProjectPortfolioManagement.Application.Finalization.Commands.ImportPpmFinalizationsCommandHandler");
                await Wolverine.FluentValidation.Internals.FluentValidationExecutor.ExecuteOne<Wayd.ProjectPortfolioManagement.Application.Finalization.Commands.ImportPpmFinalizationsCommand>(importPpmFinalizationsCommandValidator, _failureActionOfImportPpmFinalizationsCommand, importPpmFinalizationsCommand).ConfigureAwait(false);
                var importPpmFinalizationsCommandHandler = new Wayd.ProjectPortfolioManagement.Application.Finalization.Commands.ImportPpmFinalizationsCommandHandler(waydDbContext, _loggerOfImportPpmFinalizationsCommandHandler);
                
                // The actual message execution
                var outgoing1 = await importPpmFinalizationsCommandHandler.Handle(importPpmFinalizationsCommand, cancellation).ConfigureAwait(false);
    ...
    // END: ImportPpmFinalizationsCommandHandler671000093
