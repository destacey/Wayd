...
{
    // START: ImportProjectTasksCommandHandler457292915
    [global::System.CodeDom.Compiler.GeneratedCode("JasperFx", "1.0.0")]
    public sealed class ImportProjectTasksCommandHandler457292915 : Wolverine.Runtime.Handlers.MessageHandler
    {
        ...
        private readonly Microsoft.Extensions.Logging.ILogger<Wayd.ProjectPortfolioManagement.Application.ProjectTasks.Commands.ImportProjectTasksCommandHandler> _loggerOfImportProjectTasksCommandHandler;
        ...
        private readonly Wolverine.FluentValidation.IFailureAction<Wayd.ProjectPortfolioManagement.Application.ProjectTasks.Commands.ImportProjectTasksCommand> _failureActionOfImportProjectTasksCommand;
        private readonly Wolverine.Runtime.IWolverineRuntime _wolverineRuntime;

        public ImportProjectTasksCommandHandler457292915(Microsoft.AspNetCore.Http.IHttpContextAccessor __httpContextAccessor1, Microsoft.AspNetCore.Http.IHttpContextAccessor __httpContextAccessor2, Microsoft.EntityFrameworkCore.DbContextOptions dbContextOptions, Microsoft.Extensions.DependencyInjection.IServiceScopeFactory serviceScopeFactory, Microsoft.Extensions.Logging.ILogger<Wayd.Common.Application.Behaviors.PerformanceBehaviorLog> loggerOfPerformanceBehaviorLog, Microsoft.Extensions.Logging.ILogger<Wayd.Infrastructure.Common.Services.EventPublisher> loggerOfEventPublisher, Microsoft.Extensions.Logging.ILogger<Wayd.ProjectPortfolioManagement.Application.ProjectTasks.Commands.ImportProjectTasksCommandHandler> loggerOfImportProjectTasksCommandHandler, Microsoft.Extensions.Options.IOptions<Wayd.Infrastructure.Persistence.DatabaseSettings> optionsOfDatabaseSettings, System.Collections.Generic.IEnumerable<Wolverine.EntityFrameworkCore.IDomainEventScraper> domainEventScraperIEnumerable, System.TimeProvider timeProvider, Wolverine.FluentValidation.IFailureAction<Wayd.ProjectPortfolioManagement.Application.ProjectTasks.Commands.ImportProjectTasksCommand> failureActionOfImportProjectTasksCommand, Wolverine.Runtime.IWolverineRuntime wolverineRuntime)
        {
            ...
            _loggerOfImportProjectTasksCommandHandler = loggerOfImportProjectTasksCommandHandler;
            _optionsOfDatabaseSettings = optionsOfDatabaseSettings;
            _domainEventScraperIEnumerable = domainEventScraperIEnumerable;
            _timeProvider = timeProvider;
            _failureActionOfImportProjectTasksCommand = failureActionOfImportProjectTasksCommand;
        ...
        {
            var importProjectTasksCommandValidator = new Wayd.ProjectPortfolioManagement.Application.ProjectTasks.Commands.ImportProjectTasksCommandValidator();
            ...
            var importProjectTasksCommand = (Wayd.ProjectPortfolioManagement.Application.ProjectTasks.Commands.ImportProjectTasksCommand)context.Envelope.Message;
            ...
            try
            {
                System.Diagnostics.Activity.Current?.SetTag("message.handler", "Wayd.ProjectPortfolioManagement.Application.ProjectTasks.Commands.ImportProjectTasksCommandHandler");
                System.Diagnostics.Activity.Current?.SetTag("handler.type", "Wayd.ProjectPortfolioManagement.Application.ProjectTasks.Commands.ImportProjectTasksCommandHandler");
                await Wolverine.FluentValidation.Internals.FluentValidationExecutor.ExecuteOne<Wayd.ProjectPortfolioManagement.Application.ProjectTasks.Commands.ImportProjectTasksCommand>(importProjectTasksCommandValidator, _failureActionOfImportProjectTasksCommand, importProjectTasksCommand).ConfigureAwait(false);
                var importProjectTasksCommandHandler = new Wayd.ProjectPortfolioManagement.Application.ProjectTasks.Commands.ImportProjectTasksCommandHandler(waydDbContext, _loggerOfImportProjectTasksCommandHandler);
                
                // The actual message execution
                var outgoing1 = await importProjectTasksCommandHandler.Handle(importProjectTasksCommand, cancellation).ConfigureAwait(false);
    ...
    // END: ImportProjectTasksCommandHandler457292915
