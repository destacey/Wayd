...
{
    // START: ImportProjectsCommandHandler1442297677
    [global::System.CodeDom.Compiler.GeneratedCode("JasperFx", "1.0.0")]
    public sealed class ImportProjectsCommandHandler1442297677 : Wolverine.Runtime.Handlers.MessageHandler
    {
        ...
        private readonly Microsoft.Extensions.Logging.ILogger<Wayd.ProjectPortfolioManagement.Application.Projects.Commands.ImportProjectsCommandHandler> _loggerOfImportProjectsCommandHandler;
        ...
        private readonly Wolverine.FluentValidation.IFailureAction<Wayd.ProjectPortfolioManagement.Application.Projects.Commands.ImportProjectsCommand> _failureActionOfImportProjectsCommand;
        private readonly Wolverine.Runtime.IWolverineRuntime _wolverineRuntime;

        public ImportProjectsCommandHandler1442297677(Microsoft.AspNetCore.Http.IHttpContextAccessor __httpContextAccessor1, Microsoft.AspNetCore.Http.IHttpContextAccessor __httpContextAccessor2, Microsoft.EntityFrameworkCore.DbContextOptions dbContextOptions, Microsoft.Extensions.DependencyInjection.IServiceScopeFactory serviceScopeFactory, Microsoft.Extensions.Logging.ILogger<Wayd.Common.Application.Behaviors.PerformanceBehaviorLog> loggerOfPerformanceBehaviorLog, Microsoft.Extensions.Logging.ILogger<Wayd.Infrastructure.Common.Services.EventPublisher> loggerOfEventPublisher, Microsoft.Extensions.Logging.ILogger<Wayd.ProjectPortfolioManagement.Application.Projects.Commands.ImportProjectsCommandHandler> loggerOfImportProjectsCommandHandler, Microsoft.Extensions.Options.IOptions<Wayd.Infrastructure.Persistence.DatabaseSettings> optionsOfDatabaseSettings, System.Collections.Generic.IEnumerable<Wolverine.EntityFrameworkCore.IDomainEventScraper> domainEventScraperIEnumerable, System.TimeProvider timeProvider, Wolverine.FluentValidation.IFailureAction<Wayd.ProjectPortfolioManagement.Application.Projects.Commands.ImportProjectsCommand> failureActionOfImportProjectsCommand, Wolverine.Runtime.IWolverineRuntime wolverineRuntime)
        {
            ...
            _loggerOfImportProjectsCommandHandler = loggerOfImportProjectsCommandHandler;
            _optionsOfDatabaseSettings = optionsOfDatabaseSettings;
            _domainEventScraperIEnumerable = domainEventScraperIEnumerable;
            _timeProvider = timeProvider;
            _failureActionOfImportProjectsCommand = failureActionOfImportProjectsCommand;
        ...
        public override async System.Threading.Tasks.Task HandleAsync(Wolverine.Runtime.MessageContext context, System.Threading.CancellationToken cancellation)
        {
            ...
            var importProjectsCommandValidator = new Wayd.ProjectPortfolioManagement.Application.Projects.Commands.ImportProjectsCommandValidator();
            ...
            var importProjectsCommand = (Wayd.ProjectPortfolioManagement.Application.Projects.Commands.ImportProjectsCommand)context.Envelope.Message;
            ...
            try
            {
                System.Diagnostics.Activity.Current?.SetTag("message.handler", "Wayd.ProjectPortfolioManagement.Application.Projects.Commands.ImportProjectsCommandHandler");
                System.Diagnostics.Activity.Current?.SetTag("handler.type", "Wayd.ProjectPortfolioManagement.Application.Projects.Commands.ImportProjectsCommandHandler");
                await Wolverine.FluentValidation.Internals.FluentValidationExecutor.ExecuteOne<Wayd.ProjectPortfolioManagement.Application.Projects.Commands.ImportProjectsCommand>(importProjectsCommandValidator, _failureActionOfImportProjectsCommand, importProjectsCommand).ConfigureAwait(false);
                var importProjectsCommandHandler = new Wayd.ProjectPortfolioManagement.Application.Projects.Commands.ImportProjectsCommandHandler(waydDbContext, dateTimeProvider, _loggerOfImportProjectsCommandHandler);
                
                // The actual message execution
                var outgoing1 = await importProjectsCommandHandler.Handle(importProjectsCommand, cancellation).ConfigureAwait(false);
    ...
    // END: ImportProjectsCommandHandler1442297677
