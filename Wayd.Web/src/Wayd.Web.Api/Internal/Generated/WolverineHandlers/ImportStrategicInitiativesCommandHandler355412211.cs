...
{
    // START: ImportStrategicInitiativesCommandHandler355412211
    [global::System.CodeDom.Compiler.GeneratedCode("JasperFx", "1.0.0")]
    public sealed class ImportStrategicInitiativesCommandHandler355412211 : Wolverine.Runtime.Handlers.MessageHandler
    {
        ...
        private readonly Microsoft.Extensions.Logging.ILogger<Wayd.ProjectPortfolioManagement.Application.StrategicInitiatives.Commands.ImportStrategicInitiativesCommandHandler> _loggerOfImportStrategicInitiativesCommandHandler;
        ...
        private readonly Wolverine.FluentValidation.IFailureAction<Wayd.ProjectPortfolioManagement.Application.StrategicInitiatives.Commands.ImportStrategicInitiativesCommand> _failureActionOfImportStrategicInitiativesCommand;
        private readonly Wolverine.Runtime.IWolverineRuntime _wolverineRuntime;

        public ImportStrategicInitiativesCommandHandler355412211(Microsoft.AspNetCore.Http.IHttpContextAccessor __httpContextAccessor1, Microsoft.AspNetCore.Http.IHttpContextAccessor __httpContextAccessor2, Microsoft.EntityFrameworkCore.DbContextOptions dbContextOptions, Microsoft.Extensions.DependencyInjection.IServiceScopeFactory serviceScopeFactory, Microsoft.Extensions.Logging.ILogger<Wayd.Common.Application.Behaviors.PerformanceBehaviorLog> loggerOfPerformanceBehaviorLog, Microsoft.Extensions.Logging.ILogger<Wayd.Infrastructure.Common.Services.EventPublisher> loggerOfEventPublisher, Microsoft.Extensions.Logging.ILogger<Wayd.ProjectPortfolioManagement.Application.StrategicInitiatives.Commands.ImportStrategicInitiativesCommandHandler> loggerOfImportStrategicInitiativesCommandHandler, Microsoft.Extensions.Options.IOptions<Wayd.Infrastructure.Persistence.DatabaseSettings> optionsOfDatabaseSettings, System.Collections.Generic.IEnumerable<Wolverine.EntityFrameworkCore.IDomainEventScraper> domainEventScraperIEnumerable, System.TimeProvider timeProvider, Wolverine.FluentValidation.IFailureAction<Wayd.ProjectPortfolioManagement.Application.StrategicInitiatives.Commands.ImportStrategicInitiativesCommand> failureActionOfImportStrategicInitiativesCommand, Wolverine.Runtime.IWolverineRuntime wolverineRuntime)
        {
            ...
            _loggerOfImportStrategicInitiativesCommandHandler = loggerOfImportStrategicInitiativesCommandHandler;
            _optionsOfDatabaseSettings = optionsOfDatabaseSettings;
            _domainEventScraperIEnumerable = domainEventScraperIEnumerable;
            _timeProvider = timeProvider;
            _failureActionOfImportStrategicInitiativesCommand = failureActionOfImportStrategicInitiativesCommand;
        ...
        {
            var importStrategicInitiativesCommandValidator = new Wayd.ProjectPortfolioManagement.Application.StrategicInitiatives.Commands.ImportStrategicInitiativesCommandValidator();
            ...
            var importStrategicInitiativesCommand = (Wayd.ProjectPortfolioManagement.Application.StrategicInitiatives.Commands.ImportStrategicInitiativesCommand)context.Envelope.Message;
            ...
            try
            {
                System.Diagnostics.Activity.Current?.SetTag("message.handler", "Wayd.ProjectPortfolioManagement.Application.StrategicInitiatives.Commands.ImportStrategicInitiativesCommandHandler");
                System.Diagnostics.Activity.Current?.SetTag("handler.type", "Wayd.ProjectPortfolioManagement.Application.StrategicInitiatives.Commands.ImportStrategicInitiativesCommandHandler");
                await Wolverine.FluentValidation.Internals.FluentValidationExecutor.ExecuteOne<Wayd.ProjectPortfolioManagement.Application.StrategicInitiatives.Commands.ImportStrategicInitiativesCommand>(importStrategicInitiativesCommandValidator, _failureActionOfImportStrategicInitiativesCommand, importStrategicInitiativesCommand).ConfigureAwait(false);
                var importStrategicInitiativesCommandHandler = new Wayd.ProjectPortfolioManagement.Application.StrategicInitiatives.Commands.ImportStrategicInitiativesCommandHandler(waydDbContext, _loggerOfImportStrategicInitiativesCommandHandler);
                
                // The actual message execution
                var outgoing1 = await importStrategicInitiativesCommandHandler.Handle(importStrategicInitiativesCommand, cancellation).ConfigureAwait(false);
    ...
    // END: ImportStrategicInitiativesCommandHandler355412211
