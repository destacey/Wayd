...
namespace Internal.Generated.WolverineHandlers
{
    ...
    public sealed class ImportTeamsCommandHandler1817596408 : Wolverine.Runtime.Handlers.MessageHandler
    {
        ...
        public ImportTeamsCommandHandler1817596408(Microsoft.AspNetCore.Http.IHttpContextAccessor __httpContextAccessor1, Microsoft.AspNetCore.Http.IHttpContextAccessor __httpContextAccessor2, Microsoft.EntityFrameworkCore.DbContextOptions dbContextOptions, Microsoft.Extensions.DependencyInjection.IServiceScopeFactory serviceScopeFactory, Microsoft.Extensions.Logging.ILogger<Wayd.Common.Application.Behaviors.PerformanceBehaviorLog> loggerOfPerformanceBehaviorLog, Microsoft.Extensions.Logging.ILogger<Wayd.Infrastructure.Common.Services.EventPublisher> loggerOfEventPublisher, Microsoft.Extensions.Logging.ILogger<Wayd.Organization.Application.Teams.Commands.ImportTeamsCommandHandler> loggerOfImportTeamsCommandHandler, Microsoft.Extensions.Options.IOptions<Wayd.Infrastructure.Persistence.DatabaseSettings> optionsOfDatabaseSettings, System.Collections.Generic.IEnumerable<Wolverine.EntityFrameworkCore.IDomainEventScraper> domainEventScraperIEnumerable, System.TimeProvider timeProvider, Wolverine.FluentValidation.IFailureAction<Wayd.Organization.Application.Teams.Commands.ImportTeamsCommand> failureActionOfImportTeamsCommand, Wolverine.Runtime.IWolverineRuntime wolverineRuntime)
        {
        ...
        public override async System.Threading.Tasks.Task HandleAsync(Wolverine.Runtime.MessageContext context, System.Threading.CancellationToken cancellation)
        {
            ...
            try
            {
                ...
                await Wolverine.FluentValidation.Internals.FluentValidationExecutor.ExecuteOne<Wayd.Organization.Application.Teams.Commands.ImportTeamsCommand>(importTeamsCommandValidator, _failureActionOfImportTeamsCommand, importTeamsCommand).ConfigureAwait(false);
                var importTeamsCommandHandler = new Wayd.Organization.Application.Teams.Commands.ImportTeamsCommandHandler(waydDbContext, dateTimeProvider, _loggerOfImportTeamsCommandHandler);
