...
{
    // START: LinkWorkItemCommandHandler1246298767
    [global::System.CodeDom.Compiler.GeneratedCode("JasperFx", "1.0.0")]
    public sealed class LinkWorkItemCommandHandler1246298767 : Wolverine.Runtime.Handlers.MessageHandler
    {
        ...
        private readonly Microsoft.Extensions.Logging.ILogger<Wayd.Planning.Application.StoryMaps.Commands.LinkWorkItemCommandHandler> _loggerOfLinkWorkItemCommandHandler;
        ...
        private readonly Wolverine.FluentValidation.IFailureAction<Wayd.Planning.Application.StoryMaps.Commands.LinkWorkItemCommand> _failureActionOfLinkWorkItemCommand;
        private readonly Wolverine.Runtime.IWolverineRuntime _wolverineRuntime;

        public LinkWorkItemCommandHandler1246298767(Microsoft.AspNetCore.Http.IHttpContextAccessor __httpContextAccessor1, Microsoft.AspNetCore.Http.IHttpContextAccessor __httpContextAccessor2, Microsoft.EntityFrameworkCore.DbContextOptions dbContextOptions, Microsoft.Extensions.DependencyInjection.IServiceScopeFactory serviceScopeFactory, Microsoft.Extensions.Logging.ILogger<Wayd.Common.Application.Behaviors.PerformanceBehaviorLog> loggerOfPerformanceBehaviorLog, Microsoft.Extensions.Logging.ILogger<Wayd.Infrastructure.Common.Services.EventPublisher> loggerOfEventPublisher, Microsoft.Extensions.Logging.ILogger<Wayd.Planning.Application.StoryMaps.Commands.LinkWorkItemCommandHandler> loggerOfLinkWorkItemCommandHandler, Microsoft.Extensions.Options.IOptions<Wayd.Infrastructure.Persistence.DatabaseSettings> optionsOfDatabaseSettings, System.Collections.Generic.IEnumerable<Wolverine.EntityFrameworkCore.IDomainEventScraper> domainEventScraperIEnumerable, System.TimeProvider timeProvider, Wolverine.FluentValidation.IFailureAction<Wayd.Planning.Application.StoryMaps.Commands.LinkWorkItemCommand> failureActionOfLinkWorkItemCommand, Wolverine.Runtime.IWolverineRuntime wolverineRuntime)
        {
            ...
            _loggerOfLinkWorkItemCommandHandler = loggerOfLinkWorkItemCommandHandler;
            _optionsOfDatabaseSettings = optionsOfDatabaseSettings;
            _domainEventScraperIEnumerable = domainEventScraperIEnumerable;
            _timeProvider = timeProvider;
            _failureActionOfLinkWorkItemCommand = failureActionOfLinkWorkItemCommand;
        ...
        {
            var linkWorkItemCommandValidator = new Wayd.Planning.Application.StoryMaps.Commands.LinkWorkItemCommandValidator();
            ...
            var linkWorkItemCommand = (Wayd.Planning.Application.StoryMaps.Commands.LinkWorkItemCommand)context.Envelope.Message;
            ...
            try
            {
                System.Diagnostics.Activity.Current?.SetTag("message.handler", "Wayd.Planning.Application.StoryMaps.Commands.LinkWorkItemCommandHandler");
                System.Diagnostics.Activity.Current?.SetTag("handler.type", "Wayd.Planning.Application.StoryMaps.Commands.LinkWorkItemCommandHandler");
                await Wolverine.FluentValidation.Internals.FluentValidationExecutor.ExecuteOne<Wayd.Planning.Application.StoryMaps.Commands.LinkWorkItemCommand>(linkWorkItemCommandValidator, _failureActionOfLinkWorkItemCommand, linkWorkItemCommand).ConfigureAwait(false);
                var linkWorkItemCommandHandler = new Wayd.Planning.Application.StoryMaps.Commands.LinkWorkItemCommandHandler(waydDbContext, storyMapNotifier, _loggerOfLinkWorkItemCommandHandler);
                
                // The actual message execution
                var outgoing1 = await linkWorkItemCommandHandler.Handle(linkWorkItemCommand, cancellation).ConfigureAwait(false);
    ...
    // END: LinkWorkItemCommandHandler1246298767
