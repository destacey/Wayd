...
namespace Internal.Generated.WolverineHandlers
{
    ...
    public sealed class MapPlanningIntervalSprintsCommandHandler205291883 : Wolverine.Runtime.Handlers.MessageHandler
    {
        ...
        public MapPlanningIntervalSprintsCommandHandler205291883(Microsoft.AspNetCore.Http.IHttpContextAccessor __httpContextAccessor1, Microsoft.AspNetCore.Http.IHttpContextAccessor __httpContextAccessor2, Microsoft.EntityFrameworkCore.DbContextOptions dbContextOptions, Microsoft.Extensions.DependencyInjection.IServiceScopeFactory serviceScopeFactory, Microsoft.Extensions.Logging.ILogger<Wayd.Common.Application.Behaviors.PerformanceBehaviorLog> loggerOfPerformanceBehaviorLog, Microsoft.Extensions.Logging.ILogger<Wayd.Infrastructure.Common.Services.EventPublisher> loggerOfEventPublisher, Microsoft.Extensions.Logging.ILogger<Wayd.Planning.Application.PlanningIntervals.Commands.MapPlanningIntervalSprintsCommandHandler> loggerOfMapPlanningIntervalSprintsCommandHandler, Microsoft.Extensions.Options.IOptions<Wayd.Infrastructure.Persistence.DatabaseSettings> optionsOfDatabaseSettings, System.Collections.Generic.IEnumerable<Wolverine.EntityFrameworkCore.IDomainEventScraper> domainEventScraperIEnumerable, System.TimeProvider timeProvider, Wolverine.FluentValidation.IFailureAction<Wayd.Planning.Application.PlanningIntervals.Commands.MapPlanningIntervalSprintsCommand> failureActionOfMapPlanningIntervalSprintsCommand, Wolverine.Runtime.IWolverineRuntime wolverineRuntime)
        {
        ...
        public override async System.Threading.Tasks.Task HandleAsync(Wolverine.Runtime.MessageContext context, System.Threading.CancellationToken cancellation)
        {
            ...
            var mapPlanningIntervalSprintsCommandValidator = new Wayd.Planning.Application.PlanningIntervals.Commands.MapPlanningIntervalSprintsCommandValidator(waydDbContext);
            ...
            try
            {
                ...
                await Wolverine.FluentValidation.Internals.FluentValidationExecutor.ExecuteOne<Wayd.Planning.Application.PlanningIntervals.Commands.MapPlanningIntervalSprintsCommand>(mapPlanningIntervalSprintsCommandValidator, _failureActionOfMapPlanningIntervalSprintsCommand, mapPlanningIntervalSprintsCommand).ConfigureAwait(false);
                var mapPlanningIntervalSprintsCommandHandler = new Wayd.Planning.Application.PlanningIntervals.Commands.MapPlanningIntervalSprintsCommandHandler(waydDbContext, _loggerOfMapPlanningIntervalSprintsCommandHandler);
