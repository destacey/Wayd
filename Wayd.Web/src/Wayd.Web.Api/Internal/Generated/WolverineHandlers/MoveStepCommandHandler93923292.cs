...
{
    // START: MoveStepCommandHandler93923292
    [global::System.CodeDom.Compiler.GeneratedCode("JasperFx", "1.0.0")]
    public sealed class MoveStepCommandHandler93923292 : Wolverine.Runtime.Handlers.MessageHandler
    {
        ...
        private readonly Microsoft.Extensions.Logging.ILogger<Wayd.Planning.Application.StoryMaps.Commands.MoveStepCommandHandler> _loggerOfMoveStepCommandHandler;
        ...
        private readonly Wolverine.FluentValidation.IFailureAction<Wayd.Planning.Application.StoryMaps.Commands.MoveStepCommand> _failureActionOfMoveStepCommand;
        private readonly Wolverine.Runtime.IWolverineRuntime _wolverineRuntime;

        public MoveStepCommandHandler93923292(Microsoft.AspNetCore.Http.IHttpContextAccessor __httpContextAccessor1, Microsoft.AspNetCore.Http.IHttpContextAccessor __httpContextAccessor2, Microsoft.EntityFrameworkCore.DbContextOptions dbContextOptions, Microsoft.Extensions.DependencyInjection.IServiceScopeFactory serviceScopeFactory, Microsoft.Extensions.Logging.ILogger<Wayd.Common.Application.Behaviors.PerformanceBehaviorLog> loggerOfPerformanceBehaviorLog, Microsoft.Extensions.Logging.ILogger<Wayd.Infrastructure.Common.Services.EventPublisher> loggerOfEventPublisher, Microsoft.Extensions.Logging.ILogger<Wayd.Planning.Application.StoryMaps.Commands.MoveStepCommandHandler> loggerOfMoveStepCommandHandler, Microsoft.Extensions.Options.IOptions<Wayd.Infrastructure.Persistence.DatabaseSettings> optionsOfDatabaseSettings, System.Collections.Generic.IEnumerable<Wolverine.EntityFrameworkCore.IDomainEventScraper> domainEventScraperIEnumerable, System.TimeProvider timeProvider, Wolverine.FluentValidation.IFailureAction<Wayd.Planning.Application.StoryMaps.Commands.MoveStepCommand> failureActionOfMoveStepCommand, Wolverine.Runtime.IWolverineRuntime wolverineRuntime)
        {
            ...
            _loggerOfMoveStepCommandHandler = loggerOfMoveStepCommandHandler;
            _optionsOfDatabaseSettings = optionsOfDatabaseSettings;
            _domainEventScraperIEnumerable = domainEventScraperIEnumerable;
            _timeProvider = timeProvider;
            _failureActionOfMoveStepCommand = failureActionOfMoveStepCommand;
        ...
        {
            var moveStepCommandValidator = new Wayd.Planning.Application.StoryMaps.Commands.MoveStepCommandValidator();
            ...
            var moveStepCommand = (Wayd.Planning.Application.StoryMaps.Commands.MoveStepCommand)context.Envelope.Message;
            ...
            try
            {
                System.Diagnostics.Activity.Current?.SetTag("message.handler", "Wayd.Planning.Application.StoryMaps.Commands.MoveStepCommandHandler");
                System.Diagnostics.Activity.Current?.SetTag("handler.type", "Wayd.Planning.Application.StoryMaps.Commands.MoveStepCommandHandler");
                await Wolverine.FluentValidation.Internals.FluentValidationExecutor.ExecuteOne<Wayd.Planning.Application.StoryMaps.Commands.MoveStepCommand>(moveStepCommandValidator, _failureActionOfMoveStepCommand, moveStepCommand).ConfigureAwait(false);
                var moveStepCommandHandler = new Wayd.Planning.Application.StoryMaps.Commands.MoveStepCommandHandler(waydDbContext, storyMapNotifier, _loggerOfMoveStepCommandHandler);
                
                // The actual message execution
                var outgoing1 = await moveStepCommandHandler.Handle(moveStepCommand, cancellation).ConfigureAwait(false);
    ...
    // END: MoveStepCommandHandler93923292
