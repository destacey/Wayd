...
{
    // START: MoveTaskCommandHandler899721073
    [global::System.CodeDom.Compiler.GeneratedCode("JasperFx", "1.0.0")]
    public sealed class MoveTaskCommandHandler899721073 : Wolverine.Runtime.Handlers.MessageHandler
    {
        ...
        private readonly Microsoft.Extensions.Logging.ILogger<Wayd.Planning.Application.StoryMaps.Commands.MoveTaskCommandHandler> _loggerOfMoveTaskCommandHandler;
        ...
        private readonly Wolverine.FluentValidation.IFailureAction<Wayd.Planning.Application.StoryMaps.Commands.MoveTaskCommand> _failureActionOfMoveTaskCommand;
        private readonly Wolverine.Runtime.IWolverineRuntime _wolverineRuntime;

        public MoveTaskCommandHandler899721073(Microsoft.AspNetCore.Http.IHttpContextAccessor __httpContextAccessor1, Microsoft.AspNetCore.Http.IHttpContextAccessor __httpContextAccessor2, Microsoft.EntityFrameworkCore.DbContextOptions dbContextOptions, Microsoft.Extensions.DependencyInjection.IServiceScopeFactory serviceScopeFactory, Microsoft.Extensions.Logging.ILogger<Wayd.Common.Application.Behaviors.PerformanceBehaviorLog> loggerOfPerformanceBehaviorLog, Microsoft.Extensions.Logging.ILogger<Wayd.Infrastructure.Common.Services.EventPublisher> loggerOfEventPublisher, Microsoft.Extensions.Logging.ILogger<Wayd.Planning.Application.StoryMaps.Commands.MoveTaskCommandHandler> loggerOfMoveTaskCommandHandler, Microsoft.Extensions.Options.IOptions<Wayd.Infrastructure.Persistence.DatabaseSettings> optionsOfDatabaseSettings, System.Collections.Generic.IEnumerable<Wolverine.EntityFrameworkCore.IDomainEventScraper> domainEventScraperIEnumerable, System.TimeProvider timeProvider, Wolverine.FluentValidation.IFailureAction<Wayd.Planning.Application.StoryMaps.Commands.MoveTaskCommand> failureActionOfMoveTaskCommand, Wolverine.Runtime.IWolverineRuntime wolverineRuntime)
        {
            ...
            _loggerOfMoveTaskCommandHandler = loggerOfMoveTaskCommandHandler;
            _optionsOfDatabaseSettings = optionsOfDatabaseSettings;
            _domainEventScraperIEnumerable = domainEventScraperIEnumerable;
            _timeProvider = timeProvider;
            _failureActionOfMoveTaskCommand = failureActionOfMoveTaskCommand;
        ...
        public override async System.Threading.Tasks.Task HandleAsync(Wolverine.Runtime.MessageContext context, System.Threading.CancellationToken cancellation)
        {
            ...
            var moveTaskCommandValidator = new Wayd.Planning.Application.StoryMaps.Commands.MoveTaskCommandValidator();
            // The actual message body
            var moveTaskCommand = (Wayd.Planning.Application.StoryMaps.Commands.MoveTaskCommand)context.Envelope.Message;
            ...
            try
            {
                System.Diagnostics.Activity.Current?.SetTag("message.handler", "Wayd.Planning.Application.StoryMaps.Commands.MoveTaskCommandHandler");
                System.Diagnostics.Activity.Current?.SetTag("handler.type", "Wayd.Planning.Application.StoryMaps.Commands.MoveTaskCommandHandler");
                await Wolverine.FluentValidation.Internals.FluentValidationExecutor.ExecuteOne<Wayd.Planning.Application.StoryMaps.Commands.MoveTaskCommand>(moveTaskCommandValidator, _failureActionOfMoveTaskCommand, moveTaskCommand).ConfigureAwait(false);
                var moveTaskCommandHandler = new Wayd.Planning.Application.StoryMaps.Commands.MoveTaskCommandHandler(waydDbContext, storyMapNotifier, _loggerOfMoveTaskCommandHandler);
                
                // The actual message execution
                var outgoing1 = await moveTaskCommandHandler.Handle(moveTaskCommand, cancellation).ConfigureAwait(false);
    ...
    // END: MoveTaskCommandHandler899721073
