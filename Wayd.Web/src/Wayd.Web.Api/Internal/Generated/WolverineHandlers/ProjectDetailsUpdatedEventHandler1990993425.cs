...
{
    // START: ProjectDetailsUpdatedEventHandler1990993425
    [global::System.CodeDom.Compiler.GeneratedCode("JasperFx", "1.0.0")]
    public sealed class ProjectDetailsUpdatedEventHandler1990993425 : Wolverine.Runtime.Handlers.MessageHandler
    {
        ...
        public ProjectDetailsUpdatedEventHandler1990993425(Microsoft.AspNetCore.Http.IHttpContextAccessor __httpContextAccessor1, Microsoft.AspNetCore.Http.IHttpContextAccessor __httpContextAccessor2, Microsoft.EntityFrameworkCore.DbContextOptions dbContextOptions, Microsoft.Extensions.DependencyInjection.IServiceScopeFactory serviceScopeFactory, Microsoft.Extensions.Logging.ILogger<Wayd.Common.Application.Behaviors.PerformanceBehaviorLog> loggerOfPerformanceBehaviorLog, Microsoft.Extensions.Logging.ILogger<Wayd.Infrastructure.Common.Services.EventPublisher> loggerOfEventPublisher, Microsoft.Extensions.Logging.ILogger<Wayd.Work.Application.WorkProjects.EventHandlers.ProjectSyncHandler> loggerOfProjectSyncHandler, Microsoft.Extensions.Options.IOptions<Wayd.Infrastructure.Persistence.DatabaseSettings> optionsOfDatabaseSettings, System.Collections.Generic.IEnumerable<Wolverine.EntityFrameworkCore.IDomainEventScraper> domainEventScraperIEnumerable, System.TimeProvider timeProvider, Wolverine.Runtime.IWolverineRuntime wolverineRuntime)
        {
        ...
        public override async System.Threading.Tasks.Task HandleAsync(Wolverine.Runtime.MessageContext context, System.Threading.CancellationToken cancellation)
        {
            ...
            var projectDetailsUpdatedEvent = (Wayd.Common.Domain.Events.ProjectPortfolioManagement.ProjectDetailsUpdatedEvent)context.Envelope.Message;
            ...
            try
            {
                ...
                var projectSyncHandler = new Wayd.Work.Application.WorkProjects.EventHandlers.ProjectSyncHandler(waydDbContext, _loggerOfProjectSyncHandler);
                
                // The actual message execution
                await projectSyncHandler.Handle(projectDetailsUpdatedEvent, cancellation).ConfigureAwait(false);
    ...
    // END: ProjectDetailsUpdatedEventHandler1990993425
