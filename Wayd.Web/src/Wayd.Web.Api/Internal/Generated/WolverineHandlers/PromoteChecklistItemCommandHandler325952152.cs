...
{
    // START: PromoteChecklistItemCommandHandler325952152
    [global::System.CodeDom.Compiler.GeneratedCode("JasperFx", "1.0.0")]
    public sealed class PromoteChecklistItemCommandHandler325952152 : Wolverine.Runtime.Handlers.MessageHandler
    {
        ...
        private readonly Microsoft.Extensions.Logging.ILogger<Wayd.Planning.Application.StoryMaps.Commands.PromoteChecklistItemCommandHandler> _loggerOfPromoteChecklistItemCommandHandler;
        ...
        private readonly Wolverine.FluentValidation.IFailureAction<Wayd.Planning.Application.StoryMaps.Commands.PromoteChecklistItemCommand> _failureActionOfPromoteChecklistItemCommand;
        private readonly Wolverine.Runtime.IWolverineRuntime _wolverineRuntime;

        public PromoteChecklistItemCommandHandler325952152(Microsoft.AspNetCore.Http.IHttpContextAccessor __httpContextAccessor1, Microsoft.AspNetCore.Http.IHttpContextAccessor __httpContextAccessor2, Microsoft.EntityFrameworkCore.DbContextOptions dbContextOptions, Microsoft.Extensions.DependencyInjection.IServiceScopeFactory serviceScopeFactory, Microsoft.Extensions.Logging.ILogger<Wayd.Common.Application.Behaviors.PerformanceBehaviorLog> loggerOfPerformanceBehaviorLog, Microsoft.Extensions.Logging.ILogger<Wayd.Infrastructure.Common.Services.EventPublisher> loggerOfEventPublisher, Microsoft.Extensions.Logging.ILogger<Wayd.Planning.Application.StoryMaps.Commands.PromoteChecklistItemCommandHandler> loggerOfPromoteChecklistItemCommandHandler, Microsoft.Extensions.Options.IOptions<Wayd.Infrastructure.Persistence.DatabaseSettings> optionsOfDatabaseSettings, System.Collections.Generic.IEnumerable<Wolverine.EntityFrameworkCore.IDomainEventScraper> domainEventScraperIEnumerable, System.TimeProvider timeProvider, Wolverine.FluentValidation.IFailureAction<Wayd.Planning.Application.StoryMaps.Commands.PromoteChecklistItemCommand> failureActionOfPromoteChecklistItemCommand, Wolverine.Runtime.IWolverineRuntime wolverineRuntime)
        {
            ...
            _loggerOfPromoteChecklistItemCommandHandler = loggerOfPromoteChecklistItemCommandHandler;
            _optionsOfDatabaseSettings = optionsOfDatabaseSettings;
            _domainEventScraperIEnumerable = domainEventScraperIEnumerable;
            _timeProvider = timeProvider;
            _failureActionOfPromoteChecklistItemCommand = failureActionOfPromoteChecklistItemCommand;
        ...
        public override async System.Threading.Tasks.Task HandleAsync(Wolverine.Runtime.MessageContext context, System.Threading.CancellationToken cancellation)
        {
            ...
            var promoteChecklistItemCommandValidator = new Wayd.Planning.Application.StoryMaps.Commands.PromoteChecklistItemCommandValidator();
            // The actual message body
            var promoteChecklistItemCommand = (Wayd.Planning.Application.StoryMaps.Commands.PromoteChecklistItemCommand)context.Envelope.Message;
            ...
            try
            {
                System.Diagnostics.Activity.Current?.SetTag("message.handler", "Wayd.Planning.Application.StoryMaps.Commands.PromoteChecklistItemCommandHandler");
                System.Diagnostics.Activity.Current?.SetTag("handler.type", "Wayd.Planning.Application.StoryMaps.Commands.PromoteChecklistItemCommandHandler");
                await Wolverine.FluentValidation.Internals.FluentValidationExecutor.ExecuteOne<Wayd.Planning.Application.StoryMaps.Commands.PromoteChecklistItemCommand>(promoteChecklistItemCommandValidator, _failureActionOfPromoteChecklistItemCommand, promoteChecklistItemCommand).ConfigureAwait(false);
                var promoteChecklistItemCommandHandler = new Wayd.Planning.Application.StoryMaps.Commands.PromoteChecklistItemCommandHandler(waydDbContext, storyMapNotifier, _loggerOfPromoteChecklistItemCommandHandler);
                
                // The actual message execution
                var outgoing1 = await promoteChecklistItemCommandHandler.Handle(promoteChecklistItemCommand, cancellation).ConfigureAwait(false);
    ...
    // END: PromoteChecklistItemCommandHandler325952152
