...
{
    // START: RemoveChecklistItemCommandHandler1594100648
    [global::System.CodeDom.Compiler.GeneratedCode("JasperFx", "1.0.0")]
    public sealed class RemoveChecklistItemCommandHandler1594100648 : Wolverine.Runtime.Handlers.MessageHandler
    {
        ...
        private readonly Microsoft.Extensions.Logging.ILogger<Wayd.Planning.Application.StoryMaps.Commands.RemoveChecklistItemCommandHandler> _loggerOfRemoveChecklistItemCommandHandler;
        ...
        private readonly Wolverine.FluentValidation.IFailureAction<Wayd.Planning.Application.StoryMaps.Commands.RemoveChecklistItemCommand> _failureActionOfRemoveChecklistItemCommand;
        private readonly Wolverine.Runtime.IWolverineRuntime _wolverineRuntime;

        public RemoveChecklistItemCommandHandler1594100648(Microsoft.AspNetCore.Http.IHttpContextAccessor __httpContextAccessor1, Microsoft.AspNetCore.Http.IHttpContextAccessor __httpContextAccessor2, Microsoft.EntityFrameworkCore.DbContextOptions dbContextOptions, Microsoft.Extensions.DependencyInjection.IServiceScopeFactory serviceScopeFactory, Microsoft.Extensions.Logging.ILogger<Wayd.Common.Application.Behaviors.PerformanceBehaviorLog> loggerOfPerformanceBehaviorLog, Microsoft.Extensions.Logging.ILogger<Wayd.Infrastructure.Common.Services.EventPublisher> loggerOfEventPublisher, Microsoft.Extensions.Logging.ILogger<Wayd.Planning.Application.StoryMaps.Commands.RemoveChecklistItemCommandHandler> loggerOfRemoveChecklistItemCommandHandler, Microsoft.Extensions.Options.IOptions<Wayd.Infrastructure.Persistence.DatabaseSettings> optionsOfDatabaseSettings, System.Collections.Generic.IEnumerable<Wolverine.EntityFrameworkCore.IDomainEventScraper> domainEventScraperIEnumerable, System.TimeProvider timeProvider, Wolverine.FluentValidation.IFailureAction<Wayd.Planning.Application.StoryMaps.Commands.RemoveChecklistItemCommand> failureActionOfRemoveChecklistItemCommand, Wolverine.Runtime.IWolverineRuntime wolverineRuntime)
        {
            ...
            _loggerOfRemoveChecklistItemCommandHandler = loggerOfRemoveChecklistItemCommandHandler;
            _optionsOfDatabaseSettings = optionsOfDatabaseSettings;
            _domainEventScraperIEnumerable = domainEventScraperIEnumerable;
            _timeProvider = timeProvider;
            _failureActionOfRemoveChecklistItemCommand = failureActionOfRemoveChecklistItemCommand;
        ...
        public override async System.Threading.Tasks.Task HandleAsync(Wolverine.Runtime.MessageContext context, System.Threading.CancellationToken cancellation)
        {
            ...
            var removeChecklistItemCommandValidator = new Wayd.Planning.Application.StoryMaps.Commands.RemoveChecklistItemCommandValidator();
            // The actual message body
            var removeChecklistItemCommand = (Wayd.Planning.Application.StoryMaps.Commands.RemoveChecklistItemCommand)context.Envelope.Message;
            ...
            try
            {
                System.Diagnostics.Activity.Current?.SetTag("message.handler", "Wayd.Planning.Application.StoryMaps.Commands.RemoveChecklistItemCommandHandler");
                System.Diagnostics.Activity.Current?.SetTag("handler.type", "Wayd.Planning.Application.StoryMaps.Commands.RemoveChecklistItemCommandHandler");
                await Wolverine.FluentValidation.Internals.FluentValidationExecutor.ExecuteOne<Wayd.Planning.Application.StoryMaps.Commands.RemoveChecklistItemCommand>(removeChecklistItemCommandValidator, _failureActionOfRemoveChecklistItemCommand, removeChecklistItemCommand).ConfigureAwait(false);
                var removeChecklistItemCommandHandler = new Wayd.Planning.Application.StoryMaps.Commands.RemoveChecklistItemCommandHandler(waydDbContext, storyMapNotifier, _loggerOfRemoveChecklistItemCommandHandler);
                
                // The actual message execution
                var outgoing1 = await removeChecklistItemCommandHandler.Handle(removeChecklistItemCommand, cancellation).ConfigureAwait(false);
    ...
    // END: RemoveChecklistItemCommandHandler1594100648
