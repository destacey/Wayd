...
namespace Internal.Generated.WolverineHandlers
{
    ...
    public sealed class RemovePokerRoundCommandHandler1501955926 : Wolverine.Runtime.Handlers.MessageHandler
    {
        ...
        public RemovePokerRoundCommandHandler1501955926(Microsoft.AspNetCore.Http.IHttpContextAccessor __httpContextAccessor1, Microsoft.AspNetCore.Http.IHttpContextAccessor __httpContextAccessor2, Microsoft.EntityFrameworkCore.DbContextOptions dbContextOptions, Microsoft.Extensions.DependencyInjection.IServiceScopeFactory serviceScopeFactory, Microsoft.Extensions.Logging.ILogger<Wayd.Common.Application.Behaviors.PerformanceBehaviorLog> loggerOfPerformanceBehaviorLog, Microsoft.Extensions.Logging.ILogger<Wayd.Infrastructure.Common.Services.EventPublisher> loggerOfEventPublisher, Microsoft.Extensions.Logging.ILogger<Wayd.Planning.Application.PokerSessions.Commands.RemovePokerRoundCommandHandler> loggerOfRemovePokerRoundCommandHandler, Microsoft.Extensions.Options.IOptions<Wayd.Infrastructure.Persistence.DatabaseSettings> optionsOfDatabaseSettings, System.Collections.Generic.IEnumerable<Wolverine.EntityFrameworkCore.IDomainEventScraper> domainEventScraperIEnumerable, System.TimeProvider timeProvider, Wolverine.FluentValidation.IFailureAction<Wayd.Planning.Application.PokerSessions.Commands.RemovePokerRoundCommand> failureActionOfRemovePokerRoundCommand, Wolverine.Runtime.IWolverineRuntime wolverineRuntime)
        {
        ...
        public override async System.Threading.Tasks.Task HandleAsync(Wolverine.Runtime.MessageContext context, System.Threading.CancellationToken cancellation)
        {
            ...
            try
            {
                ...
                await Wolverine.FluentValidation.Internals.FluentValidationExecutor.ExecuteOne<Wayd.Planning.Application.PokerSessions.Commands.RemovePokerRoundCommand>(removePokerRoundCommandValidator, _failureActionOfRemovePokerRoundCommand, removePokerRoundCommand).ConfigureAwait(false);
                var removePokerRoundCommandHandler = new Wayd.Planning.Application.PokerSessions.Commands.RemovePokerRoundCommandHandler(waydDbContext, pokerSessionNotifier, _loggerOfRemovePokerRoundCommandHandler);
