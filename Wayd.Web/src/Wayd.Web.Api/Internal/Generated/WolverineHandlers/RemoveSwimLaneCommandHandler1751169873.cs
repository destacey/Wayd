...
{
    // START: RemoveSwimLaneCommandHandler1751169873
    [global::System.CodeDom.Compiler.GeneratedCode("JasperFx", "1.0.0")]
    public sealed class RemoveSwimLaneCommandHandler1751169873 : Wolverine.Runtime.Handlers.MessageHandler
    {
        ...
        private readonly Microsoft.Extensions.Logging.ILogger<Wayd.Planning.Application.StoryMaps.Commands.RemoveSwimLaneCommandHandler> _loggerOfRemoveSwimLaneCommandHandler;
        ...
        private readonly Wolverine.FluentValidation.IFailureAction<Wayd.Planning.Application.StoryMaps.Commands.RemoveSwimLaneCommand> _failureActionOfRemoveSwimLaneCommand;
        private readonly Wolverine.Runtime.IWolverineRuntime _wolverineRuntime;

        public RemoveSwimLaneCommandHandler1751169873(Microsoft.AspNetCore.Http.IHttpContextAccessor __httpContextAccessor1, Microsoft.AspNetCore.Http.IHttpContextAccessor __httpContextAccessor2, Microsoft.EntityFrameworkCore.DbContextOptions dbContextOptions, Microsoft.Extensions.DependencyInjection.IServiceScopeFactory serviceScopeFactory, Microsoft.Extensions.Logging.ILogger<Wayd.Common.Application.Behaviors.PerformanceBehaviorLog> loggerOfPerformanceBehaviorLog, Microsoft.Extensions.Logging.ILogger<Wayd.Infrastructure.Common.Services.EventPublisher> loggerOfEventPublisher, Microsoft.Extensions.Logging.ILogger<Wayd.Planning.Application.StoryMaps.Commands.RemoveSwimLaneCommandHandler> loggerOfRemoveSwimLaneCommandHandler, Microsoft.Extensions.Options.IOptions<Wayd.Infrastructure.Persistence.DatabaseSettings> optionsOfDatabaseSettings, System.Collections.Generic.IEnumerable<Wolverine.EntityFrameworkCore.IDomainEventScraper> domainEventScraperIEnumerable, System.TimeProvider timeProvider, Wolverine.FluentValidation.IFailureAction<Wayd.Planning.Application.StoryMaps.Commands.RemoveSwimLaneCommand> failureActionOfRemoveSwimLaneCommand, Wolverine.Runtime.IWolverineRuntime wolverineRuntime)
        {
            ...
            _loggerOfRemoveSwimLaneCommandHandler = loggerOfRemoveSwimLaneCommandHandler;
            _optionsOfDatabaseSettings = optionsOfDatabaseSettings;
            _domainEventScraperIEnumerable = domainEventScraperIEnumerable;
            _timeProvider = timeProvider;
            _failureActionOfRemoveSwimLaneCommand = failureActionOfRemoveSwimLaneCommand;
        ...
        {
            var removeSwimLaneCommandValidator = new Wayd.Planning.Application.StoryMaps.Commands.RemoveSwimLaneCommandValidator();
            ...
            var removeSwimLaneCommand = (Wayd.Planning.Application.StoryMaps.Commands.RemoveSwimLaneCommand)context.Envelope.Message;
            ...
            try
            {
                System.Diagnostics.Activity.Current?.SetTag("message.handler", "Wayd.Planning.Application.StoryMaps.Commands.RemoveSwimLaneCommandHandler");
                System.Diagnostics.Activity.Current?.SetTag("handler.type", "Wayd.Planning.Application.StoryMaps.Commands.RemoveSwimLaneCommandHandler");
                await Wolverine.FluentValidation.Internals.FluentValidationExecutor.ExecuteOne<Wayd.Planning.Application.StoryMaps.Commands.RemoveSwimLaneCommand>(removeSwimLaneCommandValidator, _failureActionOfRemoveSwimLaneCommand, removeSwimLaneCommand).ConfigureAwait(false);
                var removeSwimLaneCommandHandler = new Wayd.Planning.Application.StoryMaps.Commands.RemoveSwimLaneCommandHandler(waydDbContext, storyMapNotifier, _loggerOfRemoveSwimLaneCommandHandler);
                
                // The actual message execution
                var outgoing1 = await removeSwimLaneCommandHandler.Handle(removeSwimLaneCommand, cancellation).ConfigureAwait(false);
    ...
    // END: RemoveSwimLaneCommandHandler1751169873
