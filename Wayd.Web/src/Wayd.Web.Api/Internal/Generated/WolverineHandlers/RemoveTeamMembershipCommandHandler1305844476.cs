...
namespace Internal.Generated.WolverineHandlers
{
    ...
    public sealed class RemoveTeamMembershipCommandHandler1305844476 : Wolverine.Runtime.Handlers.MessageHandler
    {
        ...
        public RemoveTeamMembershipCommandHandler1305844476(Microsoft.AspNetCore.Http.IHttpContextAccessor __httpContextAccessor1, Microsoft.AspNetCore.Http.IHttpContextAccessor __httpContextAccessor2, Microsoft.EntityFrameworkCore.DbContextOptions dbContextOptions, Microsoft.Extensions.DependencyInjection.IServiceScopeFactory serviceScopeFactory, Microsoft.Extensions.Logging.ILogger<Wayd.Common.Application.Behaviors.PerformanceBehaviorLog> loggerOfPerformanceBehaviorLog, Microsoft.Extensions.Logging.ILogger<Wayd.Infrastructure.Common.Services.EventPublisher> loggerOfEventPublisher, Microsoft.Extensions.Logging.ILogger<Wayd.Organization.Application.Teams.Commands.RemoveTeamMembershipCommandHandler> loggerOfRemoveTeamMembershipCommandHandler, Microsoft.Extensions.Options.IOptions<Wayd.Infrastructure.Persistence.DatabaseSettings> optionsOfDatabaseSettings, System.Collections.Generic.IEnumerable<Wolverine.EntityFrameworkCore.IDomainEventScraper> domainEventScraperIEnumerable, System.TimeProvider timeProvider, Wolverine.FluentValidation.IFailureAction<Wayd.Organization.Application.Teams.Commands.RemoveTeamMembershipCommand> failureActionOfRemoveTeamMembershipCommand, Wolverine.Runtime.IWolverineRuntime wolverineRuntime)
        {
        ...
        public override async System.Threading.Tasks.Task HandleAsync(Wolverine.Runtime.MessageContext context, System.Threading.CancellationToken cancellation)
        {
            ...
            try
            {
                ...
                await Wolverine.FluentValidation.Internals.FluentValidationExecutor.ExecuteOne<Wayd.Organization.Application.Teams.Commands.RemoveTeamMembershipCommand>(removeTeamMembershipCommandValidator, _failureActionOfRemoveTeamMembershipCommand, removeTeamMembershipCommand).ConfigureAwait(false);
                var removeTeamMembershipCommandHandler = new Wayd.Organization.Application.Teams.Commands.RemoveTeamMembershipCommandHandler(waydDbContext, dateTimeProvider, _loggerOfRemoveTeamMembershipCommandHandler);
