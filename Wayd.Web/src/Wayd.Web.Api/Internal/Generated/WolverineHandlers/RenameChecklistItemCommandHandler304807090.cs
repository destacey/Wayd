...
{
    // START: RenameChecklistItemCommandHandler304807090
    [global::System.CodeDom.Compiler.GeneratedCode("JasperFx", "1.0.0")]
    public sealed class RenameChecklistItemCommandHandler304807090 : Wolverine.Runtime.Handlers.MessageHandler
    {
        ...
        private readonly Microsoft.Extensions.Logging.ILogger<Wayd.Planning.Application.StoryMaps.Commands.RenameChecklistItemCommandHandler> _loggerOfRenameChecklistItemCommandHandler;
        ...
        private readonly Wolverine.FluentValidation.IFailureAction<Wayd.Planning.Application.StoryMaps.Commands.RenameChecklistItemCommand> _failureActionOfRenameChecklistItemCommand;
        private readonly Wolverine.Runtime.IWolverineRuntime _wolverineRuntime;

        public RenameChecklistItemCommandHandler304807090(Microsoft.AspNetCore.Http.IHttpContextAccessor __httpContextAccessor1, Microsoft.AspNetCore.Http.IHttpContextAccessor __httpContextAccessor2, Microsoft.EntityFrameworkCore.DbContextOptions dbContextOptions, Microsoft.Extensions.DependencyInjection.IServiceScopeFactory serviceScopeFactory, Microsoft.Extensions.Logging.ILogger<Wayd.Common.Application.Behaviors.PerformanceBehaviorLog> loggerOfPerformanceBehaviorLog, Microsoft.Extensions.Logging.ILogger<Wayd.Infrastructure.Common.Services.EventPublisher> loggerOfEventPublisher, Microsoft.Extensions.Logging.ILogger<Wayd.Planning.Application.StoryMaps.Commands.RenameChecklistItemCommandHandler> loggerOfRenameChecklistItemCommandHandler, Microsoft.Extensions.Options.IOptions<Wayd.Infrastructure.Persistence.DatabaseSettings> optionsOfDatabaseSettings, System.Collections.Generic.IEnumerable<Wolverine.EntityFrameworkCore.IDomainEventScraper> domainEventScraperIEnumerable, System.TimeProvider timeProvider, Wolverine.FluentValidation.IFailureAction<Wayd.Planning.Application.StoryMaps.Commands.RenameChecklistItemCommand> failureActionOfRenameChecklistItemCommand, Wolverine.Runtime.IWolverineRuntime wolverineRuntime)
        {
            ...
            _loggerOfRenameChecklistItemCommandHandler = loggerOfRenameChecklistItemCommandHandler;
            _optionsOfDatabaseSettings = optionsOfDatabaseSettings;
            _domainEventScraperIEnumerable = domainEventScraperIEnumerable;
            _timeProvider = timeProvider;
            _failureActionOfRenameChecklistItemCommand = failureActionOfRenameChecklistItemCommand;
        ...
        public override async System.Threading.Tasks.Task HandleAsync(Wolverine.Runtime.MessageContext context, System.Threading.CancellationToken cancellation)
        {
            ...
            var renameChecklistItemCommandValidator = new Wayd.Planning.Application.StoryMaps.Commands.RenameChecklistItemCommandValidator();
            ...
            var renameChecklistItemCommand = (Wayd.Planning.Application.StoryMaps.Commands.RenameChecklistItemCommand)context.Envelope.Message;
            ...
            try
            {
                System.Diagnostics.Activity.Current?.SetTag("message.handler", "Wayd.Planning.Application.StoryMaps.Commands.RenameChecklistItemCommandHandler");
                System.Diagnostics.Activity.Current?.SetTag("handler.type", "Wayd.Planning.Application.StoryMaps.Commands.RenameChecklistItemCommandHandler");
                await Wolverine.FluentValidation.Internals.FluentValidationExecutor.ExecuteOne<Wayd.Planning.Application.StoryMaps.Commands.RenameChecklistItemCommand>(renameChecklistItemCommandValidator, _failureActionOfRenameChecklistItemCommand, renameChecklistItemCommand).ConfigureAwait(false);
                var renameChecklistItemCommandHandler = new Wayd.Planning.Application.StoryMaps.Commands.RenameChecklistItemCommandHandler(waydDbContext, storyMapNotifier, _loggerOfRenameChecklistItemCommandHandler);
                
                // The actual message execution
                var outgoing1 = await renameChecklistItemCommandHandler.Handle(renameChecklistItemCommand, cancellation).ConfigureAwait(false);
    ...
    // END: RenameChecklistItemCommandHandler304807090
