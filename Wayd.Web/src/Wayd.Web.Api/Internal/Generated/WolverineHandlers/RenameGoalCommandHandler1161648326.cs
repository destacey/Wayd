...
{
    // START: RenameGoalCommandHandler1161648326
    [global::System.CodeDom.Compiler.GeneratedCode("JasperFx", "1.0.0")]
    public sealed class RenameGoalCommandHandler1161648326 : Wolverine.Runtime.Handlers.MessageHandler
    {
        ...
        private readonly Microsoft.Extensions.Logging.ILogger<Wayd.Planning.Application.StoryMaps.Commands.RenameGoalCommandHandler> _loggerOfRenameGoalCommandHandler;
        ...
        private readonly Wolverine.FluentValidation.IFailureAction<Wayd.Planning.Application.StoryMaps.Commands.RenameGoalCommand> _failureActionOfRenameGoalCommand;
        private readonly Wolverine.Runtime.IWolverineRuntime _wolverineRuntime;

        public RenameGoalCommandHandler1161648326(Microsoft.AspNetCore.Http.IHttpContextAccessor __httpContextAccessor1, Microsoft.AspNetCore.Http.IHttpContextAccessor __httpContextAccessor2, Microsoft.EntityFrameworkCore.DbContextOptions dbContextOptions, Microsoft.Extensions.DependencyInjection.IServiceScopeFactory serviceScopeFactory, Microsoft.Extensions.Logging.ILogger<Wayd.Common.Application.Behaviors.PerformanceBehaviorLog> loggerOfPerformanceBehaviorLog, Microsoft.Extensions.Logging.ILogger<Wayd.Infrastructure.Common.Services.EventPublisher> loggerOfEventPublisher, Microsoft.Extensions.Logging.ILogger<Wayd.Planning.Application.StoryMaps.Commands.RenameGoalCommandHandler> loggerOfRenameGoalCommandHandler, Microsoft.Extensions.Options.IOptions<Wayd.Infrastructure.Persistence.DatabaseSettings> optionsOfDatabaseSettings, System.Collections.Generic.IEnumerable<Wolverine.EntityFrameworkCore.IDomainEventScraper> domainEventScraperIEnumerable, System.TimeProvider timeProvider, Wolverine.FluentValidation.IFailureAction<Wayd.Planning.Application.StoryMaps.Commands.RenameGoalCommand> failureActionOfRenameGoalCommand, Wolverine.Runtime.IWolverineRuntime wolverineRuntime)
        {
            ...
            _loggerOfRenameGoalCommandHandler = loggerOfRenameGoalCommandHandler;
            _optionsOfDatabaseSettings = optionsOfDatabaseSettings;
            _domainEventScraperIEnumerable = domainEventScraperIEnumerable;
            _timeProvider = timeProvider;
            _failureActionOfRenameGoalCommand = failureActionOfRenameGoalCommand;
        ...
        {
            var renameGoalCommandValidator = new Wayd.Planning.Application.StoryMaps.Commands.RenameGoalCommandValidator();
            ...
            var renameGoalCommand = (Wayd.Planning.Application.StoryMaps.Commands.RenameGoalCommand)context.Envelope.Message;
            ...
            try
            {
                System.Diagnostics.Activity.Current?.SetTag("message.handler", "Wayd.Planning.Application.StoryMaps.Commands.RenameGoalCommandHandler");
                System.Diagnostics.Activity.Current?.SetTag("handler.type", "Wayd.Planning.Application.StoryMaps.Commands.RenameGoalCommandHandler");
                await Wolverine.FluentValidation.Internals.FluentValidationExecutor.ExecuteOne<Wayd.Planning.Application.StoryMaps.Commands.RenameGoalCommand>(renameGoalCommandValidator, _failureActionOfRenameGoalCommand, renameGoalCommand).ConfigureAwait(false);
                var renameGoalCommandHandler = new Wayd.Planning.Application.StoryMaps.Commands.RenameGoalCommandHandler(waydDbContext, storyMapNotifier, _loggerOfRenameGoalCommandHandler);
                
                // The actual message execution
                var outgoing1 = await renameGoalCommandHandler.Handle(renameGoalCommand, cancellation).ConfigureAwait(false);
    ...
    // END: RenameGoalCommandHandler1161648326
