...
{
    // START: RenameStepCommandHandler1876284107
    [global::System.CodeDom.Compiler.GeneratedCode("JasperFx", "1.0.0")]
    public sealed class RenameStepCommandHandler1876284107 : Wolverine.Runtime.Handlers.MessageHandler
    {
        ...
        private readonly Microsoft.Extensions.Logging.ILogger<Wayd.Planning.Application.StoryMaps.Commands.RenameStepCommandHandler> _loggerOfRenameStepCommandHandler;
        ...
        private readonly Wolverine.FluentValidation.IFailureAction<Wayd.Planning.Application.StoryMaps.Commands.RenameStepCommand> _failureActionOfRenameStepCommand;
        private readonly Wolverine.Runtime.IWolverineRuntime _wolverineRuntime;

        public RenameStepCommandHandler1876284107(Microsoft.AspNetCore.Http.IHttpContextAccessor __httpContextAccessor1, Microsoft.AspNetCore.Http.IHttpContextAccessor __httpContextAccessor2, Microsoft.EntityFrameworkCore.DbContextOptions dbContextOptions, Microsoft.Extensions.DependencyInjection.IServiceScopeFactory serviceScopeFactory, Microsoft.Extensions.Logging.ILogger<Wayd.Common.Application.Behaviors.PerformanceBehaviorLog> loggerOfPerformanceBehaviorLog, Microsoft.Extensions.Logging.ILogger<Wayd.Infrastructure.Common.Services.EventPublisher> loggerOfEventPublisher, Microsoft.Extensions.Logging.ILogger<Wayd.Planning.Application.StoryMaps.Commands.RenameStepCommandHandler> loggerOfRenameStepCommandHandler, Microsoft.Extensions.Options.IOptions<Wayd.Infrastructure.Persistence.DatabaseSettings> optionsOfDatabaseSettings, System.Collections.Generic.IEnumerable<Wolverine.EntityFrameworkCore.IDomainEventScraper> domainEventScraperIEnumerable, System.TimeProvider timeProvider, Wolverine.FluentValidation.IFailureAction<Wayd.Planning.Application.StoryMaps.Commands.RenameStepCommand> failureActionOfRenameStepCommand, Wolverine.Runtime.IWolverineRuntime wolverineRuntime)
        {
            ...
            _loggerOfRenameStepCommandHandler = loggerOfRenameStepCommandHandler;
            _optionsOfDatabaseSettings = optionsOfDatabaseSettings;
            _domainEventScraperIEnumerable = domainEventScraperIEnumerable;
            _timeProvider = timeProvider;
            _failureActionOfRenameStepCommand = failureActionOfRenameStepCommand;
        ...
        public override async System.Threading.Tasks.Task HandleAsync(Wolverine.Runtime.MessageContext context, System.Threading.CancellationToken cancellation)
        {
            ...
            var renameStepCommandValidator = new Wayd.Planning.Application.StoryMaps.Commands.RenameStepCommandValidator();
            // The actual message body
            var renameStepCommand = (Wayd.Planning.Application.StoryMaps.Commands.RenameStepCommand)context.Envelope.Message;
            ...
            try
            {
                System.Diagnostics.Activity.Current?.SetTag("message.handler", "Wayd.Planning.Application.StoryMaps.Commands.RenameStepCommandHandler");
                System.Diagnostics.Activity.Current?.SetTag("handler.type", "Wayd.Planning.Application.StoryMaps.Commands.RenameStepCommandHandler");
                await Wolverine.FluentValidation.Internals.FluentValidationExecutor.ExecuteOne<Wayd.Planning.Application.StoryMaps.Commands.RenameStepCommand>(renameStepCommandValidator, _failureActionOfRenameStepCommand, renameStepCommand).ConfigureAwait(false);
                var renameStepCommandHandler = new Wayd.Planning.Application.StoryMaps.Commands.RenameStepCommandHandler(waydDbContext, storyMapNotifier, _loggerOfRenameStepCommandHandler);
                
                // The actual message execution
                var outgoing1 = await renameStepCommandHandler.Handle(renameStepCommand, cancellation).ConfigureAwait(false);
    ...
    // END: RenameStepCommandHandler1876284107
