...
{
    // START: RenameSwimLaneCommandHandler1846395481
    [global::System.CodeDom.Compiler.GeneratedCode("JasperFx", "1.0.0")]
    public sealed class RenameSwimLaneCommandHandler1846395481 : Wolverine.Runtime.Handlers.MessageHandler
    {
        ...
        private readonly Microsoft.Extensions.Logging.ILogger<Wayd.Planning.Application.StoryMaps.Commands.RenameSwimLaneCommandHandler> _loggerOfRenameSwimLaneCommandHandler;
        ...
        private readonly Wolverine.FluentValidation.IFailureAction<Wayd.Planning.Application.StoryMaps.Commands.RenameSwimLaneCommand> _failureActionOfRenameSwimLaneCommand;
        private readonly Wolverine.Runtime.IWolverineRuntime _wolverineRuntime;

        public RenameSwimLaneCommandHandler1846395481(Microsoft.AspNetCore.Http.IHttpContextAccessor __httpContextAccessor1, Microsoft.AspNetCore.Http.IHttpContextAccessor __httpContextAccessor2, Microsoft.EntityFrameworkCore.DbContextOptions dbContextOptions, Microsoft.Extensions.DependencyInjection.IServiceScopeFactory serviceScopeFactory, Microsoft.Extensions.Logging.ILogger<Wayd.Common.Application.Behaviors.PerformanceBehaviorLog> loggerOfPerformanceBehaviorLog, Microsoft.Extensions.Logging.ILogger<Wayd.Infrastructure.Common.Services.EventPublisher> loggerOfEventPublisher, Microsoft.Extensions.Logging.ILogger<Wayd.Planning.Application.StoryMaps.Commands.RenameSwimLaneCommandHandler> loggerOfRenameSwimLaneCommandHandler, Microsoft.Extensions.Options.IOptions<Wayd.Infrastructure.Persistence.DatabaseSettings> optionsOfDatabaseSettings, System.Collections.Generic.IEnumerable<Wolverine.EntityFrameworkCore.IDomainEventScraper> domainEventScraperIEnumerable, System.TimeProvider timeProvider, Wolverine.FluentValidation.IFailureAction<Wayd.Planning.Application.StoryMaps.Commands.RenameSwimLaneCommand> failureActionOfRenameSwimLaneCommand, Wolverine.Runtime.IWolverineRuntime wolverineRuntime)
        {
            ...
            _loggerOfRenameSwimLaneCommandHandler = loggerOfRenameSwimLaneCommandHandler;
            _optionsOfDatabaseSettings = optionsOfDatabaseSettings;
            _domainEventScraperIEnumerable = domainEventScraperIEnumerable;
            _timeProvider = timeProvider;
            _failureActionOfRenameSwimLaneCommand = failureActionOfRenameSwimLaneCommand;
        ...
        public override async System.Threading.Tasks.Task HandleAsync(Wolverine.Runtime.MessageContext context, System.Threading.CancellationToken cancellation)
        {
            ...
            var renameSwimLaneCommandValidator = new Wayd.Planning.Application.StoryMaps.Commands.RenameSwimLaneCommandValidator();
            // The actual message body
            var renameSwimLaneCommand = (Wayd.Planning.Application.StoryMaps.Commands.RenameSwimLaneCommand)context.Envelope.Message;
            ...
            try
            {
                System.Diagnostics.Activity.Current?.SetTag("message.handler", "Wayd.Planning.Application.StoryMaps.Commands.RenameSwimLaneCommandHandler");
                System.Diagnostics.Activity.Current?.SetTag("handler.type", "Wayd.Planning.Application.StoryMaps.Commands.RenameSwimLaneCommandHandler");
                await Wolverine.FluentValidation.Internals.FluentValidationExecutor.ExecuteOne<Wayd.Planning.Application.StoryMaps.Commands.RenameSwimLaneCommand>(renameSwimLaneCommandValidator, _failureActionOfRenameSwimLaneCommand, renameSwimLaneCommand).ConfigureAwait(false);
                var renameSwimLaneCommandHandler = new Wayd.Planning.Application.StoryMaps.Commands.RenameSwimLaneCommandHandler(waydDbContext, storyMapNotifier, _loggerOfRenameSwimLaneCommandHandler);
                
                // The actual message execution
                var outgoing1 = await renameSwimLaneCommandHandler.Handle(renameSwimLaneCommand, cancellation).ConfigureAwait(false);
    ...
    // END: RenameSwimLaneCommandHandler1846395481
