...
{
    // START: ReorderGoalCommandHandler791509601
    [global::System.CodeDom.Compiler.GeneratedCode("JasperFx", "1.0.0")]
    public sealed class ReorderGoalCommandHandler791509601 : Wolverine.Runtime.Handlers.MessageHandler
    {
        ...
        private readonly Microsoft.Extensions.Logging.ILogger<Wayd.Planning.Application.StoryMaps.Commands.ReorderGoalCommandHandler> _loggerOfReorderGoalCommandHandler;
        ...
        private readonly Wolverine.FluentValidation.IFailureAction<Wayd.Planning.Application.StoryMaps.Commands.ReorderGoalCommand> _failureActionOfReorderGoalCommand;
        private readonly Wolverine.Runtime.IWolverineRuntime _wolverineRuntime;

        public ReorderGoalCommandHandler791509601(Microsoft.AspNetCore.Http.IHttpContextAccessor __httpContextAccessor1, Microsoft.AspNetCore.Http.IHttpContextAccessor __httpContextAccessor2, Microsoft.EntityFrameworkCore.DbContextOptions dbContextOptions, Microsoft.Extensions.DependencyInjection.IServiceScopeFactory serviceScopeFactory, Microsoft.Extensions.Logging.ILogger<Wayd.Common.Application.Behaviors.PerformanceBehaviorLog> loggerOfPerformanceBehaviorLog, Microsoft.Extensions.Logging.ILogger<Wayd.Infrastructure.Common.Services.EventPublisher> loggerOfEventPublisher, Microsoft.Extensions.Logging.ILogger<Wayd.Planning.Application.StoryMaps.Commands.ReorderGoalCommandHandler> loggerOfReorderGoalCommandHandler, Microsoft.Extensions.Options.IOptions<Wayd.Infrastructure.Persistence.DatabaseSettings> optionsOfDatabaseSettings, System.Collections.Generic.IEnumerable<Wolverine.EntityFrameworkCore.IDomainEventScraper> domainEventScraperIEnumerable, System.TimeProvider timeProvider, Wolverine.FluentValidation.IFailureAction<Wayd.Planning.Application.StoryMaps.Commands.ReorderGoalCommand> failureActionOfReorderGoalCommand, Wolverine.Runtime.IWolverineRuntime wolverineRuntime)
        {
            ...
            _loggerOfReorderGoalCommandHandler = loggerOfReorderGoalCommandHandler;
            _optionsOfDatabaseSettings = optionsOfDatabaseSettings;
            _domainEventScraperIEnumerable = domainEventScraperIEnumerable;
            _timeProvider = timeProvider;
            _failureActionOfReorderGoalCommand = failureActionOfReorderGoalCommand;
        ...
        public override async System.Threading.Tasks.Task HandleAsync(Wolverine.Runtime.MessageContext context, System.Threading.CancellationToken cancellation)
        {
            ...
            var reorderGoalCommandValidator = new Wayd.Planning.Application.StoryMaps.Commands.ReorderGoalCommandValidator();
            ...
            var reorderGoalCommand = (Wayd.Planning.Application.StoryMaps.Commands.ReorderGoalCommand)context.Envelope.Message;
            ...
            try
            {
                System.Diagnostics.Activity.Current?.SetTag("message.handler", "Wayd.Planning.Application.StoryMaps.Commands.ReorderGoalCommandHandler");
                System.Diagnostics.Activity.Current?.SetTag("handler.type", "Wayd.Planning.Application.StoryMaps.Commands.ReorderGoalCommandHandler");
                await Wolverine.FluentValidation.Internals.FluentValidationExecutor.ExecuteOne<Wayd.Planning.Application.StoryMaps.Commands.ReorderGoalCommand>(reorderGoalCommandValidator, _failureActionOfReorderGoalCommand, reorderGoalCommand).ConfigureAwait(false);
                var reorderGoalCommandHandler = new Wayd.Planning.Application.StoryMaps.Commands.ReorderGoalCommandHandler(waydDbContext, storyMapNotifier, _loggerOfReorderGoalCommandHandler);
                
                // The actual message execution
                var outgoing1 = await reorderGoalCommandHandler.Handle(reorderGoalCommand, cancellation).ConfigureAwait(false);
    ...
    // END: ReorderGoalCommandHandler791509601
