...
{
    // START: ReorderPersonaCommandHandler722565338
    [global::System.CodeDom.Compiler.GeneratedCode("JasperFx", "1.0.0")]
    public sealed class ReorderPersonaCommandHandler722565338 : Wolverine.Runtime.Handlers.MessageHandler
    {
        ...
        private readonly Microsoft.Extensions.Logging.ILogger<Wayd.Planning.Application.StoryMaps.Commands.ReorderPersonaCommandHandler> _loggerOfReorderPersonaCommandHandler;
        ...
        private readonly Wolverine.FluentValidation.IFailureAction<Wayd.Planning.Application.StoryMaps.Commands.ReorderPersonaCommand> _failureActionOfReorderPersonaCommand;
        private readonly Wolverine.Runtime.IWolverineRuntime _wolverineRuntime;

        public ReorderPersonaCommandHandler722565338(Microsoft.AspNetCore.Http.IHttpContextAccessor __httpContextAccessor1, Microsoft.AspNetCore.Http.IHttpContextAccessor __httpContextAccessor2, Microsoft.EntityFrameworkCore.DbContextOptions dbContextOptions, Microsoft.Extensions.DependencyInjection.IServiceScopeFactory serviceScopeFactory, Microsoft.Extensions.Logging.ILogger<Wayd.Common.Application.Behaviors.PerformanceBehaviorLog> loggerOfPerformanceBehaviorLog, Microsoft.Extensions.Logging.ILogger<Wayd.Infrastructure.Common.Services.EventPublisher> loggerOfEventPublisher, Microsoft.Extensions.Logging.ILogger<Wayd.Planning.Application.StoryMaps.Commands.ReorderPersonaCommandHandler> loggerOfReorderPersonaCommandHandler, Microsoft.Extensions.Options.IOptions<Wayd.Infrastructure.Persistence.DatabaseSettings> optionsOfDatabaseSettings, System.Collections.Generic.IEnumerable<Wolverine.EntityFrameworkCore.IDomainEventScraper> domainEventScraperIEnumerable, System.TimeProvider timeProvider, Wolverine.FluentValidation.IFailureAction<Wayd.Planning.Application.StoryMaps.Commands.ReorderPersonaCommand> failureActionOfReorderPersonaCommand, Wolverine.Runtime.IWolverineRuntime wolverineRuntime)
        {
            ...
            _loggerOfReorderPersonaCommandHandler = loggerOfReorderPersonaCommandHandler;
            _optionsOfDatabaseSettings = optionsOfDatabaseSettings;
            _domainEventScraperIEnumerable = domainEventScraperIEnumerable;
            _timeProvider = timeProvider;
            _failureActionOfReorderPersonaCommand = failureActionOfReorderPersonaCommand;
        ...
        public override async System.Threading.Tasks.Task HandleAsync(Wolverine.Runtime.MessageContext context, System.Threading.CancellationToken cancellation)
        {
            ...
            var reorderPersonaCommandValidator = new Wayd.Planning.Application.StoryMaps.Commands.ReorderPersonaCommandValidator();
            // The actual message body
            var reorderPersonaCommand = (Wayd.Planning.Application.StoryMaps.Commands.ReorderPersonaCommand)context.Envelope.Message;
            ...
            try
            {
                System.Diagnostics.Activity.Current?.SetTag("message.handler", "Wayd.Planning.Application.StoryMaps.Commands.ReorderPersonaCommandHandler");
                System.Diagnostics.Activity.Current?.SetTag("handler.type", "Wayd.Planning.Application.StoryMaps.Commands.ReorderPersonaCommandHandler");
                await Wolverine.FluentValidation.Internals.FluentValidationExecutor.ExecuteOne<Wayd.Planning.Application.StoryMaps.Commands.ReorderPersonaCommand>(reorderPersonaCommandValidator, _failureActionOfReorderPersonaCommand, reorderPersonaCommand).ConfigureAwait(false);
                var reorderPersonaCommandHandler = new Wayd.Planning.Application.StoryMaps.Commands.ReorderPersonaCommandHandler(waydDbContext, storyMapNotifier, _loggerOfReorderPersonaCommandHandler);
                
                // The actual message execution
                var outgoing1 = await reorderPersonaCommandHandler.Handle(reorderPersonaCommand, cancellation).ConfigureAwait(false);
    ...
    // END: ReorderPersonaCommandHandler722565338
