...
{
    // START: ReorderStepCommandHandler1895276810
    [global::System.CodeDom.Compiler.GeneratedCode("JasperFx", "1.0.0")]
    public sealed class ReorderStepCommandHandler1895276810 : Wolverine.Runtime.Handlers.MessageHandler
    {
        ...
        private readonly Microsoft.Extensions.Logging.ILogger<Wayd.Planning.Application.StoryMaps.Commands.ReorderStepCommandHandler> _loggerOfReorderStepCommandHandler;
        ...
        private readonly Wolverine.FluentValidation.IFailureAction<Wayd.Planning.Application.StoryMaps.Commands.ReorderStepCommand> _failureActionOfReorderStepCommand;
        private readonly Wolverine.Runtime.IWolverineRuntime _wolverineRuntime;

        public ReorderStepCommandHandler1895276810(Microsoft.AspNetCore.Http.IHttpContextAccessor __httpContextAccessor1, Microsoft.AspNetCore.Http.IHttpContextAccessor __httpContextAccessor2, Microsoft.EntityFrameworkCore.DbContextOptions dbContextOptions, Microsoft.Extensions.DependencyInjection.IServiceScopeFactory serviceScopeFactory, Microsoft.Extensions.Logging.ILogger<Wayd.Common.Application.Behaviors.PerformanceBehaviorLog> loggerOfPerformanceBehaviorLog, Microsoft.Extensions.Logging.ILogger<Wayd.Infrastructure.Common.Services.EventPublisher> loggerOfEventPublisher, Microsoft.Extensions.Logging.ILogger<Wayd.Planning.Application.StoryMaps.Commands.ReorderStepCommandHandler> loggerOfReorderStepCommandHandler, Microsoft.Extensions.Options.IOptions<Wayd.Infrastructure.Persistence.DatabaseSettings> optionsOfDatabaseSettings, System.Collections.Generic.IEnumerable<Wolverine.EntityFrameworkCore.IDomainEventScraper> domainEventScraperIEnumerable, System.TimeProvider timeProvider, Wolverine.FluentValidation.IFailureAction<Wayd.Planning.Application.StoryMaps.Commands.ReorderStepCommand> failureActionOfReorderStepCommand, Wolverine.Runtime.IWolverineRuntime wolverineRuntime)
        {
            ...
            _loggerOfReorderStepCommandHandler = loggerOfReorderStepCommandHandler;
            _optionsOfDatabaseSettings = optionsOfDatabaseSettings;
            _domainEventScraperIEnumerable = domainEventScraperIEnumerable;
            _timeProvider = timeProvider;
            _failureActionOfReorderStepCommand = failureActionOfReorderStepCommand;
        ...
        public override async System.Threading.Tasks.Task HandleAsync(Wolverine.Runtime.MessageContext context, System.Threading.CancellationToken cancellation)
        {
            ...
            var reorderStepCommandValidator = new Wayd.Planning.Application.StoryMaps.Commands.ReorderStepCommandValidator();
            ...
            var reorderStepCommand = (Wayd.Planning.Application.StoryMaps.Commands.ReorderStepCommand)context.Envelope.Message;
            ...
            try
            {
                System.Diagnostics.Activity.Current?.SetTag("message.handler", "Wayd.Planning.Application.StoryMaps.Commands.ReorderStepCommandHandler");
                System.Diagnostics.Activity.Current?.SetTag("handler.type", "Wayd.Planning.Application.StoryMaps.Commands.ReorderStepCommandHandler");
                await Wolverine.FluentValidation.Internals.FluentValidationExecutor.ExecuteOne<Wayd.Planning.Application.StoryMaps.Commands.ReorderStepCommand>(reorderStepCommandValidator, _failureActionOfReorderStepCommand, reorderStepCommand).ConfigureAwait(false);
                var reorderStepCommandHandler = new Wayd.Planning.Application.StoryMaps.Commands.ReorderStepCommandHandler(waydDbContext, storyMapNotifier, _loggerOfReorderStepCommandHandler);
                
                // The actual message execution
                var outgoing1 = await reorderStepCommandHandler.Handle(reorderStepCommand, cancellation).ConfigureAwait(false);
    ...
    // END: ReorderStepCommandHandler1895276810
