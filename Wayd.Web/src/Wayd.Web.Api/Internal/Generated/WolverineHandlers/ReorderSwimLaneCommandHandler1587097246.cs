...
{
    // START: ReorderSwimLaneCommandHandler1587097246
    [global::System.CodeDom.Compiler.GeneratedCode("JasperFx", "1.0.0")]
    public sealed class ReorderSwimLaneCommandHandler1587097246 : Wolverine.Runtime.Handlers.MessageHandler
    {
        ...
        private readonly Microsoft.Extensions.Logging.ILogger<Wayd.Planning.Application.StoryMaps.Commands.ReorderSwimLaneCommandHandler> _loggerOfReorderSwimLaneCommandHandler;
        ...
        private readonly Wolverine.FluentValidation.IFailureAction<Wayd.Planning.Application.StoryMaps.Commands.ReorderSwimLaneCommand> _failureActionOfReorderSwimLaneCommand;
        private readonly Wolverine.Runtime.IWolverineRuntime _wolverineRuntime;

        public ReorderSwimLaneCommandHandler1587097246(Microsoft.AspNetCore.Http.IHttpContextAccessor __httpContextAccessor1, Microsoft.AspNetCore.Http.IHttpContextAccessor __httpContextAccessor2, Microsoft.EntityFrameworkCore.DbContextOptions dbContextOptions, Microsoft.Extensions.DependencyInjection.IServiceScopeFactory serviceScopeFactory, Microsoft.Extensions.Logging.ILogger<Wayd.Common.Application.Behaviors.PerformanceBehaviorLog> loggerOfPerformanceBehaviorLog, Microsoft.Extensions.Logging.ILogger<Wayd.Infrastructure.Common.Services.EventPublisher> loggerOfEventPublisher, Microsoft.Extensions.Logging.ILogger<Wayd.Planning.Application.StoryMaps.Commands.ReorderSwimLaneCommandHandler> loggerOfReorderSwimLaneCommandHandler, Microsoft.Extensions.Options.IOptions<Wayd.Infrastructure.Persistence.DatabaseSettings> optionsOfDatabaseSettings, System.Collections.Generic.IEnumerable<Wolverine.EntityFrameworkCore.IDomainEventScraper> domainEventScraperIEnumerable, System.TimeProvider timeProvider, Wolverine.FluentValidation.IFailureAction<Wayd.Planning.Application.StoryMaps.Commands.ReorderSwimLaneCommand> failureActionOfReorderSwimLaneCommand, Wolverine.Runtime.IWolverineRuntime wolverineRuntime)
        {
            ...
            _loggerOfReorderSwimLaneCommandHandler = loggerOfReorderSwimLaneCommandHandler;
            _optionsOfDatabaseSettings = optionsOfDatabaseSettings;
            _domainEventScraperIEnumerable = domainEventScraperIEnumerable;
            _timeProvider = timeProvider;
            _failureActionOfReorderSwimLaneCommand = failureActionOfReorderSwimLaneCommand;
        ...
        {
            var reorderSwimLaneCommandValidator = new Wayd.Planning.Application.StoryMaps.Commands.ReorderSwimLaneCommandValidator();
            ...
            var reorderSwimLaneCommand = (Wayd.Planning.Application.StoryMaps.Commands.ReorderSwimLaneCommand)context.Envelope.Message;
            ...
            try
            {
                System.Diagnostics.Activity.Current?.SetTag("message.handler", "Wayd.Planning.Application.StoryMaps.Commands.ReorderSwimLaneCommandHandler");
                System.Diagnostics.Activity.Current?.SetTag("handler.type", "Wayd.Planning.Application.StoryMaps.Commands.ReorderSwimLaneCommandHandler");
                await Wolverine.FluentValidation.Internals.FluentValidationExecutor.ExecuteOne<Wayd.Planning.Application.StoryMaps.Commands.ReorderSwimLaneCommand>(reorderSwimLaneCommandValidator, _failureActionOfReorderSwimLaneCommand, reorderSwimLaneCommand).ConfigureAwait(false);
                var reorderSwimLaneCommandHandler = new Wayd.Planning.Application.StoryMaps.Commands.ReorderSwimLaneCommandHandler(waydDbContext, storyMapNotifier, _loggerOfReorderSwimLaneCommandHandler);
                
                // The actual message execution
                var outgoing1 = await reorderSwimLaneCommandHandler.Handle(reorderSwimLaneCommand, cancellation).ConfigureAwait(false);
    ...
    // END: ReorderSwimLaneCommandHandler1587097246
