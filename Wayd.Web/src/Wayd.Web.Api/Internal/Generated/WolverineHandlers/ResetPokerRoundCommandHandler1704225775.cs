...
namespace Internal.Generated.WolverineHandlers
{
    ...
    public sealed class ResetPokerRoundCommandHandler1704225775 : Wolverine.Runtime.Handlers.MessageHandler
    {
        ...
        public ResetPokerRoundCommandHandler1704225775(Microsoft.AspNetCore.Http.IHttpContextAccessor __httpContextAccessor1, Microsoft.AspNetCore.Http.IHttpContextAccessor __httpContextAccessor2, Microsoft.EntityFrameworkCore.DbContextOptions dbContextOptions, Microsoft.Extensions.DependencyInjection.IServiceScopeFactory serviceScopeFactory, Microsoft.Extensions.Logging.ILogger<Wayd.Common.Application.Behaviors.PerformanceBehaviorLog> loggerOfPerformanceBehaviorLog, Microsoft.Extensions.Logging.ILogger<Wayd.Infrastructure.Common.Services.EventPublisher> loggerOfEventPublisher, Microsoft.Extensions.Logging.ILogger<Wayd.Planning.Application.PokerSessions.Commands.ResetPokerRoundCommandHandler> loggerOfResetPokerRoundCommandHandler, Microsoft.Extensions.Options.IOptions<Wayd.Infrastructure.Persistence.DatabaseSettings> optionsOfDatabaseSettings, System.Collections.Generic.IEnumerable<Wolverine.EntityFrameworkCore.IDomainEventScraper> domainEventScraperIEnumerable, System.TimeProvider timeProvider, Wolverine.FluentValidation.IFailureAction<Wayd.Planning.Application.PokerSessions.Commands.ResetPokerRoundCommand> failureActionOfResetPokerRoundCommand, Wolverine.Runtime.IWolverineRuntime wolverineRuntime)
        {
        ...
        public override async System.Threading.Tasks.Task HandleAsync(Wolverine.Runtime.MessageContext context, System.Threading.CancellationToken cancellation)
        {
            ...
            try
            {
                ...
                await Wolverine.FluentValidation.Internals.FluentValidationExecutor.ExecuteOne<Wayd.Planning.Application.PokerSessions.Commands.ResetPokerRoundCommand>(resetPokerRoundCommandValidator, _failureActionOfResetPokerRoundCommand, resetPokerRoundCommand).ConfigureAwait(false);
                var resetPokerRoundCommandHandler = new Wayd.Planning.Application.PokerSessions.Commands.ResetPokerRoundCommandHandler(waydDbContext, pokerSessionNotifier, _loggerOfResetPokerRoundCommandHandler);
