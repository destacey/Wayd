...
namespace Internal.Generated.WolverineHandlers
{
    ...
    public sealed class RevealPokerRoundCommandHandler531998915 : Wolverine.Runtime.Handlers.MessageHandler
    {
        ...
        public RevealPokerRoundCommandHandler531998915(Microsoft.AspNetCore.Http.IHttpContextAccessor __httpContextAccessor1, Microsoft.AspNetCore.Http.IHttpContextAccessor __httpContextAccessor2, Microsoft.EntityFrameworkCore.DbContextOptions dbContextOptions, Microsoft.Extensions.DependencyInjection.IServiceScopeFactory serviceScopeFactory, Microsoft.Extensions.Logging.ILogger<Wayd.Common.Application.Behaviors.PerformanceBehaviorLog> loggerOfPerformanceBehaviorLog, Microsoft.Extensions.Logging.ILogger<Wayd.Infrastructure.Common.Services.EventPublisher> loggerOfEventPublisher, Microsoft.Extensions.Logging.ILogger<Wayd.Planning.Application.PokerSessions.Commands.RevealPokerRoundCommandHandler> loggerOfRevealPokerRoundCommandHandler, Microsoft.Extensions.Options.IOptions<Wayd.Infrastructure.Persistence.DatabaseSettings> optionsOfDatabaseSettings, System.Collections.Generic.IEnumerable<Wolverine.EntityFrameworkCore.IDomainEventScraper> domainEventScraperIEnumerable, System.TimeProvider timeProvider, Wolverine.FluentValidation.IFailureAction<Wayd.Planning.Application.PokerSessions.Commands.RevealPokerRoundCommand> failureActionOfRevealPokerRoundCommand, Wolverine.Runtime.IWolverineRuntime wolverineRuntime)
        {
        ...
        public override async System.Threading.Tasks.Task HandleAsync(Wolverine.Runtime.MessageContext context, System.Threading.CancellationToken cancellation)
        {
            ...
            try
            {
                ...
                await Wolverine.FluentValidation.Internals.FluentValidationExecutor.ExecuteOne<Wayd.Planning.Application.PokerSessions.Commands.RevealPokerRoundCommand>(revealPokerRoundCommandValidator, _failureActionOfRevealPokerRoundCommand, revealPokerRoundCommand).ConfigureAwait(false);
                var revealPokerRoundCommandHandler = new Wayd.Planning.Application.PokerSessions.Commands.RevealPokerRoundCommandHandler(waydDbContext, pokerSessionNotifier, _loggerOfRevealPokerRoundCommandHandler);
