...
{
    // START: SearchPlanningForGlobalSearchQueryHandler1446301605
    [global::System.CodeDom.Compiler.GeneratedCode("JasperFx", "1.0.0")]
    public sealed class SearchPlanningForGlobalSearchQueryHandler1446301605 : Wolverine.Runtime.Handlers.MessageHandler
    {
        ...
        public SearchPlanningForGlobalSearchQueryHandler1446301605(Microsoft.Extensions.DependencyInjection.IServiceScopeFactory serviceScopeFactory, Microsoft.Extensions.Logging.ILogger<Wayd.Common.Application.Behaviors.PerformanceBehaviorLog> loggerOfPerformanceBehaviorLog)
        {
        ...
        public override async System.Threading.Tasks.Task HandleAsync(Wolverine.Runtime.MessageContext context, System.Threading.CancellationToken cancellation)
        {
            ...
            */
            ...
            try
            {
                System.Diagnostics.Activity.Current?.SetTag("message.handler", "Wayd.Planning.Application.Search.SearchPlanningForGlobalSearchQueryHandler");
                System.Diagnostics.Activity.Current?.SetTag("handler.type", "Wayd.Planning.Application.Search.SearchPlanningForGlobalSearchQueryHandler");
                var searchPlanningForGlobalSearchQueryHandler = new Wayd.Planning.Application.Search.SearchPlanningForGlobalSearchQueryHandler(planningDbContext, dispatcher, dateTimeProvider, currentUser);
                
                // The actual message execution
                var outgoing1 = await searchPlanningForGlobalSearchQueryHandler.Handle(searchPlanningForGlobalSearchQuery, cancellation).ConfigureAwait(false);
    ...
    // END: SearchPlanningForGlobalSearchQueryHandler1446301605
