...
{
    // START: SearchWorkItemsQueryHandler991056516
    [global::System.CodeDom.Compiler.GeneratedCode("JasperFx", "1.0.0")]
    public sealed class SearchWorkItemsQueryHandler991056516 : Wolverine.Runtime.Handlers.MessageHandler
    {
        ...
        private readonly Microsoft.Extensions.Logging.ILogger<Wayd.Work.Application.WorkItems.Queries.SearchWorkItemsQueryHandler> _loggerOfSearchWorkItemsQueryHandler;
        ...
        public SearchWorkItemsQueryHandler991056516(Microsoft.AspNetCore.Http.IHttpContextAccessor __httpContextAccessor1, Microsoft.AspNetCore.Http.IHttpContextAccessor __httpContextAccessor2, Microsoft.EntityFrameworkCore.DbContextOptions dbContextOptions, Microsoft.Extensions.DependencyInjection.IServiceScopeFactory serviceScopeFactory, Microsoft.Extensions.Logging.ILogger<Wayd.Common.Application.Behaviors.PerformanceBehaviorLog> loggerOfPerformanceBehaviorLog, Microsoft.Extensions.Logging.ILogger<Wayd.Infrastructure.Common.Services.EventPublisher> loggerOfEventPublisher, Microsoft.Extensions.Logging.ILogger<Wayd.Work.Application.WorkItems.Queries.SearchWorkItemsQueryHandler> loggerOfSearchWorkItemsQueryHandler, Microsoft.Extensions.Options.IOptions<Wayd.Infrastructure.Persistence.DatabaseSettings> optionsOfDatabaseSettings, System.Collections.Generic.IEnumerable<Wolverine.EntityFrameworkCore.IDomainEventScraper> domainEventScraperIEnumerable, System.TimeProvider timeProvider, Wolverine.Runtime.IWolverineRuntime wolverineRuntime)
        {
            ...
            _loggerOfSearchWorkItemsQueryHandler = loggerOfSearchWorkItemsQueryHandler;
        ...
        public override async System.Threading.Tasks.Task HandleAsync(Wolverine.Runtime.MessageContext context, System.Threading.CancellationToken cancellation)
        {
            ...
            try
            {
                System.Diagnostics.Activity.Current?.SetTag("message.handler", "Wayd.Work.Application.WorkItems.Queries.SearchWorkItemsQueryHandler");
                System.Diagnostics.Activity.Current?.SetTag("handler.type", "Wayd.Work.Application.WorkItems.Queries.SearchWorkItemsQueryHandler");
                var searchWorkItemsQueryHandler = new Wayd.Work.Application.WorkItems.Queries.SearchWorkItemsQueryHandler(waydDbContext, _loggerOfSearchWorkItemsQueryHandler);
                
                // The actual message execution
                var outgoing1 = await searchWorkItemsQueryHandler.Handle(searchWorkItemsQuery, cancellation).ConfigureAwait(false);
    ...
    // END: SearchWorkItemsQueryHandler991056516
