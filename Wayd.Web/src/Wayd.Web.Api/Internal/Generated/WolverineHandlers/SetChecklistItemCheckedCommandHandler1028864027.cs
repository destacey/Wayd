...
{
    // START: SetChecklistItemCheckedCommandHandler1028864027
    [global::System.CodeDom.Compiler.GeneratedCode("JasperFx", "1.0.0")]
    public sealed class SetChecklistItemCheckedCommandHandler1028864027 : Wolverine.Runtime.Handlers.MessageHandler
    {
        ...
        private readonly Microsoft.Extensions.Logging.ILogger<Wayd.Planning.Application.StoryMaps.Commands.SetChecklistItemCheckedCommandHandler> _loggerOfSetChecklistItemCheckedCommandHandler;
        ...
        private readonly Wolverine.FluentValidation.IFailureAction<Wayd.Planning.Application.StoryMaps.Commands.SetChecklistItemCheckedCommand> _failureActionOfSetChecklistItemCheckedCommand;
        private readonly Wolverine.Runtime.IWolverineRuntime _wolverineRuntime;

        public SetChecklistItemCheckedCommandHandler1028864027(Microsoft.AspNetCore.Http.IHttpContextAccessor __httpContextAccessor1, Microsoft.AspNetCore.Http.IHttpContextAccessor __httpContextAccessor2, Microsoft.EntityFrameworkCore.DbContextOptions dbContextOptions, Microsoft.Extensions.DependencyInjection.IServiceScopeFactory serviceScopeFactory, Microsoft.Extensions.Logging.ILogger<Wayd.Common.Application.Behaviors.PerformanceBehaviorLog> loggerOfPerformanceBehaviorLog, Microsoft.Extensions.Logging.ILogger<Wayd.Infrastructure.Common.Services.EventPublisher> loggerOfEventPublisher, Microsoft.Extensions.Logging.ILogger<Wayd.Planning.Application.StoryMaps.Commands.SetChecklistItemCheckedCommandHandler> loggerOfSetChecklistItemCheckedCommandHandler, Microsoft.Extensions.Options.IOptions<Wayd.Infrastructure.Persistence.DatabaseSettings> optionsOfDatabaseSettings, System.Collections.Generic.IEnumerable<Wolverine.EntityFrameworkCore.IDomainEventScraper> domainEventScraperIEnumerable, System.TimeProvider timeProvider, Wolverine.FluentValidation.IFailureAction<Wayd.Planning.Application.StoryMaps.Commands.SetChecklistItemCheckedCommand> failureActionOfSetChecklistItemCheckedCommand, Wolverine.Runtime.IWolverineRuntime wolverineRuntime)
        {
            ...
            _loggerOfSetChecklistItemCheckedCommandHandler = loggerOfSetChecklistItemCheckedCommandHandler;
            _optionsOfDatabaseSettings = optionsOfDatabaseSettings;
            _domainEventScraperIEnumerable = domainEventScraperIEnumerable;
            _timeProvider = timeProvider;
            _failureActionOfSetChecklistItemCheckedCommand = failureActionOfSetChecklistItemCheckedCommand;
        ...
        {
            var setChecklistItemCheckedCommandValidator = new Wayd.Planning.Application.StoryMaps.Commands.SetChecklistItemCheckedCommandValidator();
            ...
            var setChecklistItemCheckedCommand = (Wayd.Planning.Application.StoryMaps.Commands.SetChecklistItemCheckedCommand)context.Envelope.Message;
            ...
            try
            {
                System.Diagnostics.Activity.Current?.SetTag("message.handler", "Wayd.Planning.Application.StoryMaps.Commands.SetChecklistItemCheckedCommandHandler");
                System.Diagnostics.Activity.Current?.SetTag("handler.type", "Wayd.Planning.Application.StoryMaps.Commands.SetChecklistItemCheckedCommandHandler");
                await Wolverine.FluentValidation.Internals.FluentValidationExecutor.ExecuteOne<Wayd.Planning.Application.StoryMaps.Commands.SetChecklistItemCheckedCommand>(setChecklistItemCheckedCommandValidator, _failureActionOfSetChecklistItemCheckedCommand, setChecklistItemCheckedCommand).ConfigureAwait(false);
                var setChecklistItemCheckedCommandHandler = new Wayd.Planning.Application.StoryMaps.Commands.SetChecklistItemCheckedCommandHandler(waydDbContext, storyMapNotifier, _loggerOfSetChecklistItemCheckedCommandHandler);
                
                // The actual message execution
                var outgoing1 = await setChecklistItemCheckedCommandHandler.Handle(setChecklistItemCheckedCommand, cancellation).ConfigureAwait(false);
    ...
    // END: SetChecklistItemCheckedCommandHandler1028864027
