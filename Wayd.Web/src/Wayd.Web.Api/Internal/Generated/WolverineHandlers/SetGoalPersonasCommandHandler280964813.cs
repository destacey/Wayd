...
{
    // START: SetGoalPersonasCommandHandler280964813
    [global::System.CodeDom.Compiler.GeneratedCode("JasperFx", "1.0.0")]
    public sealed class SetGoalPersonasCommandHandler280964813 : Wolverine.Runtime.Handlers.MessageHandler
    {
        ...
        private readonly Microsoft.Extensions.Logging.ILogger<Wayd.Planning.Application.StoryMaps.Commands.SetGoalPersonasCommandHandler> _loggerOfSetGoalPersonasCommandHandler;
        ...
        private readonly Wolverine.FluentValidation.IFailureAction<Wayd.Planning.Application.StoryMaps.Commands.SetGoalPersonasCommand> _failureActionOfSetGoalPersonasCommand;
        private readonly Wolverine.Runtime.IWolverineRuntime _wolverineRuntime;

        public SetGoalPersonasCommandHandler280964813(Microsoft.AspNetCore.Http.IHttpContextAccessor __httpContextAccessor1, Microsoft.AspNetCore.Http.IHttpContextAccessor __httpContextAccessor2, Microsoft.EntityFrameworkCore.DbContextOptions dbContextOptions, Microsoft.Extensions.DependencyInjection.IServiceScopeFactory serviceScopeFactory, Microsoft.Extensions.Logging.ILogger<Wayd.Common.Application.Behaviors.PerformanceBehaviorLog> loggerOfPerformanceBehaviorLog, Microsoft.Extensions.Logging.ILogger<Wayd.Infrastructure.Common.Services.EventPublisher> loggerOfEventPublisher, Microsoft.Extensions.Logging.ILogger<Wayd.Planning.Application.StoryMaps.Commands.SetGoalPersonasCommandHandler> loggerOfSetGoalPersonasCommandHandler, Microsoft.Extensions.Options.IOptions<Wayd.Infrastructure.Persistence.DatabaseSettings> optionsOfDatabaseSettings, System.Collections.Generic.IEnumerable<Wolverine.EntityFrameworkCore.IDomainEventScraper> domainEventScraperIEnumerable, System.TimeProvider timeProvider, Wolverine.FluentValidation.IFailureAction<Wayd.Planning.Application.StoryMaps.Commands.SetGoalPersonasCommand> failureActionOfSetGoalPersonasCommand, Wolverine.Runtime.IWolverineRuntime wolverineRuntime)
        {
            ...
            _loggerOfSetGoalPersonasCommandHandler = loggerOfSetGoalPersonasCommandHandler;
            _optionsOfDatabaseSettings = optionsOfDatabaseSettings;
            _domainEventScraperIEnumerable = domainEventScraperIEnumerable;
            _timeProvider = timeProvider;
            _failureActionOfSetGoalPersonasCommand = failureActionOfSetGoalPersonasCommand;
        ...
        {
            var setGoalPersonasCommandValidator = new Wayd.Planning.Application.StoryMaps.Commands.SetGoalPersonasCommandValidator();
            ...
            var setGoalPersonasCommand = (Wayd.Planning.Application.StoryMaps.Commands.SetGoalPersonasCommand)context.Envelope.Message;
            ...
            try
            {
                System.Diagnostics.Activity.Current?.SetTag("message.handler", "Wayd.Planning.Application.StoryMaps.Commands.SetGoalPersonasCommandHandler");
                System.Diagnostics.Activity.Current?.SetTag("handler.type", "Wayd.Planning.Application.StoryMaps.Commands.SetGoalPersonasCommandHandler");
                await Wolverine.FluentValidation.Internals.FluentValidationExecutor.ExecuteOne<Wayd.Planning.Application.StoryMaps.Commands.SetGoalPersonasCommand>(setGoalPersonasCommandValidator, _failureActionOfSetGoalPersonasCommand, setGoalPersonasCommand).ConfigureAwait(false);
                var setGoalPersonasCommandHandler = new Wayd.Planning.Application.StoryMaps.Commands.SetGoalPersonasCommandHandler(waydDbContext, storyMapNotifier, _loggerOfSetGoalPersonasCommandHandler);
                
                // The actual message execution
                var outgoing1 = await setGoalPersonasCommandHandler.Handle(setGoalPersonasCommand, cancellation).ConfigureAwait(false);
    ...
    // END: SetGoalPersonasCommandHandler280964813
