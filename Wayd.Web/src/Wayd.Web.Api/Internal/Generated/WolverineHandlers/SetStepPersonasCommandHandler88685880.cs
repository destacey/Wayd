...
{
    // START: SetStepPersonasCommandHandler88685880
    [global::System.CodeDom.Compiler.GeneratedCode("JasperFx", "1.0.0")]
    public sealed class SetStepPersonasCommandHandler88685880 : Wolverine.Runtime.Handlers.MessageHandler
    {
        ...
        private readonly Microsoft.Extensions.Logging.ILogger<Wayd.Planning.Application.StoryMaps.Commands.SetStepPersonasCommandHandler> _loggerOfSetStepPersonasCommandHandler;
        ...
        private readonly Wolverine.FluentValidation.IFailureAction<Wayd.Planning.Application.StoryMaps.Commands.SetStepPersonasCommand> _failureActionOfSetStepPersonasCommand;
        private readonly Wolverine.Runtime.IWolverineRuntime _wolverineRuntime;

        public SetStepPersonasCommandHandler88685880(Microsoft.AspNetCore.Http.IHttpContextAccessor __httpContextAccessor1, Microsoft.AspNetCore.Http.IHttpContextAccessor __httpContextAccessor2, Microsoft.EntityFrameworkCore.DbContextOptions dbContextOptions, Microsoft.Extensions.DependencyInjection.IServiceScopeFactory serviceScopeFactory, Microsoft.Extensions.Logging.ILogger<Wayd.Common.Application.Behaviors.PerformanceBehaviorLog> loggerOfPerformanceBehaviorLog, Microsoft.Extensions.Logging.ILogger<Wayd.Infrastructure.Common.Services.EventPublisher> loggerOfEventPublisher, Microsoft.Extensions.Logging.ILogger<Wayd.Planning.Application.StoryMaps.Commands.SetStepPersonasCommandHandler> loggerOfSetStepPersonasCommandHandler, Microsoft.Extensions.Options.IOptions<Wayd.Infrastructure.Persistence.DatabaseSettings> optionsOfDatabaseSettings, System.Collections.Generic.IEnumerable<Wolverine.EntityFrameworkCore.IDomainEventScraper> domainEventScraperIEnumerable, System.TimeProvider timeProvider, Wolverine.FluentValidation.IFailureAction<Wayd.Planning.Application.StoryMaps.Commands.SetStepPersonasCommand> failureActionOfSetStepPersonasCommand, Wolverine.Runtime.IWolverineRuntime wolverineRuntime)
        {
            ...
            _loggerOfSetStepPersonasCommandHandler = loggerOfSetStepPersonasCommandHandler;
            _optionsOfDatabaseSettings = optionsOfDatabaseSettings;
            _domainEventScraperIEnumerable = domainEventScraperIEnumerable;
            _timeProvider = timeProvider;
            _failureActionOfSetStepPersonasCommand = failureActionOfSetStepPersonasCommand;
        ...
        public override async System.Threading.Tasks.Task HandleAsync(Wolverine.Runtime.MessageContext context, System.Threading.CancellationToken cancellation)
        {
            ...
            var setStepPersonasCommandValidator = new Wayd.Planning.Application.StoryMaps.Commands.SetStepPersonasCommandValidator();
            ...
            var setStepPersonasCommand = (Wayd.Planning.Application.StoryMaps.Commands.SetStepPersonasCommand)context.Envelope.Message;
            ...
            try
            {
                System.Diagnostics.Activity.Current?.SetTag("message.handler", "Wayd.Planning.Application.StoryMaps.Commands.SetStepPersonasCommandHandler");
                System.Diagnostics.Activity.Current?.SetTag("handler.type", "Wayd.Planning.Application.StoryMaps.Commands.SetStepPersonasCommandHandler");
                await Wolverine.FluentValidation.Internals.FluentValidationExecutor.ExecuteOne<Wayd.Planning.Application.StoryMaps.Commands.SetStepPersonasCommand>(setStepPersonasCommandValidator, _failureActionOfSetStepPersonasCommand, setStepPersonasCommand).ConfigureAwait(false);
                var setStepPersonasCommandHandler = new Wayd.Planning.Application.StoryMaps.Commands.SetStepPersonasCommandHandler(waydDbContext, storyMapNotifier, _loggerOfSetStepPersonasCommandHandler);
                
                // The actual message execution
                var outgoing1 = await setStepPersonasCommandHandler.Handle(setStepPersonasCommand, cancellation).ConfigureAwait(false);
    ...
    // END: SetStepPersonasCommandHandler88685880
