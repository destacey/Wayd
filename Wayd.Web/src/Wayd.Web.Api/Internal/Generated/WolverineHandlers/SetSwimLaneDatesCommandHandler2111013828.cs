...
{
    // START: SetSwimLaneDatesCommandHandler2111013828
    [global::System.CodeDom.Compiler.GeneratedCode("JasperFx", "1.0.0")]
    public sealed class SetSwimLaneDatesCommandHandler2111013828 : Wolverine.Runtime.Handlers.MessageHandler
    {
        ...
        private readonly Microsoft.Extensions.Logging.ILogger<Wayd.Planning.Application.StoryMaps.Commands.SetSwimLaneDatesCommandHandler> _loggerOfSetSwimLaneDatesCommandHandler;
        ...
        private readonly Wolverine.FluentValidation.IFailureAction<Wayd.Planning.Application.StoryMaps.Commands.SetSwimLaneDatesCommand> _failureActionOfSetSwimLaneDatesCommand;
        private readonly Wolverine.Runtime.IWolverineRuntime _wolverineRuntime;

        public SetSwimLaneDatesCommandHandler2111013828(Microsoft.AspNetCore.Http.IHttpContextAccessor __httpContextAccessor1, Microsoft.AspNetCore.Http.IHttpContextAccessor __httpContextAccessor2, Microsoft.EntityFrameworkCore.DbContextOptions dbContextOptions, Microsoft.Extensions.DependencyInjection.IServiceScopeFactory serviceScopeFactory, Microsoft.Extensions.Logging.ILogger<Wayd.Common.Application.Behaviors.PerformanceBehaviorLog> loggerOfPerformanceBehaviorLog, Microsoft.Extensions.Logging.ILogger<Wayd.Infrastructure.Common.Services.EventPublisher> loggerOfEventPublisher, Microsoft.Extensions.Logging.ILogger<Wayd.Planning.Application.StoryMaps.Commands.SetSwimLaneDatesCommandHandler> loggerOfSetSwimLaneDatesCommandHandler, Microsoft.Extensions.Options.IOptions<Wayd.Infrastructure.Persistence.DatabaseSettings> optionsOfDatabaseSettings, System.Collections.Generic.IEnumerable<Wolverine.EntityFrameworkCore.IDomainEventScraper> domainEventScraperIEnumerable, System.TimeProvider timeProvider, Wolverine.FluentValidation.IFailureAction<Wayd.Planning.Application.StoryMaps.Commands.SetSwimLaneDatesCommand> failureActionOfSetSwimLaneDatesCommand, Wolverine.Runtime.IWolverineRuntime wolverineRuntime)
        {
            ...
            _loggerOfSetSwimLaneDatesCommandHandler = loggerOfSetSwimLaneDatesCommandHandler;
            _optionsOfDatabaseSettings = optionsOfDatabaseSettings;
            _domainEventScraperIEnumerable = domainEventScraperIEnumerable;
            _timeProvider = timeProvider;
            _failureActionOfSetSwimLaneDatesCommand = failureActionOfSetSwimLaneDatesCommand;
        ...
        {
            var setSwimLaneDatesCommandValidator = new Wayd.Planning.Application.StoryMaps.Commands.SetSwimLaneDatesCommandValidator();
            ...
            var setSwimLaneDatesCommand = (Wayd.Planning.Application.StoryMaps.Commands.SetSwimLaneDatesCommand)context.Envelope.Message;
            ...
            try
            {
                System.Diagnostics.Activity.Current?.SetTag("message.handler", "Wayd.Planning.Application.StoryMaps.Commands.SetSwimLaneDatesCommandHandler");
                System.Diagnostics.Activity.Current?.SetTag("handler.type", "Wayd.Planning.Application.StoryMaps.Commands.SetSwimLaneDatesCommandHandler");
                await Wolverine.FluentValidation.Internals.FluentValidationExecutor.ExecuteOne<Wayd.Planning.Application.StoryMaps.Commands.SetSwimLaneDatesCommand>(setSwimLaneDatesCommandValidator, _failureActionOfSetSwimLaneDatesCommand, setSwimLaneDatesCommand).ConfigureAwait(false);
                var setSwimLaneDatesCommandHandler = new Wayd.Planning.Application.StoryMaps.Commands.SetSwimLaneDatesCommandHandler(waydDbContext, storyMapNotifier, _loggerOfSetSwimLaneDatesCommandHandler);
                
                // The actual message execution
                var outgoing1 = await setSwimLaneDatesCommandHandler.Handle(setSwimLaneDatesCommand, cancellation).ConfigureAwait(false);
    ...
    // END: SetSwimLaneDatesCommandHandler2111013828
