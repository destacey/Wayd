...
{
    // START: SetTaskPersonasCommandHandler728553527
    [global::System.CodeDom.Compiler.GeneratedCode("JasperFx", "1.0.0")]
    public sealed class SetTaskPersonasCommandHandler728553527 : Wolverine.Runtime.Handlers.MessageHandler
    {
        ...
        private readonly Microsoft.Extensions.Logging.ILogger<Wayd.Planning.Application.StoryMaps.Commands.SetTaskPersonasCommandHandler> _loggerOfSetTaskPersonasCommandHandler;
        ...
        private readonly Wolverine.FluentValidation.IFailureAction<Wayd.Planning.Application.StoryMaps.Commands.SetTaskPersonasCommand> _failureActionOfSetTaskPersonasCommand;
        private readonly Wolverine.Runtime.IWolverineRuntime _wolverineRuntime;

        public SetTaskPersonasCommandHandler728553527(Microsoft.AspNetCore.Http.IHttpContextAccessor __httpContextAccessor1, Microsoft.AspNetCore.Http.IHttpContextAccessor __httpContextAccessor2, Microsoft.EntityFrameworkCore.DbContextOptions dbContextOptions, Microsoft.Extensions.DependencyInjection.IServiceScopeFactory serviceScopeFactory, Microsoft.Extensions.Logging.ILogger<Wayd.Common.Application.Behaviors.PerformanceBehaviorLog> loggerOfPerformanceBehaviorLog, Microsoft.Extensions.Logging.ILogger<Wayd.Infrastructure.Common.Services.EventPublisher> loggerOfEventPublisher, Microsoft.Extensions.Logging.ILogger<Wayd.Planning.Application.StoryMaps.Commands.SetTaskPersonasCommandHandler> loggerOfSetTaskPersonasCommandHandler, Microsoft.Extensions.Options.IOptions<Wayd.Infrastructure.Persistence.DatabaseSettings> optionsOfDatabaseSettings, System.Collections.Generic.IEnumerable<Wolverine.EntityFrameworkCore.IDomainEventScraper> domainEventScraperIEnumerable, System.TimeProvider timeProvider, Wolverine.FluentValidation.IFailureAction<Wayd.Planning.Application.StoryMaps.Commands.SetTaskPersonasCommand> failureActionOfSetTaskPersonasCommand, Wolverine.Runtime.IWolverineRuntime wolverineRuntime)
        {
            ...
            _loggerOfSetTaskPersonasCommandHandler = loggerOfSetTaskPersonasCommandHandler;
            _optionsOfDatabaseSettings = optionsOfDatabaseSettings;
            _domainEventScraperIEnumerable = domainEventScraperIEnumerable;
            _timeProvider = timeProvider;
            _failureActionOfSetTaskPersonasCommand = failureActionOfSetTaskPersonasCommand;
        ...
        {
            var setTaskPersonasCommandValidator = new Wayd.Planning.Application.StoryMaps.Commands.SetTaskPersonasCommandValidator();
            ...
            var setTaskPersonasCommand = (Wayd.Planning.Application.StoryMaps.Commands.SetTaskPersonasCommand)context.Envelope.Message;
            ...
            try
            {
                System.Diagnostics.Activity.Current?.SetTag("message.handler", "Wayd.Planning.Application.StoryMaps.Commands.SetTaskPersonasCommandHandler");
                System.Diagnostics.Activity.Current?.SetTag("handler.type", "Wayd.Planning.Application.StoryMaps.Commands.SetTaskPersonasCommandHandler");
                await Wolverine.FluentValidation.Internals.FluentValidationExecutor.ExecuteOne<Wayd.Planning.Application.StoryMaps.Commands.SetTaskPersonasCommand>(setTaskPersonasCommandValidator, _failureActionOfSetTaskPersonasCommand, setTaskPersonasCommand).ConfigureAwait(false);
                var setTaskPersonasCommandHandler = new Wayd.Planning.Application.StoryMaps.Commands.SetTaskPersonasCommandHandler(waydDbContext, storyMapNotifier, _loggerOfSetTaskPersonasCommandHandler);
                
                // The actual message execution
                var outgoing1 = await setTaskPersonasCommandHandler.Handle(setTaskPersonasCommand, cancellation).ConfigureAwait(false);
    ...
    // END: SetTaskPersonasCommandHandler728553527
