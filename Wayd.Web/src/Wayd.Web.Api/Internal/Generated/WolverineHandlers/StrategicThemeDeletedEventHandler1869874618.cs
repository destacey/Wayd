...
{
    // START: StrategicThemeDeletedEventHandler1869874618
    [global::System.CodeDom.Compiler.GeneratedCode("JasperFx", "1.0.0")]
    public sealed class StrategicThemeDeletedEventHandler1869874618 : Wolverine.Runtime.Handlers.MessageHandler
    {
        ...
        private readonly Microsoft.Extensions.Logging.ILogger<Wayd.ProjectPortfolioManagement.Application.StrategicThemes.EventHandlers.StrategicThemeChangedHandler> _loggerOfStrategicThemeChangedHandler;
        ...
        public StrategicThemeDeletedEventHandler1869874618(Microsoft.AspNetCore.Http.IHttpContextAccessor __httpContextAccessor1, Microsoft.AspNetCore.Http.IHttpContextAccessor __httpContextAccessor2, Microsoft.EntityFrameworkCore.DbContextOptions dbContextOptions, Microsoft.Extensions.DependencyInjection.IServiceScopeFactory serviceScopeFactory, Microsoft.Extensions.Logging.ILogger<Wayd.Common.Application.Behaviors.PerformanceBehaviorLog> loggerOfPerformanceBehaviorLog, Microsoft.Extensions.Logging.ILogger<Wayd.Infrastructure.Common.Services.EventPublisher> loggerOfEventPublisher, Microsoft.Extensions.Logging.ILogger<Wayd.ProjectPortfolioManagement.Application.StrategicThemes.EventHandlers.StrategicThemeChangedHandler> loggerOfStrategicThemeChangedHandler, Microsoft.Extensions.Options.IOptions<Wayd.Infrastructure.Persistence.DatabaseSettings> optionsOfDatabaseSettings, System.Collections.Generic.IEnumerable<Wolverine.EntityFrameworkCore.IDomainEventScraper> domainEventScraperIEnumerable, System.TimeProvider timeProvider, Wolverine.Runtime.IWolverineRuntime wolverineRuntime)
        {
            ...
            _loggerOfStrategicThemeChangedHandler = loggerOfStrategicThemeChangedHandler;
        ...
        public override async System.Threading.Tasks.Task HandleAsync(Wolverine.Runtime.MessageContext context, System.Threading.CancellationToken cancellation)
        {
            ...
            var strategicThemeDeletedEvent = (Wayd.Common.Domain.Events.StrategicManagement.StrategicThemeDeletedEvent)context.Envelope.Message;
            ...
            try
            {
                System.Diagnostics.Activity.Current?.SetTag("message.handler", "Wayd.ProjectPortfolioManagement.Application.StrategicThemes.EventHandlers.StrategicThemeChangedHandler");
                System.Diagnostics.Activity.Current?.SetTag("handler.type", "Wayd.ProjectPortfolioManagement.Application.StrategicThemes.EventHandlers.StrategicThemeChangedHandler");
                var strategicThemeChangedHandler = new Wayd.ProjectPortfolioManagement.Application.StrategicThemes.EventHandlers.StrategicThemeChangedHandler(waydDbContext, _loggerOfStrategicThemeChangedHandler);
                
                // The actual message execution
                await strategicThemeChangedHandler.Handle(strategicThemeDeletedEvent, cancellation).ConfigureAwait(false);
    ...
    // END: StrategicThemeDeletedEventHandler1869874618
