...
namespace Internal.Generated.WolverineHandlers
{
    ...
    public sealed class SyncExternalWorkStatusesCommandHandler1340767516 : Wolverine.Runtime.Handlers.MessageHandler
    {
        ...
        public SyncExternalWorkStatusesCommandHandler1340767516(Microsoft.AspNetCore.Http.IHttpContextAccessor __httpContextAccessor1, Microsoft.AspNetCore.Http.IHttpContextAccessor __httpContextAccessor2, Microsoft.EntityFrameworkCore.DbContextOptions dbContextOptions, Microsoft.Extensions.DependencyInjection.IServiceScopeFactory serviceScopeFactory, Microsoft.Extensions.Logging.ILogger<Wayd.Common.Application.Behaviors.PerformanceBehaviorLog> loggerOfPerformanceBehaviorLog, Microsoft.Extensions.Logging.ILogger<Wayd.Infrastructure.Common.Services.EventPublisher> loggerOfEventPublisher, Microsoft.Extensions.Logging.ILogger<Wayd.Work.Application.WorkStatuses.Commands.SyncExternalWorkStatusesCommandHandler> loggerOfSyncExternalWorkStatusesCommandHandler, Microsoft.Extensions.Options.IOptions<Wayd.Infrastructure.Persistence.DatabaseSettings> optionsOfDatabaseSettings, System.Collections.Generic.IEnumerable<Wolverine.EntityFrameworkCore.IDomainEventScraper> domainEventScraperIEnumerable, System.TimeProvider timeProvider, Wolverine.FluentValidation.IFailureAction<Wayd.Common.Application.Requests.WorkManagement.Commands.SyncExternalWorkStatusesCommand> failureActionOfSyncExternalWorkStatusesCommand, Wolverine.Runtime.IWolverineRuntime wolverineRuntime)
        {
        ...
        {
            var syncExternalWorkStatusesCommandValidator = new Wayd.Common.Application.Requests.WorkManagement.Commands.SyncExternalWorkStatusesCommandValidator();
            ...
            try
            {
                ...
                await Wolverine.FluentValidation.Internals.FluentValidationExecutor.ExecuteOne<Wayd.Common.Application.Requests.WorkManagement.Commands.SyncExternalWorkStatusesCommand>(syncExternalWorkStatusesCommandValidator, _failureActionOfSyncExternalWorkStatusesCommand, syncExternalWorkStatusesCommand).ConfigureAwait(false);
                var syncExternalWorkStatusesCommandHandler = new Wayd.Work.Application.WorkStatuses.Commands.SyncExternalWorkStatusesCommandHandler(waydDbContext, dateTimeProvider, _loggerOfSyncExternalWorkStatusesCommandHandler);
