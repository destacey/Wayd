...
{
    // START: SyncTeamMembershipEdgesCommandHandler775818719
    [global::System.CodeDom.Compiler.GeneratedCode("JasperFx", "1.0.0")]
    public sealed class SyncTeamMembershipEdgesCommandHandler775818719 : Wolverine.Runtime.Handlers.MessageHandler
    {
        ...
        private readonly Microsoft.Extensions.Logging.ILogger<Wayd.Organization.Application.Teams.Commands.SyncTeamMembershipEdgesCommandHandler> _loggerOfSyncTeamMembershipEdgesCommandHandler;
        ...
        public SyncTeamMembershipEdgesCommandHandler775818719(Microsoft.AspNetCore.Http.IHttpContextAccessor __httpContextAccessor1, Microsoft.AspNetCore.Http.IHttpContextAccessor __httpContextAccessor2, Microsoft.EntityFrameworkCore.DbContextOptions dbContextOptions, Microsoft.Extensions.DependencyInjection.IServiceScopeFactory serviceScopeFactory, Microsoft.Extensions.Logging.ILogger<Wayd.Common.Application.Behaviors.PerformanceBehaviorLog> loggerOfPerformanceBehaviorLog, Microsoft.Extensions.Logging.ILogger<Wayd.Infrastructure.Common.Services.EventPublisher> loggerOfEventPublisher, Microsoft.Extensions.Logging.ILogger<Wayd.Organization.Application.Teams.Commands.SyncTeamMembershipEdgesCommandHandler> loggerOfSyncTeamMembershipEdgesCommandHandler, Microsoft.Extensions.Options.IOptions<Wayd.Infrastructure.Persistence.DatabaseSettings> optionsOfDatabaseSettings, System.Collections.Generic.IEnumerable<Wolverine.EntityFrameworkCore.IDomainEventScraper> domainEventScraperIEnumerable, System.TimeProvider timeProvider, Wolverine.Runtime.IWolverineRuntime wolverineRuntime)
        {
            ...
            _loggerOfSyncTeamMembershipEdgesCommandHandler = loggerOfSyncTeamMembershipEdgesCommandHandler;
        ...
        public override async System.Threading.Tasks.Task HandleAsync(Wolverine.Runtime.MessageContext context, System.Threading.CancellationToken cancellation)
        {
            ...
            var syncTeamMembershipEdgesCommand = (Wayd.Organization.Application.Teams.Commands.SyncTeamMembershipEdgesCommand)context.Envelope.Message;
            ...
            try
            {
                System.Diagnostics.Activity.Current?.SetTag("message.handler", "Wayd.Organization.Application.Teams.Commands.SyncTeamMembershipEdgesCommandHandler");
                System.Diagnostics.Activity.Current?.SetTag("handler.type", "Wayd.Organization.Application.Teams.Commands.SyncTeamMembershipEdgesCommandHandler");
                var syncTeamMembershipEdgesCommandHandler = new Wayd.Organization.Application.Teams.Commands.SyncTeamMembershipEdgesCommandHandler(waydDbContext, _loggerOfSyncTeamMembershipEdgesCommandHandler);
                
                // The actual message execution
                var outgoing1 = await syncTeamMembershipEdgesCommandHandler.Handle(syncTeamMembershipEdgesCommand, cancellation).ConfigureAwait(false);
    ...
    // END: SyncTeamMembershipEdgesCommandHandler775818719
