...
{
    // START: SyncTeamNodesCommandHandler872819514
    [global::System.CodeDom.Compiler.GeneratedCode("JasperFx", "1.0.0")]
    public sealed class SyncTeamNodesCommandHandler872819514 : Wolverine.Runtime.Handlers.MessageHandler
    {
        ...
        private readonly Microsoft.Extensions.Logging.ILogger<Wayd.Organization.Application.Teams.Commands.SyncTeamNodesCommandHandler> _loggerOfSyncTeamNodesCommandHandler;
        ...
        public SyncTeamNodesCommandHandler872819514(Microsoft.AspNetCore.Http.IHttpContextAccessor __httpContextAccessor1, Microsoft.AspNetCore.Http.IHttpContextAccessor __httpContextAccessor2, Microsoft.EntityFrameworkCore.DbContextOptions dbContextOptions, Microsoft.Extensions.DependencyInjection.IServiceScopeFactory serviceScopeFactory, Microsoft.Extensions.Logging.ILogger<Wayd.Common.Application.Behaviors.PerformanceBehaviorLog> loggerOfPerformanceBehaviorLog, Microsoft.Extensions.Logging.ILogger<Wayd.Infrastructure.Common.Services.EventPublisher> loggerOfEventPublisher, Microsoft.Extensions.Logging.ILogger<Wayd.Organization.Application.Teams.Commands.SyncTeamNodesCommandHandler> loggerOfSyncTeamNodesCommandHandler, Microsoft.Extensions.Options.IOptions<Wayd.Infrastructure.Persistence.DatabaseSettings> optionsOfDatabaseSettings, System.Collections.Generic.IEnumerable<Wolverine.EntityFrameworkCore.IDomainEventScraper> domainEventScraperIEnumerable, System.TimeProvider timeProvider, Wolverine.Runtime.IWolverineRuntime wolverineRuntime)
        {
            ...
            _loggerOfSyncTeamNodesCommandHandler = loggerOfSyncTeamNodesCommandHandler;
        ...
        public override async System.Threading.Tasks.Task HandleAsync(Wolverine.Runtime.MessageContext context, System.Threading.CancellationToken cancellation)
        {
            ...
            var syncTeamNodesCommand = (Wayd.Organization.Application.Teams.Commands.SyncTeamNodesCommand)context.Envelope.Message;
            ...
            try
            {
                System.Diagnostics.Activity.Current?.SetTag("message.handler", "Wayd.Organization.Application.Teams.Commands.SyncTeamNodesCommandHandler");
                System.Diagnostics.Activity.Current?.SetTag("handler.type", "Wayd.Organization.Application.Teams.Commands.SyncTeamNodesCommandHandler");
                var syncTeamNodesCommandHandler = new Wayd.Organization.Application.Teams.Commands.SyncTeamNodesCommandHandler(waydDbContext, _loggerOfSyncTeamNodesCommandHandler);
                
                // The actual message execution
                var outgoing1 = await syncTeamNodesCommandHandler.Handle(syncTeamNodesCommand, cancellation).ConfigureAwait(false);
    ...
    // END: SyncTeamNodesCommandHandler872819514
