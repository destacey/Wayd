...
{
    // START: SyncWorkProjectsCommandHandler691771598
    [global::System.CodeDom.Compiler.GeneratedCode("JasperFx", "1.0.0")]
    public sealed class SyncWorkProjectsCommandHandler691771598 : Wolverine.Runtime.Handlers.MessageHandler
    {
        ...
        private readonly Microsoft.Extensions.Logging.ILogger<Wayd.Work.Application.WorkProjects.Commands.SyncWorkProjectsCommandHandler> _loggerOfSyncWorkProjectsCommandHandler;
        ...
        public SyncWorkProjectsCommandHandler691771598(Microsoft.AspNetCore.Http.IHttpContextAccessor __httpContextAccessor1, Microsoft.AspNetCore.Http.IHttpContextAccessor __httpContextAccessor2, Microsoft.EntityFrameworkCore.DbContextOptions dbContextOptions, Microsoft.Extensions.DependencyInjection.IServiceScopeFactory serviceScopeFactory, Microsoft.Extensions.Logging.ILogger<Wayd.Common.Application.Behaviors.PerformanceBehaviorLog> loggerOfPerformanceBehaviorLog, Microsoft.Extensions.Logging.ILogger<Wayd.Infrastructure.Common.Services.EventPublisher> loggerOfEventPublisher, Microsoft.Extensions.Logging.ILogger<Wayd.Work.Application.WorkProjects.Commands.SyncWorkProjectsCommandHandler> loggerOfSyncWorkProjectsCommandHandler, Microsoft.Extensions.Options.IOptions<Wayd.Infrastructure.Persistence.DatabaseSettings> optionsOfDatabaseSettings, System.Collections.Generic.IEnumerable<Wolverine.EntityFrameworkCore.IDomainEventScraper> domainEventScraperIEnumerable, System.TimeProvider timeProvider, Wolverine.Runtime.IWolverineRuntime wolverineRuntime)
        {
            ...
            _loggerOfSyncWorkProjectsCommandHandler = loggerOfSyncWorkProjectsCommandHandler;
        ...
        public override async System.Threading.Tasks.Task HandleAsync(Wolverine.Runtime.MessageContext context, System.Threading.CancellationToken cancellation)
        {
            ...
            var syncWorkProjectsCommand = (Wayd.Work.Application.WorkProjects.Commands.SyncWorkProjectsCommand)context.Envelope.Message;
            ...
            try
            {
                System.Diagnostics.Activity.Current?.SetTag("message.handler", "Wayd.Work.Application.WorkProjects.Commands.SyncWorkProjectsCommandHandler");
                System.Diagnostics.Activity.Current?.SetTag("handler.type", "Wayd.Work.Application.WorkProjects.Commands.SyncWorkProjectsCommandHandler");
                var syncWorkProjectsCommandHandler = new Wayd.Work.Application.WorkProjects.Commands.SyncWorkProjectsCommandHandler(waydDbContext, _loggerOfSyncWorkProjectsCommandHandler);
                
                // The actual message execution
                var outgoing1 = await syncWorkProjectsCommandHandler.Handle(syncWorkProjectsCommand, cancellation).ConfigureAwait(false);
    ...
    // END: SyncWorkProjectsCommandHandler691771598
