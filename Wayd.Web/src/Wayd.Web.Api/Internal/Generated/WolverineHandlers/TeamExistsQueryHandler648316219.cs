...
{
    // START: TeamExistsQueryHandler648316219
    [global::System.CodeDom.Compiler.GeneratedCode("JasperFx", "1.0.0")]
    public sealed class TeamExistsQueryHandler648316219 : Wolverine.Runtime.Handlers.MessageHandler
    {
        ...
        private readonly Microsoft.Extensions.Logging.ILogger<Wayd.Organization.Application.Teams.Queries.TeamExistsQueryHandler> _loggerOfTeamExistsQueryHandler;
        ...
        public TeamExistsQueryHandler648316219(Microsoft.AspNetCore.Http.IHttpContextAccessor __httpContextAccessor1, Microsoft.AspNetCore.Http.IHttpContextAccessor __httpContextAccessor2, Microsoft.EntityFrameworkCore.DbContextOptions dbContextOptions, Microsoft.Extensions.DependencyInjection.IServiceScopeFactory serviceScopeFactory, Microsoft.Extensions.Logging.ILogger<Wayd.Common.Application.Behaviors.PerformanceBehaviorLog> loggerOfPerformanceBehaviorLog, Microsoft.Extensions.Logging.ILogger<Wayd.Infrastructure.Common.Services.EventPublisher> loggerOfEventPublisher, Microsoft.Extensions.Logging.ILogger<Wayd.Organization.Application.Teams.Queries.TeamExistsQueryHandler> loggerOfTeamExistsQueryHandler, Microsoft.Extensions.Options.IOptions<Wayd.Infrastructure.Persistence.DatabaseSettings> optionsOfDatabaseSettings, System.Collections.Generic.IEnumerable<Wolverine.EntityFrameworkCore.IDomainEventScraper> domainEventScraperIEnumerable, System.TimeProvider timeProvider, Wolverine.Runtime.IWolverineRuntime wolverineRuntime)
        {
            ...
            _loggerOfTeamExistsQueryHandler = loggerOfTeamExistsQueryHandler;
        ...
        public override async System.Threading.Tasks.Task HandleAsync(Wolverine.Runtime.MessageContext context, System.Threading.CancellationToken cancellation)
        {
            ...
            var teamExistsQuery = (Wayd.Organization.Application.Teams.Queries.TeamExistsQuery)context.Envelope.Message;
            ...
            try
            {
                System.Diagnostics.Activity.Current?.SetTag("message.handler", "Wayd.Organization.Application.Teams.Queries.TeamExistsQueryHandler");
                System.Diagnostics.Activity.Current?.SetTag("handler.type", "Wayd.Organization.Application.Teams.Queries.TeamExistsQueryHandler");
                var teamExistsQueryHandler = new Wayd.Organization.Application.Teams.Queries.TeamExistsQueryHandler(waydDbContext, _loggerOfTeamExistsQueryHandler);
                
                // The actual message execution
                var outgoing1 = await teamExistsQueryHandler.Handle(teamExistsQuery, cancellation).ConfigureAwait(false);
    ...
    // END: TeamExistsQueryHandler648316219
