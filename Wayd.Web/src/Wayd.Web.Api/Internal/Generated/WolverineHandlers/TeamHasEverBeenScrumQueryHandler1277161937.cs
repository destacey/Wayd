...
{
    // START: TeamHasEverBeenScrumQueryHandler1277161937
    [global::System.CodeDom.Compiler.GeneratedCode("JasperFx", "1.0.0")]
    public sealed class TeamHasEverBeenScrumQueryHandler1277161937 : Wolverine.Runtime.Handlers.MessageHandler
    {
        ...
        public override async System.Threading.Tasks.Task HandleAsync(Wolverine.Runtime.MessageContext context, System.Threading.CancellationToken cancellation)
        {
            ...
            var teamHasEverBeenScrumQuery = (Wayd.Organization.Application.Teams.Queries.TeamHasEverBeenScrumQuery)context.Envelope.Message;
            ...
            try
            {
                System.Diagnostics.Activity.Current?.SetTag("message.handler", "Wayd.Organization.Application.Teams.Queries.TeamHasEverBeenScrumQueryHandler");
                System.Diagnostics.Activity.Current?.SetTag("handler.type", "Wayd.Organization.Application.Teams.Queries.TeamHasEverBeenScrumQueryHandler");
                var teamHasEverBeenScrumQueryHandler = new Wayd.Organization.Application.Teams.Queries.TeamHasEverBeenScrumQueryHandler(waydDbContext);
                
                // The actual message execution
                var outgoing1 = await teamHasEverBeenScrumQueryHandler.Handle(teamHasEverBeenScrumQuery, cancellation).ConfigureAwait(false);
    ...
    // END: TeamHasEverBeenScrumQueryHandler1277161937
