...
{
    // START: UnlinkWorkItemCommandHandler229653610
    [global::System.CodeDom.Compiler.GeneratedCode("JasperFx", "1.0.0")]
    public sealed class UnlinkWorkItemCommandHandler229653610 : Wolverine.Runtime.Handlers.MessageHandler
    {
        ...
        private readonly Microsoft.Extensions.Logging.ILogger<Wayd.Planning.Application.StoryMaps.Commands.UnlinkWorkItemCommandHandler> _loggerOfUnlinkWorkItemCommandHandler;
        ...
        private readonly Wolverine.FluentValidation.IFailureAction<Wayd.Planning.Application.StoryMaps.Commands.UnlinkWorkItemCommand> _failureActionOfUnlinkWorkItemCommand;
        private readonly Wolverine.Runtime.IWolverineRuntime _wolverineRuntime;

        public UnlinkWorkItemCommandHandler229653610(Microsoft.AspNetCore.Http.IHttpContextAccessor __httpContextAccessor1, Microsoft.AspNetCore.Http.IHttpContextAccessor __httpContextAccessor2, Microsoft.EntityFrameworkCore.DbContextOptions dbContextOptions, Microsoft.Extensions.DependencyInjection.IServiceScopeFactory serviceScopeFactory, Microsoft.Extensions.Logging.ILogger<Wayd.Common.Application.Behaviors.PerformanceBehaviorLog> loggerOfPerformanceBehaviorLog, Microsoft.Extensions.Logging.ILogger<Wayd.Infrastructure.Common.Services.EventPublisher> loggerOfEventPublisher, Microsoft.Extensions.Logging.ILogger<Wayd.Planning.Application.StoryMaps.Commands.UnlinkWorkItemCommandHandler> loggerOfUnlinkWorkItemCommandHandler, Microsoft.Extensions.Options.IOptions<Wayd.Infrastructure.Persistence.DatabaseSettings> optionsOfDatabaseSettings, System.Collections.Generic.IEnumerable<Wolverine.EntityFrameworkCore.IDomainEventScraper> domainEventScraperIEnumerable, System.TimeProvider timeProvider, Wolverine.FluentValidation.IFailureAction<Wayd.Planning.Application.StoryMaps.Commands.UnlinkWorkItemCommand> failureActionOfUnlinkWorkItemCommand, Wolverine.Runtime.IWolverineRuntime wolverineRuntime)
        {
            ...
            _loggerOfUnlinkWorkItemCommandHandler = loggerOfUnlinkWorkItemCommandHandler;
            _optionsOfDatabaseSettings = optionsOfDatabaseSettings;
            _domainEventScraperIEnumerable = domainEventScraperIEnumerable;
            _timeProvider = timeProvider;
            _failureActionOfUnlinkWorkItemCommand = failureActionOfUnlinkWorkItemCommand;
        ...
        public override async System.Threading.Tasks.Task HandleAsync(Wolverine.Runtime.MessageContext context, System.Threading.CancellationToken cancellation)
        {
            ...
            var unlinkWorkItemCommandValidator = new Wayd.Planning.Application.StoryMaps.Commands.UnlinkWorkItemCommandValidator();
            var systemTextJsonService = new Wayd.Infrastructure.Common.Services.SystemTextJsonService();
            // The actual message body
            var unlinkWorkItemCommand = (Wayd.Planning.Application.StoryMaps.Commands.UnlinkWorkItemCommand)context.Envelope.Message;
            ...
            try
            {
                System.Diagnostics.Activity.Current?.SetTag("message.handler", "Wayd.Planning.Application.StoryMaps.Commands.UnlinkWorkItemCommandHandler");
                System.Diagnostics.Activity.Current?.SetTag("handler.type", "Wayd.Planning.Application.StoryMaps.Commands.UnlinkWorkItemCommandHandler");
                await Wolverine.FluentValidation.Internals.FluentValidationExecutor.ExecuteOne<Wayd.Planning.Application.StoryMaps.Commands.UnlinkWorkItemCommand>(unlinkWorkItemCommandValidator, _failureActionOfUnlinkWorkItemCommand, unlinkWorkItemCommand).ConfigureAwait(false);
                var unlinkWorkItemCommandHandler = new Wayd.Planning.Application.StoryMaps.Commands.UnlinkWorkItemCommandHandler(waydDbContext, storyMapNotifier, _loggerOfUnlinkWorkItemCommandHandler);
                
                // The actual message execution
                var outgoing1 = await unlinkWorkItemCommandHandler.Handle(unlinkWorkItemCommand, cancellation).ConfigureAwait(false);
    ...
    // END: UnlinkWorkItemCommandHandler229653610
