...
namespace Internal.Generated.WolverineHandlers
{
    ...
    public sealed class UpdateExternalWorkProcessCommandHandler1660798403 : Wolverine.Runtime.Handlers.MessageHandler
    {
        ...
        public UpdateExternalWorkProcessCommandHandler1660798403(Microsoft.AspNetCore.Http.IHttpContextAccessor __httpContextAccessor1, Microsoft.AspNetCore.Http.IHttpContextAccessor __httpContextAccessor2, Microsoft.EntityFrameworkCore.DbContextOptions dbContextOptions, Microsoft.Extensions.DependencyInjection.IServiceScopeFactory serviceScopeFactory, Microsoft.Extensions.Logging.ILogger<Wayd.Common.Application.Behaviors.PerformanceBehaviorLog> loggerOfPerformanceBehaviorLog, Microsoft.Extensions.Logging.ILogger<Wayd.Infrastructure.Common.Services.EventPublisher> loggerOfEventPublisher, Microsoft.Extensions.Logging.ILogger<Wayd.Work.Application.WorkProcesses.Commands.UpdateExternalWorkProcessCommandHandler> loggerOfUpdateExternalWorkProcessCommandHandler, Microsoft.Extensions.Options.IOptions<Wayd.Infrastructure.Persistence.DatabaseSettings> optionsOfDatabaseSettings, System.Collections.Generic.IEnumerable<Wolverine.EntityFrameworkCore.IDomainEventScraper> domainEventScraperIEnumerable, System.TimeProvider timeProvider, Wolverine.FluentValidation.IFailureAction<Wayd.Common.Application.Requests.WorkManagement.Commands.UpdateExternalWorkProcessCommand> failureActionOfUpdateExternalWorkProcessCommand, Wolverine.Runtime.IWolverineRuntime wolverineRuntime)
        {
        ...
        {
            var updateExternalWorkProcessCommandValidator = new Wayd.Common.Application.Requests.WorkManagement.Commands.UpdateExternalWorkProcessCommandValidator();
            ...
            try
            {
                ...
                await Wolverine.FluentValidation.Internals.FluentValidationExecutor.ExecuteOne<Wayd.Common.Application.Requests.WorkManagement.Commands.UpdateExternalWorkProcessCommand>(updateExternalWorkProcessCommandValidator, _failureActionOfUpdateExternalWorkProcessCommand, updateExternalWorkProcessCommand).ConfigureAwait(false);
                var updateExternalWorkProcessCommandHandler = new Wayd.Work.Application.WorkProcesses.Commands.UpdateExternalWorkProcessCommandHandler(waydDbContext, dateTimeProvider, _loggerOfUpdateExternalWorkProcessCommandHandler);
