...
namespace Internal.Generated.WolverineHandlers
{
    ...
    public sealed class UpdateFeatureFlagCommandHandler1786218659 : Wolverine.Runtime.Handlers.MessageHandler
    {
        ...
        public UpdateFeatureFlagCommandHandler1786218659(Microsoft.AspNetCore.Http.IHttpContextAccessor __httpContextAccessor1, Microsoft.AspNetCore.Http.IHttpContextAccessor __httpContextAccessor2, Microsoft.EntityFrameworkCore.DbContextOptions dbContextOptions, Microsoft.Extensions.DependencyInjection.IServiceScopeFactory serviceScopeFactory, Microsoft.Extensions.Logging.ILogger<Wayd.Common.Application.Behaviors.PerformanceBehaviorLog> loggerOfPerformanceBehaviorLog, Microsoft.Extensions.Logging.ILogger<Wayd.Common.Application.FeatureManagement.Commands.UpdateFeatureFlagCommandHandler> loggerOfUpdateFeatureFlagCommandHandler, Microsoft.Extensions.Logging.ILogger<Wayd.Infrastructure.Common.Services.EventPublisher> loggerOfEventPublisher, Microsoft.Extensions.Options.IOptions<Wayd.Infrastructure.Persistence.DatabaseSettings> optionsOfDatabaseSettings, System.Collections.Generic.IEnumerable<Wolverine.EntityFrameworkCore.IDomainEventScraper> domainEventScraperIEnumerable, System.TimeProvider timeProvider, Wolverine.FluentValidation.IFailureAction<Wayd.Common.Application.FeatureManagement.Commands.UpdateFeatureFlagCommand> failureActionOfUpdateFeatureFlagCommand, Wolverine.Runtime.IWolverineRuntime wolverineRuntime)
        {
        ...
        public override async System.Threading.Tasks.Task HandleAsync(Wolverine.Runtime.MessageContext context, System.Threading.CancellationToken cancellation)
        {
            ...
            try
            {
                ...
                await Wolverine.FluentValidation.Internals.FluentValidationExecutor.ExecuteOne<Wayd.Common.Application.FeatureManagement.Commands.UpdateFeatureFlagCommand>(updateFeatureFlagCommandValidator, _failureActionOfUpdateFeatureFlagCommand, updateFeatureFlagCommand).ConfigureAwait(false);
                var updateFeatureFlagCommandHandler = new Wayd.Common.Application.FeatureManagement.Commands.UpdateFeatureFlagCommandHandler(waydDbContext, _loggerOfUpdateFeatureFlagCommandHandler);
