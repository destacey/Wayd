...
{
    // START: UpdatePersonaCommandHandler1734691164
    [global::System.CodeDom.Compiler.GeneratedCode("JasperFx", "1.0.0")]
    public sealed class UpdatePersonaCommandHandler1734691164 : Wolverine.Runtime.Handlers.MessageHandler
    {
        ...
        private readonly Microsoft.Extensions.Logging.ILogger<Wayd.Planning.Application.StoryMaps.Commands.UpdatePersonaCommandHandler> _loggerOfUpdatePersonaCommandHandler;
        ...
        private readonly Wolverine.FluentValidation.IFailureAction<Wayd.Planning.Application.StoryMaps.Commands.UpdatePersonaCommand> _failureActionOfUpdatePersonaCommand;
        private readonly Wolverine.Runtime.IWolverineRuntime _wolverineRuntime;

        public UpdatePersonaCommandHandler1734691164(Microsoft.AspNetCore.Http.IHttpContextAccessor __httpContextAccessor1, Microsoft.AspNetCore.Http.IHttpContextAccessor __httpContextAccessor2, Microsoft.EntityFrameworkCore.DbContextOptions dbContextOptions, Microsoft.Extensions.DependencyInjection.IServiceScopeFactory serviceScopeFactory, Microsoft.Extensions.Logging.ILogger<Wayd.Common.Application.Behaviors.PerformanceBehaviorLog> loggerOfPerformanceBehaviorLog, Microsoft.Extensions.Logging.ILogger<Wayd.Infrastructure.Common.Services.EventPublisher> loggerOfEventPublisher, Microsoft.Extensions.Logging.ILogger<Wayd.Planning.Application.StoryMaps.Commands.UpdatePersonaCommandHandler> loggerOfUpdatePersonaCommandHandler, Microsoft.Extensions.Options.IOptions<Wayd.Infrastructure.Persistence.DatabaseSettings> optionsOfDatabaseSettings, System.Collections.Generic.IEnumerable<Wolverine.EntityFrameworkCore.IDomainEventScraper> domainEventScraperIEnumerable, System.TimeProvider timeProvider, Wolverine.FluentValidation.IFailureAction<Wayd.Planning.Application.StoryMaps.Commands.UpdatePersonaCommand> failureActionOfUpdatePersonaCommand, Wolverine.Runtime.IWolverineRuntime wolverineRuntime)
        {
            ...
            _loggerOfUpdatePersonaCommandHandler = loggerOfUpdatePersonaCommandHandler;
            _optionsOfDatabaseSettings = optionsOfDatabaseSettings;
            _domainEventScraperIEnumerable = domainEventScraperIEnumerable;
            _timeProvider = timeProvider;
            _failureActionOfUpdatePersonaCommand = failureActionOfUpdatePersonaCommand;
        ...
        {
            var updatePersonaCommandValidator = new Wayd.Planning.Application.StoryMaps.Commands.UpdatePersonaCommandValidator();
            ...
            var updatePersonaCommand = (Wayd.Planning.Application.StoryMaps.Commands.UpdatePersonaCommand)context.Envelope.Message;
            ...
            try
            {
                System.Diagnostics.Activity.Current?.SetTag("message.handler", "Wayd.Planning.Application.StoryMaps.Commands.UpdatePersonaCommandHandler");
                System.Diagnostics.Activity.Current?.SetTag("handler.type", "Wayd.Planning.Application.StoryMaps.Commands.UpdatePersonaCommandHandler");
                await Wolverine.FluentValidation.Internals.FluentValidationExecutor.ExecuteOne<Wayd.Planning.Application.StoryMaps.Commands.UpdatePersonaCommand>(updatePersonaCommandValidator, _failureActionOfUpdatePersonaCommand, updatePersonaCommand).ConfigureAwait(false);
                var updatePersonaCommandHandler = new Wayd.Planning.Application.StoryMaps.Commands.UpdatePersonaCommandHandler(waydDbContext, storyMapNotifier, _loggerOfUpdatePersonaCommandHandler);
                
                // The actual message execution
                var outgoing1 = await updatePersonaCommandHandler.Handle(updatePersonaCommand, cancellation).ConfigureAwait(false);
    ...
    // END: UpdatePersonaCommandHandler1734691164
