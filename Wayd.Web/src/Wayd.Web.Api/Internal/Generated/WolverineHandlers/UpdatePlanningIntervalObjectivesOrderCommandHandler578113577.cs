...
namespace Internal.Generated.WolverineHandlers
{
    ...
    public sealed class UpdatePlanningIntervalObjectivesOrderCommandHandler578113577 : Wolverine.Runtime.Handlers.MessageHandler
    {
        ...
        public UpdatePlanningIntervalObjectivesOrderCommandHandler578113577(Microsoft.AspNetCore.Http.IHttpContextAccessor __httpContextAccessor1, Microsoft.AspNetCore.Http.IHttpContextAccessor __httpContextAccessor2, Microsoft.EntityFrameworkCore.DbContextOptions dbContextOptions, Microsoft.Extensions.DependencyInjection.IServiceScopeFactory serviceScopeFactory, Microsoft.Extensions.Logging.ILogger<Wayd.Common.Application.Behaviors.PerformanceBehaviorLog> loggerOfPerformanceBehaviorLog, Microsoft.Extensions.Logging.ILogger<Wayd.Infrastructure.Common.Services.EventPublisher> loggerOfEventPublisher, Microsoft.Extensions.Logging.ILogger<Wayd.Planning.Application.PlanningIntervals.Commands.UpdatePlanningIntervalObjectivesOrderCommandHandler> loggerOfUpdatePlanningIntervalObjectivesOrderCommandHandler, Microsoft.Extensions.Options.IOptions<Wayd.Infrastructure.Persistence.DatabaseSettings> optionsOfDatabaseSettings, System.Collections.Generic.IEnumerable<Wolverine.EntityFrameworkCore.IDomainEventScraper> domainEventScraperIEnumerable, System.TimeProvider timeProvider, Wolverine.FluentValidation.IFailureAction<Wayd.Planning.Application.PlanningIntervals.Commands.UpdatePlanningIntervalObjectivesOrderCommand> failureActionOfUpdatePlanningIntervalObjectivesOrderCommand, Wolverine.Runtime.IWolverineRuntime wolverineRuntime)
        {
        ...
        public override async System.Threading.Tasks.Task HandleAsync(Wolverine.Runtime.MessageContext context, System.Threading.CancellationToken cancellation)
        {
            ...
            try
            {
                ...
                await Wolverine.FluentValidation.Internals.FluentValidationExecutor.ExecuteOne<Wayd.Planning.Application.PlanningIntervals.Commands.UpdatePlanningIntervalObjectivesOrderCommand>(updatePlanningIntervalObjectivesOrderCommandValidator, _failureActionOfUpdatePlanningIntervalObjectivesOrderCommand, updatePlanningIntervalObjectivesOrderCommand).ConfigureAwait(false);
                var updatePlanningIntervalObjectivesOrderCommandHandler = new Wayd.Planning.Application.PlanningIntervals.Commands.UpdatePlanningIntervalObjectivesOrderCommandHandler(waydDbContext, dispatcher, _loggerOfUpdatePlanningIntervalObjectivesOrderCommandHandler);
