...
namespace Internal.Generated.WolverineHandlers
{
    ...
    public sealed class UpdatePokerRoundLabelCommandHandler149753493 : Wolverine.Runtime.Handlers.MessageHandler
    {
        ...
        public UpdatePokerRoundLabelCommandHandler149753493(Microsoft.AspNetCore.Http.IHttpContextAccessor __httpContextAccessor1, Microsoft.AspNetCore.Http.IHttpContextAccessor __httpContextAccessor2, Microsoft.EntityFrameworkCore.DbContextOptions dbContextOptions, Microsoft.Extensions.DependencyInjection.IServiceScopeFactory serviceScopeFactory, Microsoft.Extensions.Logging.ILogger<Wayd.Common.Application.Behaviors.PerformanceBehaviorLog> loggerOfPerformanceBehaviorLog, Microsoft.Extensions.Logging.ILogger<Wayd.Infrastructure.Common.Services.EventPublisher> loggerOfEventPublisher, Microsoft.Extensions.Logging.ILogger<Wayd.Planning.Application.PokerSessions.Commands.UpdatePokerRoundLabelCommandHandler> loggerOfUpdatePokerRoundLabelCommandHandler, Microsoft.Extensions.Options.IOptions<Wayd.Infrastructure.Persistence.DatabaseSettings> optionsOfDatabaseSettings, System.Collections.Generic.IEnumerable<Wolverine.EntityFrameworkCore.IDomainEventScraper> domainEventScraperIEnumerable, System.TimeProvider timeProvider, Wolverine.FluentValidation.IFailureAction<Wayd.Planning.Application.PokerSessions.Commands.UpdatePokerRoundLabelCommand> failureActionOfUpdatePokerRoundLabelCommand, Wolverine.Runtime.IWolverineRuntime wolverineRuntime)
        {
        ...
        {
            var updatePokerRoundLabelCommandValidator = new Wayd.Planning.Application.PokerSessions.Commands.UpdatePokerRoundLabelCommandValidator();
            ...
            try
            {
                ...
                await Wolverine.FluentValidation.Internals.FluentValidationExecutor.ExecuteOne<Wayd.Planning.Application.PokerSessions.Commands.UpdatePokerRoundLabelCommand>(updatePokerRoundLabelCommandValidator, _failureActionOfUpdatePokerRoundLabelCommand, updatePokerRoundLabelCommand).ConfigureAwait(false);
                var updatePokerRoundLabelCommandHandler = new Wayd.Planning.Application.PokerSessions.Commands.UpdatePokerRoundLabelCommandHandler(waydDbContext, pokerSessionNotifier, _loggerOfUpdatePokerRoundLabelCommandHandler);
