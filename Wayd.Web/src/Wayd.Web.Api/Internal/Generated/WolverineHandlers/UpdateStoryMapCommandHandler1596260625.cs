...
{
    // START: UpdateStoryMapCommandHandler1596260625
    [global::System.CodeDom.Compiler.GeneratedCode("JasperFx", "1.0.0")]
    public sealed class UpdateStoryMapCommandHandler1596260625 : Wolverine.Runtime.Handlers.MessageHandler
    {
        ...
        private readonly Microsoft.Extensions.Logging.ILogger<Wayd.Planning.Application.StoryMaps.Commands.UpdateStoryMapCommandHandler> _loggerOfUpdateStoryMapCommandHandler;
        ...
        private readonly Wolverine.FluentValidation.IFailureAction<Wayd.Planning.Application.StoryMaps.Commands.UpdateStoryMapCommand> _failureActionOfUpdateStoryMapCommand;
        private readonly Wolverine.Runtime.IWolverineRuntime _wolverineRuntime;

        public UpdateStoryMapCommandHandler1596260625(Microsoft.AspNetCore.Http.IHttpContextAccessor __httpContextAccessor1, Microsoft.AspNetCore.Http.IHttpContextAccessor __httpContextAccessor2, Microsoft.EntityFrameworkCore.DbContextOptions dbContextOptions, Microsoft.Extensions.DependencyInjection.IServiceScopeFactory serviceScopeFactory, Microsoft.Extensions.Logging.ILogger<Wayd.Common.Application.Behaviors.PerformanceBehaviorLog> loggerOfPerformanceBehaviorLog, Microsoft.Extensions.Logging.ILogger<Wayd.Infrastructure.Common.Services.EventPublisher> loggerOfEventPublisher, Microsoft.Extensions.Logging.ILogger<Wayd.Planning.Application.StoryMaps.Commands.UpdateStoryMapCommandHandler> loggerOfUpdateStoryMapCommandHandler, Microsoft.Extensions.Options.IOptions<Wayd.Infrastructure.Persistence.DatabaseSettings> optionsOfDatabaseSettings, System.Collections.Generic.IEnumerable<Wolverine.EntityFrameworkCore.IDomainEventScraper> domainEventScraperIEnumerable, System.TimeProvider timeProvider, Wolverine.FluentValidation.IFailureAction<Wayd.Planning.Application.StoryMaps.Commands.UpdateStoryMapCommand> failureActionOfUpdateStoryMapCommand, Wolverine.Runtime.IWolverineRuntime wolverineRuntime)
        {
            ...
            _loggerOfUpdateStoryMapCommandHandler = loggerOfUpdateStoryMapCommandHandler;
            _optionsOfDatabaseSettings = optionsOfDatabaseSettings;
            _domainEventScraperIEnumerable = domainEventScraperIEnumerable;
            _timeProvider = timeProvider;
            _failureActionOfUpdateStoryMapCommand = failureActionOfUpdateStoryMapCommand;
        ...
        public override async System.Threading.Tasks.Task HandleAsync(Wolverine.Runtime.MessageContext context, System.Threading.CancellationToken cancellation)
        {
            ...
            var updateStoryMapCommandValidator = new Wayd.Planning.Application.StoryMaps.Commands.UpdateStoryMapCommandValidator();
            // The actual message body
            var updateStoryMapCommand = (Wayd.Planning.Application.StoryMaps.Commands.UpdateStoryMapCommand)context.Envelope.Message;
            ...
            try
            {
                System.Diagnostics.Activity.Current?.SetTag("message.handler", "Wayd.Planning.Application.StoryMaps.Commands.UpdateStoryMapCommandHandler");
                System.Diagnostics.Activity.Current?.SetTag("handler.type", "Wayd.Planning.Application.StoryMaps.Commands.UpdateStoryMapCommandHandler");
                await Wolverine.FluentValidation.Internals.FluentValidationExecutor.ExecuteOne<Wayd.Planning.Application.StoryMaps.Commands.UpdateStoryMapCommand>(updateStoryMapCommandValidator, _failureActionOfUpdateStoryMapCommand, updateStoryMapCommand).ConfigureAwait(false);
                var updateStoryMapCommandHandler = new Wayd.Planning.Application.StoryMaps.Commands.UpdateStoryMapCommandHandler(waydDbContext, storyMapNotifier, _loggerOfUpdateStoryMapCommandHandler);
                
                // The actual message execution
                var outgoing1 = await updateStoryMapCommandHandler.Handle(updateStoryMapCommand, cancellation).ConfigureAwait(false);
    ...
    // END: UpdateStoryMapCommandHandler1596260625
