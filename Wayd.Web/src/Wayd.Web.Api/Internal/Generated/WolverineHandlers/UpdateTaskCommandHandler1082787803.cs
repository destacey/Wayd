...
{
    // START: UpdateTaskCommandHandler1082787803
    [global::System.CodeDom.Compiler.GeneratedCode("JasperFx", "1.0.0")]
    public sealed class UpdateTaskCommandHandler1082787803 : Wolverine.Runtime.Handlers.MessageHandler
    {
        ...
        private readonly Microsoft.Extensions.Logging.ILogger<Wayd.Planning.Application.StoryMaps.Commands.UpdateTaskCommandHandler> _loggerOfUpdateTaskCommandHandler;
        ...
        private readonly Wolverine.FluentValidation.IFailureAction<Wayd.Planning.Application.StoryMaps.Commands.UpdateTaskCommand> _failureActionOfUpdateTaskCommand;
        private readonly Wolverine.Runtime.IWolverineRuntime _wolverineRuntime;

        public UpdateTaskCommandHandler1082787803(Microsoft.AspNetCore.Http.IHttpContextAccessor __httpContextAccessor1, Microsoft.AspNetCore.Http.IHttpContextAccessor __httpContextAccessor2, Microsoft.EntityFrameworkCore.DbContextOptions dbContextOptions, Microsoft.Extensions.DependencyInjection.IServiceScopeFactory serviceScopeFactory, Microsoft.Extensions.Logging.ILogger<Wayd.Common.Application.Behaviors.PerformanceBehaviorLog> loggerOfPerformanceBehaviorLog, Microsoft.Extensions.Logging.ILogger<Wayd.Infrastructure.Common.Services.EventPublisher> loggerOfEventPublisher, Microsoft.Extensions.Logging.ILogger<Wayd.Planning.Application.StoryMaps.Commands.UpdateTaskCommandHandler> loggerOfUpdateTaskCommandHandler, Microsoft.Extensions.Options.IOptions<Wayd.Infrastructure.Persistence.DatabaseSettings> optionsOfDatabaseSettings, System.Collections.Generic.IEnumerable<Wolverine.EntityFrameworkCore.IDomainEventScraper> domainEventScraperIEnumerable, System.TimeProvider timeProvider, Wolverine.FluentValidation.IFailureAction<Wayd.Planning.Application.StoryMaps.Commands.UpdateTaskCommand> failureActionOfUpdateTaskCommand, Wolverine.Runtime.IWolverineRuntime wolverineRuntime)
        {
            ...
            _loggerOfUpdateTaskCommandHandler = loggerOfUpdateTaskCommandHandler;
            _optionsOfDatabaseSettings = optionsOfDatabaseSettings;
            _domainEventScraperIEnumerable = domainEventScraperIEnumerable;
            _timeProvider = timeProvider;
            _failureActionOfUpdateTaskCommand = failureActionOfUpdateTaskCommand;
        ...
        public override async System.Threading.Tasks.Task HandleAsync(Wolverine.Runtime.MessageContext context, System.Threading.CancellationToken cancellation)
        {
            ...
            var updateTaskCommandValidator = new Wayd.Planning.Application.StoryMaps.Commands.UpdateTaskCommandValidator();
            ...
            var updateTaskCommand = (Wayd.Planning.Application.StoryMaps.Commands.UpdateTaskCommand)context.Envelope.Message;
            ...
            try
            {
                System.Diagnostics.Activity.Current?.SetTag("message.handler", "Wayd.Planning.Application.StoryMaps.Commands.UpdateTaskCommandHandler");
                System.Diagnostics.Activity.Current?.SetTag("handler.type", "Wayd.Planning.Application.StoryMaps.Commands.UpdateTaskCommandHandler");
                await Wolverine.FluentValidation.Internals.FluentValidationExecutor.ExecuteOne<Wayd.Planning.Application.StoryMaps.Commands.UpdateTaskCommand>(updateTaskCommandValidator, _failureActionOfUpdateTaskCommand, updateTaskCommand).ConfigureAwait(false);
                var updateTaskCommandHandler = new Wayd.Planning.Application.StoryMaps.Commands.UpdateTaskCommandHandler(waydDbContext, storyMapNotifier, _loggerOfUpdateTaskCommandHandler);
                
                // The actual message execution
                var outgoing1 = await updateTaskCommandHandler.Handle(updateTaskCommand, cancellation).ConfigureAwait(false);
    ...
    // END: UpdateTaskCommandHandler1082787803
