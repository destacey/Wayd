...
namespace Internal.Generated.WolverineHandlers
{
    ...
    public sealed class UpdateTeamCommandHandler1482938567 : Wolverine.Runtime.Handlers.MessageHandler
    {
        ...
        public UpdateTeamCommandHandler1482938567(Microsoft.AspNetCore.Http.IHttpContextAccessor __httpContextAccessor1, Microsoft.AspNetCore.Http.IHttpContextAccessor __httpContextAccessor2, Microsoft.EntityFrameworkCore.DbContextOptions dbContextOptions, Microsoft.Extensions.DependencyInjection.IServiceScopeFactory serviceScopeFactory, Microsoft.Extensions.Logging.ILogger<Wayd.Common.Application.Behaviors.PerformanceBehaviorLog> loggerOfPerformanceBehaviorLog, Microsoft.Extensions.Logging.ILogger<Wayd.Infrastructure.Common.Services.EventPublisher> loggerOfEventPublisher, Microsoft.Extensions.Logging.ILogger<Wayd.Organization.Application.Teams.Commands.UpdateTeamCommandHandler> loggerOfUpdateTeamCommandHandler, Microsoft.Extensions.Options.IOptions<Wayd.Infrastructure.Persistence.DatabaseSettings> optionsOfDatabaseSettings, System.Collections.Generic.IEnumerable<Wolverine.EntityFrameworkCore.IDomainEventScraper> domainEventScraperIEnumerable, System.TimeProvider timeProvider, Wolverine.FluentValidation.IFailureAction<Wayd.Organization.Application.Teams.Commands.UpdateTeamCommand> failureActionOfUpdateTeamCommand, Wolverine.Runtime.IWolverineRuntime wolverineRuntime)
        {
        ...
        public override async System.Threading.Tasks.Task HandleAsync(Wolverine.Runtime.MessageContext context, System.Threading.CancellationToken cancellation)
        {
            ...
            try
            {
                ...
                await Wolverine.FluentValidation.Internals.FluentValidationExecutor.ExecuteOne<Wayd.Organization.Application.Teams.Commands.UpdateTeamCommand>(updateTeamCommandValidator, _failureActionOfUpdateTeamCommand, updateTeamCommand).ConfigureAwait(false);
                var updateTeamCommandHandler = new Wayd.Organization.Application.Teams.Commands.UpdateTeamCommandHandler(waydDbContext, dateTimeProvider, _loggerOfUpdateTeamCommandHandler);
