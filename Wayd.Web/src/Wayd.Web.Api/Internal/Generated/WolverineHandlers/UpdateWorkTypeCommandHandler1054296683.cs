...
namespace Internal.Generated.WolverineHandlers
{
    ...
    public sealed class UpdateWorkTypeCommandHandler1054296683 : Wolverine.Runtime.Handlers.MessageHandler
    {
        ...
        public UpdateWorkTypeCommandHandler1054296683(Microsoft.AspNetCore.Http.IHttpContextAccessor __httpContextAccessor1, Microsoft.AspNetCore.Http.IHttpContextAccessor __httpContextAccessor2, Microsoft.EntityFrameworkCore.DbContextOptions dbContextOptions, Microsoft.Extensions.DependencyInjection.IServiceScopeFactory serviceScopeFactory, Microsoft.Extensions.Logging.ILogger<Wayd.Common.Application.Behaviors.PerformanceBehaviorLog> loggerOfPerformanceBehaviorLog, Microsoft.Extensions.Logging.ILogger<Wayd.Infrastructure.Common.Services.EventPublisher> loggerOfEventPublisher, Microsoft.Extensions.Logging.ILogger<Wayd.Work.Application.WorkTypes.Commands.UpdateWorkTypeCommandHandler> loggerOfUpdateWorkTypeCommandHandler, Microsoft.Extensions.Options.IOptions<Wayd.Infrastructure.Persistence.DatabaseSettings> optionsOfDatabaseSettings, System.Collections.Generic.IEnumerable<Wolverine.EntityFrameworkCore.IDomainEventScraper> domainEventScraperIEnumerable, System.TimeProvider timeProvider, Wolverine.FluentValidation.IFailureAction<Wayd.Work.Application.WorkTypes.Commands.UpdateWorkTypeCommand> failureActionOfUpdateWorkTypeCommand, Wolverine.Runtime.IWolverineRuntime wolverineRuntime)
        {
        ...
        public override async System.Threading.Tasks.Task HandleAsync(Wolverine.Runtime.MessageContext context, System.Threading.CancellationToken cancellation)
        {
            ...
            try
            {
                ...
                await Wolverine.FluentValidation.Internals.FluentValidationExecutor.ExecuteOne<Wayd.Work.Application.WorkTypes.Commands.UpdateWorkTypeCommand>(updateWorkTypeCommandValidator, _failureActionOfUpdateWorkTypeCommand, updateWorkTypeCommand).ConfigureAwait(false);
                var updateWorkTypeCommandHandler = new Wayd.Work.Application.WorkTypes.Commands.UpdateWorkTypeCommandHandler(waydDbContext, dateTimeProvider, _loggerOfUpdateWorkTypeCommandHandler);
