...
namespace Internal.Generated.WolverineHandlers
{
    ...
    public sealed class WithdrawVoteCommandHandler1632771119 : Wolverine.Runtime.Handlers.MessageHandler
    {
        ...
        public WithdrawVoteCommandHandler1632771119(Microsoft.AspNetCore.Http.IHttpContextAccessor __httpContextAccessor1, Microsoft.AspNetCore.Http.IHttpContextAccessor __httpContextAccessor2, Microsoft.EntityFrameworkCore.DbContextOptions dbContextOptions, Microsoft.Extensions.DependencyInjection.IServiceScopeFactory serviceScopeFactory, Microsoft.Extensions.Logging.ILogger<Wayd.Common.Application.Behaviors.PerformanceBehaviorLog> loggerOfPerformanceBehaviorLog, Microsoft.Extensions.Logging.ILogger<Wayd.Infrastructure.Common.Services.EventPublisher> loggerOfEventPublisher, Microsoft.Extensions.Logging.ILogger<Wayd.Planning.Application.PokerSessions.Commands.WithdrawVoteCommandHandler> loggerOfWithdrawVoteCommandHandler, Microsoft.Extensions.Options.IOptions<Wayd.Infrastructure.Persistence.DatabaseSettings> optionsOfDatabaseSettings, System.Collections.Generic.IEnumerable<Wolverine.EntityFrameworkCore.IDomainEventScraper> domainEventScraperIEnumerable, System.TimeProvider timeProvider, Wolverine.FluentValidation.IFailureAction<Wayd.Planning.Application.PokerSessions.Commands.WithdrawVoteCommand> failureActionOfWithdrawVoteCommand, Wolverine.Runtime.IWolverineRuntime wolverineRuntime)
        {
        ...
        {
            var withdrawVoteCommandValidator = new Wayd.Planning.Application.PokerSessions.Commands.WithdrawVoteCommandValidator();
            ...
            try
            {
                ...
                await Wolverine.FluentValidation.Internals.FluentValidationExecutor.ExecuteOne<Wayd.Planning.Application.PokerSessions.Commands.WithdrawVoteCommand>(withdrawVoteCommandValidator, _failureActionOfWithdrawVoteCommand, withdrawVoteCommand).ConfigureAwait(false);
                var withdrawVoteCommandHandler = new Wayd.Planning.Application.PokerSessions.Commands.WithdrawVoteCommandHandler(waydDbContext, currentUser, pokerSessionNotifier, _loggerOfWithdrawVoteCommandHandler);
