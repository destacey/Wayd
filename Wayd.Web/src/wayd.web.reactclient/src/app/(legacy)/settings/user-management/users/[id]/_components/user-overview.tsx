...
/**
 * A user's account details and roles.
 *
 * A section rather than the facts panel, unlike the other settings records:
 * the panel is closed by default and holds reference material beside content,
 * but for a user account these fields *are* the content — putting them there
 * would open the page on sign-in history with the account itself hidden behind
 * a toggle.
 */
    ...
    <Flex gap="middle" wrap align="flex-start">
      <Card size="small" title="Account" style={{ flex: '1 1 320px' }}>
        <Flex vertical gap={12}>
          ...
          <Flex gap={32} wrap>
            <LabeledContent label="First Name">{user.firstName}</LabeledContent>
