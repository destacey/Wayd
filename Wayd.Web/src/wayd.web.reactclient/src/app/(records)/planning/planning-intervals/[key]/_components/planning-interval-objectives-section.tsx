...
import PlanningIntervalObjectivesGrid from '@/src/app/(legacy)/planning/planning-intervals/_components/planning-interval-objectives-grid'
import {
...
const PlanningIntervalObjectivesTimeline = dynamic(
  () =>
    import(
      '@/src/app/(legacy)/planning/planning-intervals/_components/planning-interval-objectives-view-manager'
    ),
