...
} from '@/src/app/(legacy)/ppm/projects/_components'
import AssignProjectLifecycleForm from '@/src/app/(legacy)/ppm/projects/_components/assign-project-lifecycle-form'
import ChangeProjectLifecycleForm from '@/src/app/(legacy)/ppm/projects/_components/change-project-lifecycle-form'
import { ProjectStatusAction } from '@/src/app/(legacy)/ppm/projects/_components/change-project-status-form'
...
const ProjectTeamGrid = dynamic(
  () => import('@/src/app/(legacy)/ppm/projects/_components/project-team-grid'),
  { ssr: false, loading: () => <Spin /> },
)
...
const ProjectWorkItemsViewManager = dynamic(
  () =>
    import(
      '@/src/app/(legacy)/ppm/projects/_components/project-work-items-view-manager'
    ),
  { ssr: false, loading: () => <Spin /> },
)
