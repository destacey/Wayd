...
} as unknown as ReleaseDto

const updateRelease = jest.fn().mockResolvedValue({ data: undefined })
...
jest.mock('@/src/store/features/delivery/releases-api', () => ({
  useUpdateReleaseMutation: () => [updateRelease],
}))

describe('EditReleaseForm', () => {
  beforeEach(() => updateRelease.mockClear())
