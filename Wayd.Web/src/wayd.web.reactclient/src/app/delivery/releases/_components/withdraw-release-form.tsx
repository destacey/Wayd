...
import { useWithdrawReleaseMutation } from '@/src/store/features/delivery/releases-api'
...
/**
 * Withdraws a release, with an optional reason recorded on the status transition.
 *
 * Available for a released release as well as an unreleased one: pulling something after it shipped
