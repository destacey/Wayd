...
import styles from './objectives-health-report-section.module.css'

export interface ObjectivesHealthReportSectionProps {
  planningIntervalKey: number
}

/**
 * Every objective's latest health check, as a flat report.
 *
 * A report rather than a section: it restates objectives the record already
 * shows, arranged for scanning health across all of them at once.
 */
const ObjectivesHealthReportSection = ({
  planningIntervalKey,
}: ObjectivesHealthReportSectionProps) => {
  const {
    data: healthReport,
    isLoading,
    refetch,
...
export default ObjectivesHealthReportSection
