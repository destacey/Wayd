...
import type { WaydGrid2Handle, WaydGrid2Props } from './types'
 ...
 * header cells, row renderer, table/state hooks, descriptor filter engine,
 * CSV export). Currently flat-only: rows render through the row-renderer
 * seam's flat form ({@link FlatGridRow}); tree mode (getSubRows → expansion,
 * indentation, filterFromLeafRows, reparenting DnD) plugs a tree row form
 * into the same seam and absorbs TreeGrid.
 *
