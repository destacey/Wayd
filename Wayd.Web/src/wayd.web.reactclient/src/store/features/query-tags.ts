export enum QueryTags {
  ...
  BackgroundJobStatistics = 'Admin.BackgroundJobStatistics',
  ...
  PlanningIntervalBacklog = 'Planning.PlanningInterval.Backlog',
  ...
  StoryMap = 'Planning.StoryMap',
  StoryMapList = 'Planning.StoryMap.List',
  ...
  ProjectScore = 'Ppm.Project.Score',
  ProjectScoringContext = 'Ppm.Project.ScoringContext',
