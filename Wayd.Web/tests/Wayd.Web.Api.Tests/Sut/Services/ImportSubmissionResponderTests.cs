...
public sealed class ImportSubmissionResponderTests
{
    ...
    private static ImportProcessDto Run(ImportProcessStatus status) => new(
        _importProcessId, "test-import", "Test Import", ImportAtomicity.Atomic, GroupNoun: null, status, IsPreflight: false, AppliedImportProcessId: null, null, "user-1", "User One",
