---
title: Planning
description: Planning intervals, iterations, sprints, objectives, risks, roadmaps, and planning poker in Wayd.
sidebar_position: 2
audience: [user, agent]
---
...
## How Planning Connects Across Wayd
...
- **[Teams](../organizations/index.mdx#teams)** participate in Planning Intervals and own Sprints. Teams see their sprints in the [Sprints section](../organizations/index.mdx#sprints) and risks in the [Risks section](../organizations/index.mdx#risks).
...
- **[Story Maps](./story-maps.mdx)** — User story mapping with goals, steps, tasks, swim lanes, and personas
- **[Bulk Import](./bulk-import.mdx)** — Loading planning interval objectives and risks from CSV
