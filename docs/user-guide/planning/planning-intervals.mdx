...
- **Details** — PI metadata, with tabs for Teams and Sprint Mappings:
  - **Teams tab** — Grid of all [teams](../organizations/index.mdx#teams) assigned to the PI
  - **Sprint Mappings tab** — Configuration grid mapping each team's [sprints](./sprints.mdx) to PI iterations
