...
- **Task** — A specific piece of work under a step. Tasks stack vertically inside the grid cell where their step column meets a swim lane row. A task can also carry a description and a checklist — see [Task Details](#task-details).
...
Click a task card to open its details. Everything a card cannot show — a description, a checklist — lives there.
