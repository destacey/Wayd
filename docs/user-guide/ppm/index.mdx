...
- **[Projects](./projects.mdx)** — Project lifecycle, stages, tasks, dependencies, health checks, and the plan tab
...
| Portfolio ranking | Every project is ranked within its portfolio from creation; portfolio Owners/Managers (and [PPM administrators](../settings/permissions.mdx#ppm-administrator)) can reorder non-closed projects on the Ranking tab |
