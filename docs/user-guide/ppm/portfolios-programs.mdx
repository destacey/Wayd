...
**Ranking Tab** — Rank-ordered board for Proposed, Approved, and Active projects. Supports drag-to-rank for portfolio Owners/Managers (and [PPM administrators](../settings/permissions.mdx#ppm-administrator)) and includes score breakdown columns when a scoring model is assigned.
