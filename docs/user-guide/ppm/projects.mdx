...
The page-level **Actions** menu changes based on project status and your permissions.
...
Users need project update rights and management access to record scores. Project Owner/Manager, portfolio Owner/Manager, or program Owner/Manager access is sufficient. Users with project view access can view current scores and score history.
...
To create, edit, or delete project health checks, users need project update rights and management access on the project context (for example, project owner/manager or equivalent portfolio/program management access). Users with project view access can still view health checks and health reports.
