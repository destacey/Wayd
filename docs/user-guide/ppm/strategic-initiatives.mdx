...
description: Strategic initiative tracking with KPIs, checkpoints, and measurements in Wayd.
sidebar_position: 3
audience: [user, agent]
---
...
- Completed and Canceled initiatives are read-only

## Strategic Initiative Detail Page

The detail page uses a two-column layout:

*Left sidebar* — [Portfolio](./portfolios-programs.mdx#portfolios) link, date range, sponsors/owners, [strategic themes](../strategic-management/index.mdx#strategic-themes), description, and links.
...
**[Projects](./projects.mdx)** — Badge showing project count, with Card/List/Timeline views showing linked projects.
...
1. Navigate to a [portfolio's](./portfolios-programs.mdx#portfolios) Strategic Initiatives tab
...
6. Link **[Projects](./projects.mdx)** that contribute to the initiative
