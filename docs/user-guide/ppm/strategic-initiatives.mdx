...
A **Create KPI** button sits beside the section heading when the initiative is editable.

**[Projects](./projects.mdx)** — Card/List/Timeline views showing linked projects.

Both sections show their count in the rail.
...
1. Navigate to a [portfolio's](./portfolios-programs.mdx#portfolios) Strategic Initiatives section
