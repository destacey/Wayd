...
Product Management is being built in phases, and the user interface currently covers the catalog only.

| Area | Interface | API |
| --- | --- | --- |
| Products, types, tags | Yes | Yes |
| Releases and packages | Not yet | Yes |
| Deployments and environments | Not yet | Yes |
| Delivery metrics | Not yet | Yes |

The delivery records can be created and read through the API today, and the screens for them follow. Where a page below describes an API-only capability it says so.
