...
A workflow's detail page carries an **Activity** section holding its recorded history — published, archived, assigned to a record type, and statuses reclassified — with who made each change and when. See [Activity Log](../activity-log.mdx).
