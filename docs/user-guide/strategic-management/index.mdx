...
Where a project's work is attributed to themes, such as in the [Allocation Report](../work-management/allocation-report.mdx), Wayd uses the project's **effective themes**: its own themes when it has any, and otherwise its program's. A project's own themes replace its program's rather than adding to them. A project's themes are not required to be among its program's.
...
- **[Portfolio > Projects section](../ppm/portfolios-programs.mdx#portfolio-detail-page)** — Filter or group by strategic theme to see investment distribution
- **[Portfolio > Programs section](../ppm/portfolios-programs.mdx#portfolio-detail-page)** — See which programs support which themes
- **[Portfolio > Strategic Initiatives section](../ppm/portfolios-programs.mdx#portfolio-detail-page)** — Track [KPI](../ppm/strategic-initiatives.mdx#kpis) progress for theme-aligned initiatives
