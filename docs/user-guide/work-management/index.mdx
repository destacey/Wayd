...
- **[Teams](../organizations/index.mdx#teams)** are assigned to work items and see them in the [Backlog section](../organizations/index.mdx#backlog). Team [dependencies](../organizations/index.mdx#dependencies) and [cycle time](./cycle-time-report.mdx) are also tracked.
...
- **[Projects](../ppm/projects.mdx)** can be associated with portfolio-tier work items. Projects track work in their [Work Items section](../ppm/projects.mdx#project-detail-page).
...
- **[Backlog Health Report](./backlog-health-report.mdx)** — Grade a team's backlog for runway, flow, staleness, readiness and ordering problems
- **[Delivery Forecasting](./delivery-forecasting.mdx)** — Monte Carlo forecasts of when work items, objectives, and projects will be done, and how much a team will finish
- **[Allocation Report](./allocation-report.mdx)** — Where a team's or a team of teams' completed work went, by portfolio, program, project, strategic theme or work type
