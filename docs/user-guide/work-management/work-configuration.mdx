...
description: Work processes, work types, workflows, work statuses, and work status categories in Wayd.
sidebar_position: 2
audience: [user, agent]
---
...
A work process detail page carries an **Activity** section holding its recorded history, which for a work process is its integration state changing as an external system syncs it. See [Activity Log](../activity-log.mdx).
...
1. Navigate to [Settings > Work Management > Work Types](../settings/index.mdx#work-types)
...
1. Navigate to [Settings > Work Management > Work Statuses](../settings/index.mdx#work-statuses)
...
1. Navigate to [Settings > Work Management > Work Processes](../settings/index.mdx#work-processes)
2. Create a work process
3. Add [work types](#work-types) and assign [workflows](#workflows) to each
4. Activate the work process
5. The work process can then be assigned to [workspaces](./work-items.mdx#workspaces)
